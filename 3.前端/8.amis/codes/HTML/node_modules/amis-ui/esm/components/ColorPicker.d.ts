...
declare const _default: {
    new (props: Omit<Pick<Omit<ColorProps, keyof LocaleProps>, "classPrefix" | "classnames" | "className" | "style" | "theme" | "disabled" | "value" | "onChange" | "placement" | "resetValue" | "popoverClassName" | "popOverContainer" | "useMobileUI" | "presetColors"> & Partial<Pick<Omit<ColorProps, keyof LocaleProps>, "placeholder" | "clearable" | "format" | "allowCustomColor">> & Partial<Pick<{
        format: string;
        clearable: boolean;
        placeholder: string;
        allowCustomColor: boolean;
