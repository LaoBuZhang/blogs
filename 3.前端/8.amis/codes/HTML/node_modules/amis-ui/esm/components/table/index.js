...
import { __extends, __spreadArray, __awaiter, __generator, __assign, __decorate, __metadata, __rest } from 'tslib';
...
var Table = /** @class */ (function (_super) {
        ...
        return (React__default.createElement("thead", { ref: this.theadDom, className: cx('Table-thead') }, thColumns.map(function (data, index) {
            return (React__default.createElement("tr", { key: 'th-cell-' + index },
                ...
                data.map(function (item, i) {
                    ...
                    var children = !((_c = item.children) === null || _c === void 0 ? void 0 : _c.length) ? (React__default.createElement("span", null,
                        sort,
                        filter,
                    ...
                    case 0:
                        ...
                        if (value) {
                            if (isRadio) {
                                ...
                                selectedRowKeys = __spreadArray(__spreadArray(__spreadArray([], this.state.selectedRowKeys, true), [
                                    data[defaultKey]
    ...
    Table.prototype.renderLoading = function () {
        ...
        return (React__default.createElement("div", { className: cx('Table-loading') }, typeof loading === 'boolean' ? (React__default.createElement(Spinner, { loadingConfig: loadingConfig })) : (loading)));
    };
    Table.prototype.renderTable = function () {
        ...
        return (React__default.createElement("div", { ref: this.contentDom, className: cx('Table-content'), style: hasScrollX ? { overflow: 'auto hidden' } : {}, onMouseLeave: this.onMouseLeave.bind(this), onScroll: this.onTableContentScroll.bind(this) },
            itemActions && hoverRow ? (React__default.createElement(ItemActionsWrapper, { dom: hoverRow.target, classnames: cx }, typeof itemActions === 'function'
                ...
                : null)) : null,
            React__default.createElement("table", { style: __assign(__assign({}, tableStyle), { tableLayout: tableLayout }), className: cx('Table-table') },
                this.renderColGroup(),
    ...
    Table.prototype.renderScrollTableBody = function () {
        ...
        var hoverRow = this.state.hoverRow;
        return (React__default.createElement("div", { ref: this.bodyDom, className: cx('Table-body'), style: style, onMouseLeave: this.onMouseLeave.bind(this), onScroll: this.onTableScroll.bind(this) },
            itemActions && hoverRow ? (React__default.createElement(ItemActionsWrapper, { dom: hoverRow.target, classnames: cx }, typeof itemActions === 'function'
                ? itemActions(hoverRow.record, hoverRow.rowIndex)
                : null)) : null,
            React__default.createElement("table", { className: cx('Table-table'), style: tableStyle },
