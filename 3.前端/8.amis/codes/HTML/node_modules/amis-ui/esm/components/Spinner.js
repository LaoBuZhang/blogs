...
import { generateIcon, themeable } from 'amis-core';
...
var Spinner = /** @class */ (function (_super) {
    ...
    Spinner.prototype.componentDidUpdate = function () {
        ...
        var root = (_c = this.props.loadingConfig) === null || _c === void 0 ? void 0 : _c.root;
        if (!this.parent && root) {
    ...
    Spinner.prototype.renderBody = function () {
        ...
        return (React__default.createElement(Transition, { mountOnEnter: true, unmountOnExit: true, in: this.state.spinning, timeout: timeout }, function (status) {
            var _a, _b, _c;
            return (React__default.createElement(React__default.Fragment, null,
                ...
                React__default.createElement("div", { "data-testid": "spinner", className: cx("Spinner", tip && (_a = {},
                    ...
                    React__default.createElement("div", { className: cx("Spinner-icon", (_c = {},
                            ...
                            _c), spinnerClassName) }, icon ? (isCustomIcon ? (icon) : hasIcon(icon) ? (React__default.createElement(Icon, { icon: icon, className: "icon" })) : (generateIcon(cx, icon, 'icon'))) : null),
                    tip ? React__default.createElement("span", { className: cx("Spinner-tip") }, tip) : '')));
        }));
    };
    Spinner.prototype.render = function () {
        var _a = this.props, cx = _a.classnames, loadingConfig = _a.loadingConfig;
        var spinnerBody = this.renderBody();
        var root = loadingConfig === null || loadingConfig === void 0 ? void 0 : loadingConfig.root;
        var doms = root ? document.querySelectorAll(root) : null;
