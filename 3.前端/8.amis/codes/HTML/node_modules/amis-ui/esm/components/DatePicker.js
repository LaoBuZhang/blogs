...
var DatePicker = /** @class */ (function (_super) {
    ...
    DatePicker.prototype.getAvailableShortcuts = function (key) {
        ...
        for (var i = 0, len = advancedShortcuts.length; i < len; i++) {
            ...
            if (m) {
                return item.resolve.apply(item, __spreadArray([__], m, true));
            }
        }
        return null;
    };
    ...
    DatePicker.prototype.render = function () {
        ...
        return (React__default.createElement("div", { tabIndex: 0, onKeyPress: this.handleKeyPress, onFocus: this.handleFocus, onBlur: this.handleBlur, className: cx("DatePicker", (_a = {
            ...
            React__default.createElement(Input, { className: cx('DatePicker-input'), onChange: this.inputChange, onBlur: this.onInputBlur, ref: this.inputRef, placeholder: __(placeholder), autoComplete: "off", value: this.state.inputValue || '', disabled: disabled }),
