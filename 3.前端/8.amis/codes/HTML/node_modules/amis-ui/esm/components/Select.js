...
import { __extends, __assign, __spreadArray, __decorate, __metadata, __rest } from 'tslib';
import { isMobile, Overlay, PopOver, noop, ucFirst, autobind, themeable, localeable, uncontrollable, normalizeNodePath, isObject, findTree, highlight } from 'amis-core';
...
var Select = /** @class */ (function (_super) {
    ...
    Select.prototype.renderValue = function (_a) {
        ...
        if (multiple &&
            ...
            return __spreadArray(__spreadArray([], selection.slice(0, maxVisibleCount_1), true), [
                ...
                return (React__default.createElement(TooltipWrapper, { placement: 'top', tooltip: item[labelField || 'label'], trigger: 'hover', key: index },
                    React__default.createElement("div", { className: cx('Select-value', {
                        ...
                        React__default.createElement("span", { className: cx('Select-valueLabel') }, renderValueLabel ? renderValueLabel(item) : item[labelField || 'label']),
                        React__default.createElement("span", { className: cx('Select-valueIcon', {
                                'is-disabled': disabled || item.disabled
    ...
    Select.prototype.renderOuter = function (_a) {
        ...
        return mobileUI ? (React__default.createElement(PopUp, { className: cx("Select-popup"), container: popOverContainer, isShow: this.state.isOpen, onHide: this.close }, menu)) : (React__default.createElement(Overlay, { container: popOverContainer || this.getTarget, containerSelector: popOverContainerSelector, target: this.getTarget, placement: overlayPlacement, show: true },
...
export { Select, SelectWithRemoteOptions, EnhancedSelect as default, expandValue, matchOptionValue, normalizeOptions, optionValueCompare, value2array };
