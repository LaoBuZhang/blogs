...
var TransferPicker = /** @class */ (function (_super) {
    ...
    TransferPicker.prototype.render = function () {
        var _this = this;
        var _a = this.props, cx = _a.classnames, value = _a.value, __ = _a.translate, disabled = _a.disabled, className = _a.className, onChange = _a.onChange, size = _a.size, borderMode = _a.borderMode, rest = __rest(_a, ["classnames", "value", "translate", "disabled", "className", "onChange", "size", "borderMode"]);
        return (React__default.createElement(PickerContainer, { title: __('Select.placeholder'), onFocus: this.onFoucs, onClose: this.onBlur, bodyRender: function (_a) {
                _a.onClose; var value = _a.value, onChange = _a.onChange, setState = _a.setState, states = __rest(_a, ["onClose", "value", "onChange", "setState"]);
                return (React__default.createElement(Transfer, __assign({}, rest, states, { value: value, onChange: function (value, optionModified) {
                        if (optionModified) {
            ...
            return (React__default.createElement(ResultBox, { className: cx('TransferPicker', className, isOpened ? 'is-active' : ''), allowInput: false, result: value, onResultChange: onChange, onResultClick: onClick, placeholder: __('Select.placeholder'), disabled: disabled, borderMode: borderMode },
                React__default.createElement("span", { className: cx('TransferPicker-icon') },
                    React__default.createElement(Icon, { icon: "pencil", className: "icon" }))));
        }));
    };
    __decorate([
        autobind,
