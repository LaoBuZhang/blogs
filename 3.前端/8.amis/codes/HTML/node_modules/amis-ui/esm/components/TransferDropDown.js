...
import { isMobile, autobind, themeable, localeable, uncontrollable } from 'amis-core';
    ...
    TransferDropDown.prototype.render = function () {
        ...
        return (React__default.createElement(PopOverContainer, { onAfterHide: this.handleAfterPopoverHide, useMobileUI: useMobileUI, popOverContainer: popOverContainer, popOverClassName: cx('TransferDropDown-popover'), popOverRender: function (_a) {
                ...
                return (React__default.createElement("div", { className: cx('TransferDropDown-content', {
                    ...
                    searchResult !== null
                        ? _this.renderSearchResult(__assign(__assign({}, _this.props), { value: value, onChange: multiple
                                ? onChange
                                : function (value) {
                                    onClose();
                                    onChange === null || onChange === void 0 ? void 0 : onChange(value);
                                }, multiple: multiple }))
                        : _this.renderOptions(__assign(__assign({}, _this.props), { value: value, onChange: multiple
                                ? onChange
                                : function (value) {
                                    onClose();
                                    onChange === null || onChange === void 0 ? void 0 : onChange(value);
