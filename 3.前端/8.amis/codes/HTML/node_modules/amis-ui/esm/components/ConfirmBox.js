...
function ConfirmBox(_a) {
    ...
    var _b = React__default.useState(), loading = _b[0], setLoading = _b[1];
    ...
    function renderDialog() {
        return (React__default.createElement(FinalModal, { size: size, closeOnEsc: closeOnEsc, show: show, onHide: onCancel, container: popOverContainer, className: className },
            ...
            React__default.createElement(FinalModal.Body, { className: bodyClassName }, typeof children === 'function'
                ? children({
                    bodyRef: bodyRef,
                    loading: loading
                })
            ...
            (showFooter !== null && showFooter !== void 0 ? showFooter : true) ? (React__default.createElement(FinalModal.Footer, { className: footerClassName },
                ...
                React__default.createElement(Button, { onClick: onCancel }, __('cancel')),
                React__default.createElement(Button, { onClick: handleConfirm, level: "primary" }, __('confirm')))) : null));
    }
    function renderDrawer() {
        return (React__default.createElement(Drawer, { size: size, closeOnEsc: closeOnEsc, show: show, onHide: onCancel, container: popOverContainer, position: position, resizable: resizable, showCloseButton: false, className: className },
            ...
            React__default.createElement("div", { className: cx('Drawer-body', bodyClassName) }, typeof children === 'function'
                ? children({
                    bodyRef: bodyRef
                })
                : children),
