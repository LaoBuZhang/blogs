...
export declare function InputTable({ control, name, wrap, mode, label, labelAlign, labelClassName, description, fieldClassName, className, translate: __, classnames: cx, removable, columns, addable, addButtonText, addButtonClassName, scaffold, minLength, maxLength, isRequired, rules }: InputTabbleProps): JSX.Element;
...
export declare function InputTableRow({ value, columns, index, translate, update, formRef, classnames }: InputTableRowProps): JSX.Element;
