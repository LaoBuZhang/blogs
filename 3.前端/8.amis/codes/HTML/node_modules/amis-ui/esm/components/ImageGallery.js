...
var ImageGallery = /** @class */ (function (_super) {
    ...
    ImageGallery.prototype.render = function () {
        ...
        return (React__default.createElement(React__default.Fragment, null,
            ...
            React__default.createElement(FinalModal, { closeOnEsc: true, size: "full", onHide: this.close, show: this.state.isOpened, contentClassName: cx('ImageGallery'), container: modalContainer },
                    ...
                    React__default.createElement("div", { className: cx('ImageGallery-main'), ref: this.galleryMainRef },
                        ...
                        items.length > 1 ? (React__default.createElement(React__default.Fragment, null,
                            ...
                            React__default.createElement("a", { className: cx('ImageGallery-nextBtn', index >= items.length - 1 ? 'is-disabled' : ''), onClick: this.next },
                                React__default.createElement(Icon, { icon: "next", className: "icon" })))) : null))) : null,
                items.length > 1 ? (React__default.createElement("div", { className: cx('ImageGallery-footer') },
