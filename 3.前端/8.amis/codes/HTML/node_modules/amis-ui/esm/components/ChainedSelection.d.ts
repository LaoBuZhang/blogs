...
export declare class ChainedSelection extends BaseSelection<ChainedSelectionProps, ChainedSelectionState> {
    ...
    renderItem(option: Option, index: number, depth: number, id: string, styles?: object): JSX.Element;
    renderOption(option: Option, index: number, depth: number, id: string, styles?: object): JSX.Element;
    render(): JSX.Element;
}
declare const _default: {
    new (props: Omit<Pick<Omit<ChainedSelectionProps, keyof import("amis-core").LocaleProps>, "classPrefix" | "classnames" | "className" | "style" | "theme" | "disabled" | "value" | "onChange" | "onClick" | "inline" | "loadingConfig" | "itemClassName" | "labelClassName" | "labelField" | "options" | "onDeferLoad" | "onLeftDeferLoad" | "option2value" | "virtualListHeight" | "placeholderRender" | "defaultSelectedIndex"> & Partial<Pick<Omit<ChainedSelectionProps, keyof import("amis-core").LocaleProps>, "multiple" | "placeholder" | "itemHeight" | "clearable" | "virtualThreshold" | "itemRender">> & Partial<Pick<{
        placeholder: string;
