...
var SchemaEditorItemObject = /** @class */ (function (_super) {
    ...
    SchemaEditorItemObject.prototype.rendererProps = function () {
        ...
        return (React__default.createElement("div", { className: cx('SchemaEditorProps', {
            ...
            members.length ? (members.map(function (member, index) { return (React__default.createElement(SchemaEditorItem, { key: member.id, types: types, onTypeChange: onTypeChange, enableAdvancedSetting: enableAdvancedSetting, prefix: React__default.createElement(React__default.Fragment, null,
                    React__default.createElement(InputBox, { className: cx('SchemaEditor-key'), hasError: member.hasError, value: member.key || '', onChange: _this.handlePropKeyChange.bind(_this, index), placeholder: __('JSONSchema.key'), disabled: disabled || !!(value === null || value === void 0 ? void 0 : value.$ref) }),
                    React__default.createElement(InputBox, { className: cx('SchemaEditor-title'), value: member.schema.title || '', onChange: _this.handlePropTitleChange.bind(_this, index), placeholder: __('JSONSchema.title'), disabled: disabled || !!(value === null || value === void 0 ? void 0 : value.$ref) })), affix: React__default.createElement(Button, { className: cx('SchemaEditor-btn'), onClick: _this.handlePropRemove.bind(_this, index), iconOnly: true, disabled: disabled || !!(value === null || value === void 0 ? void 0 : value.$ref) },
                    React__default.createElement(Icon, { icon: "remove", className: "icon" })), value: member.schema, onChange: _this.handlePropChange.bind(_this, index), renderExtraProps: renderExtraProps, renderModalProps: renderModalProps, locale: locale, translate: __, classnames: cx, classPrefix: classPrefix, disabled: disabled || !!(value === null || value === void 0 ? void 0 : value.$ref), required: member.required, onRequiredChange: _this.handlePropRequiredChange.bind(_this, index) })); })) : (React__default.createElement("div", { className: cx('SchemaEditorProps-placeholder') }, __('placeholder.empty'))),
