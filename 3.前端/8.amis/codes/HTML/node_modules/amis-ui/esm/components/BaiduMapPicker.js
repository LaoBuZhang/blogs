...
var BaiduMapPicker = /** @class */ (function (_super) {
    ...
    BaiduMapPicker.prototype.render = function () {
        ...
        return (React__default.createElement("div", { className: cx('MapPicker') },
            ...
            hasSug ? (React__default.createElement("div", { className: cx('MapPicker-sug') }, sugs.map(function (item) { return (React__default.createElement("div", { onClick: _this.handleSugSelect, className: cx('MapPicker-sugItem'), key: item }, item)); }))) : null));
    };
    __decorate([
        autobind,
