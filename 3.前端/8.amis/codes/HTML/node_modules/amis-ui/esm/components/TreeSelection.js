...
var TreeSelection = /** @class */ (function (_super) {
    ...
    TreeSelection.prototype.renderItem = function (option, index, indexes) {
        ...
        return (React__default.createElement("div", { key: index, className: cx('TreeSelection-item', disabled || option.disabled || (option.defer && option.loading)
                ? 'is-disabled'
                : '', expaned ? 'is-expanded' : '') },
            React__default.createElement("div", { className: cx('TreeSelection-itemInner', itemClassName, option.className, checked ? 'is-active' : ''), onClick: function () { return _this.toggleOption(option); } },
                hasChildren || option.defer ? (React__default.createElement("a", { onClick: function (e) {
                        e.stopPropagation();
                ...
                option.defer && option.loading ? (React__default.createElement(Spinner, { loadingConfig: loadingConfig, show: true, size: "sm" })) : null,
                multiple && (!option.defer || option.loaded) ? (React__default.createElement(Checkbox, { size: "sm", checked: checked, partial: partial, disabled: disabled || option.disabled, labelClassName: labelClassName, description: option.description })) : null,
