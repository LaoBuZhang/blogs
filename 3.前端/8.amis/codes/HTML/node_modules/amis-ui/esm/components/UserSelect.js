    ...
    UserSelect.prototype.renderContent = function () {
        ...
        return (React__default.createElement("div", { className: cx("UserSelect-wrap") },
            ...
            searchable ? (React__default.createElement("div", { className: cx('UserSelect-searchBox') },
                React__default.createElement(InputBox, { className: cx("UserSelect-search"), value: this.state.inputValue, onChange: this.handleSearch, placeholder: searchPlaceholder, clearable: false }, this.state.isSearch ? (React__default.createElement("a", { onClick: this.handleSeachCancel },
