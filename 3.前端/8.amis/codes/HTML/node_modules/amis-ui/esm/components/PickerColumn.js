...
var PickerColumn = forwardRef(function (props, ref) {
    ...
    var renderOptions = function () {
        ...
        return state.options.map(function (option, index) {
            ...
            return (React__default.createElement("li", __assign({}, data, { ref: menuItemRef }), props.optionRender ? (props.optionRender(option)) : (React__default.createElement("div", __assign({}, childData)))));
        });
    };
