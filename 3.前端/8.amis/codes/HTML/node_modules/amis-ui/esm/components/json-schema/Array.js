...
function InputJSONSchemaArray(props) {
    ...
    var _d = React__default.useState(buildMembers(props.schema, value)), members = _d[0], setMembers = _d[1];
    var membersRef = React__default.useRef(members);
    membersRef.current = members;
    var _e = React__default.useState(collapsable ? true : false), collapsed = _e[0], setCollapsed = _e[1];
