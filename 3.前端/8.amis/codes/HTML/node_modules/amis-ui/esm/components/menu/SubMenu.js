...
var SubMenu = /** @class */ (function (_super) {
    ...
    SubMenu.prototype.renderSubMenuTitle = function () {
        ...
        var labelNode = label && typeof label === 'string' ? (React__default.createElement("span", { className: cx('Nav-Menu-item-label', (_c = {},
                ...
                _c)), title: isCollapsedNode ? '' : label, style: this.getDynamicStyle(!!iconNode) }, label)) : React__default.isValidElement(label) ? (React__default.cloneElement(label, {
        ...
        var renderContent = function () {
            return isCollapsedNode ? (React__default.createElement(React__default.Fragment, null, iconNode || labelNode)) : (React__default.createElement(React__default.Fragment, null,
                ...
                !stacked ? (React__default.createElement("span", { key: "expand-toggle", className: cx('Nav-Menu-submenu-arrow') },
                    React__default.createElement(CaretIcon, null))) : null));
        };
