...
var Picker = memo(function (props) {
    ...
    var _h = useState(fixToArray(props.value === undefined ? props.defaultValue || [] : value)), innerValue = _h[0], setInnerValue = _h[1];
    useEffect(function () {
        if (value === innerValue)
            return;
    ...
    var onChange = function (itemValue, columnIndex, confirm) {
        var nextInnerValue = __spreadArray([], innerValue, true);
