...
var MenuItem = /** @class */ (function (_super) {
    ...
    MenuItem.prototype.renderMenuItem = function () {
        ...
        var labelNode = label && typeof label === 'string' ? (React__default.createElement("span", { className: cx("Nav-Menu-item-label", (_c = {},
                _c['Nav-Menu-item-label-collapsed'] = isCollapsedNode,
                _c)), title: isCollapsedNode ? '' : label, style: this.getDynamicStyle(!!iconNode) }, isCollapsedNode ? label.slice(0, 1) : label)) : React__default.isValidElement(label) ? (React__default.cloneElement(label, {
        ...
        return (React__default.createElement("div", { className: cx('Nav-Menu-item-wrap') },
            React__default.createElement(Badge, { classnames: cx, badge: badge ? __assign(__assign({}, badge), { className: badgeClassName }) : null, data: createObject(defaultData, link) },
    ...
    MenuItem.prototype.render = function () {
        ...
        return hidden ? null : (React__default.createElement(TooltipWrapper, { tooltipClassName: cx('Nav-Menu-item-tooltip', tooltipClassName, (_a = {},
            ...
            React__default.createElement("div", { className: cx('Nav-Menu-item-tooltip-wrap') },
