...
var ChainedSelection = /** @class */ (function (_super) {
    ...
    ChainedSelection.prototype.renderOption = function (option, index, depth, id, styles) {
        ...
        if (Array.isArray(option.children) || option.defer) {
            return (React__default.createElement("div", { style: styles, key: index, className: cx('ChainedSelection-item', itemClassName, option.className, disabled || option.disabled ? 'is-disabled' : '', ~this.state.selected.indexOf(id) ? 'is-active' : ''), onClick: function () { return _this.selectOption(option, depth, id); } },
                ...
                option.defer && option.loading ? (React__default.createElement(Spinner, { loadingConfig: loadingConfig, size: "sm", show: true })) : null));
        }
    ...
    ChainedSelection.prototype.render = function () {
        ...
        return (React__default.createElement("div", { className: cx('ChainedSelection', className) }, body && body.length ? (body) : (React__default.createElement("div", { className: cx('ChainedSelection-placeholder') }, __(placeholder)))));
    };
