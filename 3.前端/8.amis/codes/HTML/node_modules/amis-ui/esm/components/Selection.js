...
import { __extends, __spreadArray, __decorate, __metadata } from 'tslib';
import React__default from 'react';
import isEqual from 'lodash/isEqual';
import cx from 'classnames';
import { findTree, autobind, themeable, localeable, uncontrollable } from 'amis-core';
...
var BaseSelection = /** @class */ (function (_super) {
    ...
    BaseSelection.itemRender = function (option, states) {
        return (React__default.createElement("span", { className: cx({ 'is-invalid': option === null || option === void 0 ? void 0 : option.__unmatched }) },
    ...
    BaseSelection.value2array = function (value, options, option2value) {
        ...
        return value.map(function (value) {
            var option = findTree(options, function (option) {
                return isEqual(option2value(option), value);
            });
            return option || value;
        });
    };
    ...
    BaseSelection.prototype.toggleAll = function () {
        ...
        if (!Array.isArray(value)) {
            ...
            valueArray = Array.from(new Set(__spreadArray(__spreadArray([], value, true), availableOptions, true)));
        }
        else {
