...
var Alert = /** @class */ (function (_super) {
    ...
    Alert.prototype.render = function () {
        ...
        return (React__default.createElement(FinalModal, { show: this.state.show, onHide: this.handleCancel, container: container, ref: this.modalRef, closeOnEsc: true },
            ...
            React__default.createElement("div", { className: cx('Modal-body') }, this.state.prompt ? (renderForm(this.state.controls, this.state.value, this.handleFormSubmit, this.scopeRef, theme)) : (React__default.createElement(Html, { html: this.state.content }))),
            finalConfirmText ? (React__default.createElement("div", { className: cx('Modal-footer') },
                this.state.confirm || this.state.prompt ? (React__default.createElement(Button, { onClick: this.handleCancel }, __(cancelText))) : null,
