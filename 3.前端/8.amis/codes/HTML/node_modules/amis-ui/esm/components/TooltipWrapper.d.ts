...
declare const _default: {
    new (props: Pick<Omit<TooltipWrapperProps, keyof import("amis-core").ThemeProps>, "tooltip" | "overlay" | "container" | "tooltipTheme" | "tooltipClassName" | "onVisibleChange"> & Partial<Pick<Omit<TooltipWrapperProps, keyof import("amis-core").ThemeProps>, "placement" | "trigger" | "rootClose" | "delay">> & Partial<Pick<Pick<TooltipWrapperProps, "placement" | "trigger" | "rootClose" | "delay">, never>> & import("packages/amis-core/lib/theme").ThemeOutterProps): {
        ref: any;
