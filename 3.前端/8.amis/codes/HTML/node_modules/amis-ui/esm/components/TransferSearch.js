...
var TransferSearch = /** @class */ (function (_super) {
    ...
    TransferSearch.prototype.render = function () {
        ...
        return (React__default.createElement("div", { className: cx('Transfer-search') },
            React__default.createElement(InputBox, { value: inputValue, onChange: this.handleSearch, clearable: false, onKeyDown: this.handleSearchKeyDown, placeholder: placeholder }, !!inputValue ? (React__default.createElement("a", { onClick: this.handleSeachCancel },
