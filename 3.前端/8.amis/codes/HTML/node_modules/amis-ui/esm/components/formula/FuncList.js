...
function FuncList(props) {
    ...
    var _b = React__default.useState(props.data), filteredFuncs = _b[0], setFiteredFuncs = _b[1];
    var _c = React__default.useState(null), activeFunc = _c[0], setActiveFunc = _c[1];
