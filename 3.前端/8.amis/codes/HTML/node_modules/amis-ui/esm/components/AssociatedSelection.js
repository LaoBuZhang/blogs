...
var AssociatedSelection = /** @class */ (function (_super) {
    ...
    AssociatedSelection.prototype.render = function () {
        ...
        return (React__default.createElement("div", { className: cx('AssociatedSelection', className) },
            ...
            React__default.createElement("div", { className: cx('AssociatedSelection-right') }, this.state.leftValue ? (selectdOption ? (selectdOption.defer && !selectdOption.loaded ? (React__default.createElement("div", { className: cx('AssociatedSelection-box') },
