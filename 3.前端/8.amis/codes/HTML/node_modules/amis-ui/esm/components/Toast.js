...
import { isMobile, guid, autobind, themeable, localeable, noop } from 'amis-core';
...
var ToastComponent = /** @class */ (function (_super) {
    ...
    ToastComponent.prototype.notifiy = function (level, content, config) {
        var useMobileUI = (config.useMobileUI || this.props.useMobileUI) && isMobile();
        this.setState(function (state) {
            ...
            items.push(__assign(__assign({ body: content, level: level }, config), { id: guid(), position: config.position || (useMobileUI ? 'center' : config.position), timeout: config.timeout || (useMobileUI ? 3000 : undefined) }));
            return {
                items: items,
    ...
    ToastComponent.prototype.render = function () {
        ...
        var mobileUI = (useMobileUI || this.state.useMobileUI) && isMobile();
...
var ToastMessage = /** @class */ (function (_super) {
    ...
    ToastMessage.prototype.render = function () {
        ...
        return (React__default.createElement(Transition, { mountOnEnter: true, unmountOnExit: true, in: this.state.visible, timeout: 750, onEntered: this.handleEntered, onExited: onDismiss }, function (status) {
            var _a, _b, _c, _d;
            return (React__default.createElement("div", { className: cx("Toast Toast--".concat(level), fadeStyles[status], {
