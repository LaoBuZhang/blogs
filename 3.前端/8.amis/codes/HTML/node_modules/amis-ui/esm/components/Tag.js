...
import { generateIcon, autobind, noop, themeable } from 'amis-core';
...
var Tag = /** @class */ (function (_super) {
    ...
    Tag.prototype.renderCloseIcon = function () {
        ...
        var icon = typeof closeIcon === 'string' ? (getIcon(closeIcon) ? (React__default.createElement(Icon, { icon: closeIcon, className: "icon" })) : (generateIcon(cx, closeIcon, 'Icon'))) : React__default.isValidElement(closeIcon) ? (closeIcon) : (React__default.createElement(Icon, { icon: "close", className: "icon" }));
    ...
    Tag.prototype.render = function () {
        ...
        var prevIcon = displayMode === 'status' && (React__default.createElement("span", { className: cx('Tag--prev') }, typeof icon === 'string' ? (getIcon(icon) ? (React__default.createElement(Icon, { icon: icon, className: "icon" })) : (generateIcon(cx, icon, 'Icon'))) : React__default.isValidElement(icon) ? (icon) : (React__default.createElement(Icon, { icon: "dot", className: "icon" }))));
        return (React__default.createElement("span", { className: cx('Tag', "Tag--".concat(displayMode), className, (_a = {},
            ...
            React__default.createElement("span", { className: cx('Tag-text') },
                prevIcon,
                label || children),
...
var CheckableTagComp = /** @class */ (function (_super) {
    ...
    CheckableTagComp.prototype.render = function () {
        ...
        return (React__default.createElement("span", { className: cx(className, 'Tag', 'Tag--checkable', {
            ...
            }), onClick: disabled ? noop : this.handleClick, style: style }, label || children));
    };
    __decorate([
        autobind,
        __metadata("design:type", Function),
