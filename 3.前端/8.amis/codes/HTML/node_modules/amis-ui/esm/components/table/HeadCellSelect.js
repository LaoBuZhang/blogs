...
var HeadCellSelect = /** @class */ (function (_super) {
    ...
    HeadCellSelect.prototype.render = function () {
        ...
        return (React__default.createElement(HeadCellDropDown, { className: "".concat(ns, "TableCell-selectionBtn"), layerClassName: "".concat(ns, "TableCell-selectionPopOver"), filterIcon: React__default.createElement(Icon, { icon: "left-arrow", className: "icon" }), active: false, popOverContainer: popOverContainer ? popOverContainer : function () { return findDOMNode(_this); }, filterDropdown: function (_a) {
