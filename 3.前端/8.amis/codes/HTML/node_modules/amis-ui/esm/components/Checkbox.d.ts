...
declare const _default: {
    new (props: Pick<Omit<CheckboxProps, keyof import("amis-core").ThemeProps>, "description" | "label" | "name" | "disabled" | "value" | "checked" | "onChange" | "inline" | "size" | "readOnly" | "labelClassName" | "partial" | "optionType"> & Partial<Pick<Omit<CheckboxProps, keyof import("amis-core").ThemeProps>, "type" | "trueValue" | "falseValue">> & Partial<Pick<Pick<CheckboxProps, "type" | "trueValue" | "falseValue">, never>> & import("packages/amis-core/lib/theme").ThemeOutterProps): {
        ref: any;
