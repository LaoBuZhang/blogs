...
function InputTable(_a) {
    ...
    function renderBody() {
        return (React__default.createElement("div", { className: cx("Table", className) },
            React__default.createElement("div", { className: cx("Table-contentWrap") },
                React__default.createElement("table", { className: cx("Table-table") },
                    ...
                    React__default.createElement("tbody", null, fields.length ? (fields.map(function (field, index) { return (React__default.createElement("tr", { key: field.id },
                        ...
                        React__default.createElement("td", { colSpan: columns.length + 1 },
                            React__default.createElement(Icon, { icon: "desk-empty", className: cx('Table-placeholder-empty-icon', 'icon') }),
            ...
            addable !== false && (!maxLength || fields.length < maxLength) ? (React__default.createElement("div", { className: cx("InputTable-toolbar") },
                React__default.createElement(Button, { className: cx(addButtonClassName), onClick: function () { return append(__assign({}, scaffold)); }, size: "sm" },
...
function InputTableRow(_a) {
    ...
    return (React__default.createElement(React__default.Fragment, null, columns.map(function (item, index) { return (React__default.createElement("td", { key: index, className: item.className }, item.tdRender(methods, index))); })));
}
