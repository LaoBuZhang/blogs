...
function InputJSONSchemaObject(props) {
    ...
    var _c = React__default.useState(buildMembers(props.schema, props.value)), members = _c[0], setMembers = _c[1];
    var membersRef = React__default.useRef();
    membersRef.current = members;
    var _d = React__default.useState(collapsable ? true : false), collapsed = _d[0], setCollapsed = _d[1];
