...
var Tabs = /** @class */ (function (_super) {
    ...
    Tabs.prototype.renderNav = function (child, index, showClose) {
        ...
        return (React__default.createElement("li", { className: cx('Tabs-link', activeKey === eventKey ? 'is-active' : '', disabled ? 'is-disabled' : '', tabClassName), key: eventKey !== null && eventKey !== void 0 ? eventKey : index, onClick: function () { return (disabled ? '' : _this.handleSelect(eventKey)); }, onDoubleClick: function () {
    ...
    Tabs.prototype.renderTab = function (child, index) {
        ...
        var activeKey = activeKeyProp === undefined && index === 0 ? eventKey : activeKeyProp;
        return React__default.cloneElement(child, __assign(__assign({}, child.props), { key: eventKey, classnames: classnames, activeKey: activeKey }));
    };
