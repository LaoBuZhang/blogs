...
/** Toast配置 */
export type ToastConf = Partial<Pick<ToastComponentProps, 'position' | 'closeButton' | 'showIcon' | 'timeout' | 'errorTimeout' | 'className' | 'items' | 'useMobileUI'>>;
...
declare const _default: {
    new (props: Omit<Pick<Omit<ToastComponentProps, keyof LocaleProps>, "classPrefix" | "classnames" | "className" | "style" | "theme" | "useMobileUI" | "showIcon"> & Partial<Pick<Omit<ToastComponentProps, keyof LocaleProps>, "timeout" | "items" | "position" | "closeButton" | "errorTimeout">> & Partial<Pick<Pick<ToastComponentProps, "timeout" | "items" | "position" | "closeButton" | "errorTimeout">, never>> & {
