...
import { convertArrayValueToMoment, isMobile, localeable } from 'amis-core';
        ...
        _this.renderDay = function (props, currentDate) {
            ...
            if (_this.props.schedules) {
                ...
                if (schedule_1.length > 0) {
                    ...
                    if (_this.props.largeMode) {
                        ...
                        var scheduleDiv = showSchedule_1.map(function (item, index) {
                            ...
                            return (React__default.createElement("div", { key: injectedProps.key + 'content' + index, className: cx('ScheduleCalendar-large-schedule-content', item.className), style: { width: width + '00%' }, onClick: function () {
                                ...
                                React__default.createElement("div", { className: cx('ScheduleCalendar-text-overflow') }, item.content)));
                        });
                    ...
                    // 正常模式
                    var ScheduleIcon = (React__default.createElement("span", { className: cx('ScheduleCalendar-icon', schedule_1[0].className), onClick: function () {
                            return _this.props.onScheduleClick &&
                                _this.props.onScheduleClick(scheduleData_1);
                        } }));
                    return (React__default.createElement("td", __assign({}, injectedProps),
