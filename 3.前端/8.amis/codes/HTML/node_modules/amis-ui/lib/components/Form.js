...
function Form(props) {
    ...
    var methods = reactHookForm.useForm({
        defaultValues: (_a = props.value) !== null && _a !== void 0 ? _a : props.defaultValue,
    ...
    React__default["default"].useEffect(function () {
        if (value && amisCore.isObjectShallowModified(value, methods.getValues())) {
    ...
    if (onChange) {
        React__default["default"].useEffect(function () {
            var subscriber = methods.watch(function (value) {
                onChange(value);
            });
    ...
    return (React__default["default"].createElement(reactHookForm.FormProvider, tslib.__assign({}, methods),
        React__default["default"].createElement("form", { className: cx('Form', className), onSubmit: onSubmit.current, noValidate: true },
            React__default["default"].createElement("input", { type: "submit", style: { display: 'none' } }), (_b = props.children) === null || _b === void 0 ? void 0 :
...
var Form$1 = React__default["default"].forwardRef(function (props, ref) { return (React__default["default"].createElement(ThemedForm, tslib.__assign({}, props, { forwardRef: ref }))); });
