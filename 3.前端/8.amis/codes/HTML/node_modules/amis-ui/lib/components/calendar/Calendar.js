...
var BaseDatePicker = /** @class */ (function (_super) {
    ...
    BaseDatePicker.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx__default["default"]('rdt rdtStatic rdtOpen', this.props.className, (timeFormat && !dateFormat) || typeof dateFormat !== 'string'
                ? 'rdtTimeWithoutD'
                : timeFormat && timeFormat.toLowerCase().indexOf('s') > 0
                    ...
                    : timeFormat
                        ? 'rdtTime'
                        : '') },
            React__default["default"].createElement("div", { key: "dt", className: cx__default["default"]('rdtPicker', timeFormat && !dateFormat
