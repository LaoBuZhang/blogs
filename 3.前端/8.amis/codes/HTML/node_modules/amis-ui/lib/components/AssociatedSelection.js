...
var AssociatedSelection = /** @class */ (function (_super) {
    ...
    AssociatedSelection.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('AssociatedSelection', className) },
            React__default["default"].createElement("div", { className: cx('AssociatedSelection-left') }, leftMode === 'tree' ? (React__default["default"].createElement(Tree["default"], { multiple: false, disabled: disabled, value: this.state.leftValue, options: leftOptions, onChange: this.handleLeftSelect, onDeferLoad: this.handleLeftDeferLoad, virtualThreshold: virtualThreshold, itemHeight: itemHeight, loadingConfig: loadingConfig })) : (React__default["default"].createElement(GroupedSelection["default"], { option2value: this.leftOption2Value, options: leftOptions, value: this.state.leftValue, disabled: disabled, onChange: this.handleLeftSelect, multiple: false, clearable: false, virtualThreshold: virtualThreshold, itemHeight: itemHeight }))),
            React__default["default"].createElement("div", { className: cx('AssociatedSelection-right') }, this.state.leftValue ? (selectdOption ? (selectdOption.defer && !selectdOption.loaded ? (React__default["default"].createElement("div", { className: cx('AssociatedSelection-box') },
                React__default["default"].createElement("div", { className: cx('AssociatedSelection-reload', selectdOption.loading ? 'is-spin' : 'is-clickable'), onClick: selectdOption.loading
                        ? undefined
                        : this.handleRetry.bind(this, selectdOption) },
                    React__default["default"].createElement(icons.Icon, { icon: "reload", className: "icon" })),
                selectdOption.loading ? (React__default["default"].createElement("p", null, __('loading'))) : (React__default["default"].createElement("p", null, __('Transfer.refreshIcon'))))) : rightMode === 'table' ? (React__default["default"].createElement(TableSelection["default"], { columns: columns, value: value, disabled: disabled, options: selectdOption.children || [], onChange: onChange, option2value: option2value, cellRender: cellRender, multiple: multiple, virtualThreshold: virtualThreshold, itemHeight: itemHeight })) : rightMode === 'tree' ? (React__default["default"].createElement(Tree["default"], { value: value, disabled: disabled, options: selectdOption.children || [], onChange: onChange, multiple: multiple, labelField: labelField, virtualThreshold: virtualThreshold, itemHeight: itemHeight, loadingConfig: loadingConfig })) : rightMode === 'chained' ? (React__default["default"].createElement(ChainedSelection["default"], { value: value, disabled: disabled, options: selectdOption.children || [], onChange: onChange, option2value: option2value, multiple: multiple, itemRender: itemRender, labelField: labelField, virtualThreshold: virtualThreshold, itemHeight: itemHeight, loadingConfig: loadingConfig })) : (React__default["default"].createElement(GroupedSelection["default"], { value: value, disabled: disabled, options: selectdOption.children || [], onChange: onChange, option2value: option2value, multiple: multiple, itemRender: itemRender, labelField: labelField, virtualThreshold: virtualThreshold, itemHeight: itemHeight }))) : (React__default["default"].createElement("div", { className: cx('AssociatedSelection-box') }, __('Transfer.configError')))) : (React__default["default"].createElement("div", { className: cx('AssociatedSelection-box') }, __('Transfer.selectFromLeft'))))));
    };
    tslib.__decorate([
        amisCore.autobind,
