...
function InputJSONSchemaArray(props) {
    ...
    var _d = React__default["default"].useState(buildMembers(props.schema, value)), members = _d[0], setMembers = _d[1];
    var membersRef = React__default["default"].useRef(members);
    membersRef.current = members;
    var _e = React__default["default"].useState(collapsable ? true : false), collapsed = _e[0], setCollapsed = _e[1];
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        collapsable ? (React__default["default"].createElement("a", { className: cx('JSONSchemaObject-caret', {
                'is-collapsed': collapsed
            }), onClick: toggleCollapsed },
            React__default["default"].createElement(icons.Icon, { icon: "caret", className: "icon" }))) : null,
        React__default["default"].createElement("div", { className: cx('JSONSchemaObject', {
                'is-expanded': collapsable && !collapsed
            }) },
            collapsed ? (renderValue ? (React__default["default"].createElement(Item.InputJSONSchemaItem, tslib.__assign({}, props, { value: value, onChange: onChange, schema: {
                    type: 'string'
                }, placeholder: (_c = props.schema) === null || _c === void 0 ? void 0 : _c.description }))) : null) : (members.map(function (member) {
                return (React__default["default"].createElement("div", { key: member.key, className: cx('JSONSchemaMember') },
                    React__default["default"].createElement("div", { className: cx('JSONSchemaMember-value') },
                        React__default["default"].createElement(Item.InputJSONSchemaItem, tslib.__assign({}, props, { value: value === null || value === void 0 ? void 0 : value[member.index], onChange: onMemberChange.bind(null, member), schema: member.schema || {
                                type: 'string'
                            }, collapsable: true }))),
                    allowDelete ? (React__default["default"].createElement(Button["default"], { className: cx('SchemaEditor-btn'), onClick: onMemberDelete.bind(null, member), iconOnly: true, disabled: disabled || !!(value === null || value === void 0 ? void 0 : value.$ref) },
                        React__default["default"].createElement(icons.Icon, { icon: "remove", className: "icon" }))) : null));
            })),
            !collapsed ? (React__default["default"].createElement(Button["default"], { level: "link", onClick: handleAdd, size: "xs", disabled: disabled || !allowAdd }, __('JSONSchema.add_prop'))) : null)));
}
