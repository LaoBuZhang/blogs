...
var CustomYearsView = /** @class */ (function (_super) {
    ...
    function CustomYearsView(props) {
        ...
        _this.renderYearPicker = function () {
            ...
            return (React__default["default"].createElement(Picker["default"], { translate: _this.props.translate, locale: _this.props.locale, title: title, columns: columns, value: _this.state.pickerValue, onConfirm: _this.onConfirm, onChange: _this.onPickerChange, onClose: _this.props.onClose }));
        };
    ...
    CustomYearsView.prototype.renderYears = function (year) {
        ...
        while (i < 11) {
            ...
            if (years.length === 3) {
                rows.push(React__default["default"].createElement('tr', { key: i }, years));
                years = [];
            }
            year++;
            i++;
    ...
    CustomYearsView.prototype.render = function () {
        ...
        if (amisCore.isMobile() && this.props.useMobileUI) {
            return React__default["default"].createElement("div", { className: "rdtYears" }, this.renderYearPicker());
        }
        return (React__default["default"].createElement("div", { className: "rdtYears" },
            React__default["default"].createElement("table", { className: "headerTable" },
                React__default["default"].createElement("thead", null,
                    React__default["default"].createElement("tr", null,
                        React__default["default"].createElement("th", { className: "rdtPrev", onClick: this.props.subtractTime(10, 'years') }, "\u00AB"),
                        React__default["default"].createElement("th", { className: "rdtSwitch" }, __('year-to-year', { from: year, to: year + 9 })),
                        React__default["default"].createElement("th", { className: "rdtNext", onClick: this.props.addTime(10, 'years') }, "\u00BB")))),
            React__default["default"].createElement("table", null,
                React__default["default"].createElement("tbody", null, this.renderYears(year)))));
    };
