...
var Rating = /** @class */ (function (_super) {
    ...
    Rating.prototype.getShowColorAndText = function (value) {
        ...
        if (this.ratingRef.current) {
            ...
            if (_.isEmpty(colors) && !_.isEmpty(obj_1)) {
                tempColor = obj_1;
            }
        }
        if (!value)
    ...
    Rating.prototype.renderStars = function () {
        ...
        return (React__default["default"].createElement("ul", { onMouseLeave: this.mouseLeave }, stars.map(function (star, i) {
            var isThisHalf = half && !halfStar.hidden && halfStar.at === i;
            return (React__default["default"].createElement("li", { ref: _this.saveRef(i), className: cx('Rating-star', charClassName, {
                    'is-half': isThisHalf,
                ...
                isThisHalf && (React__default["default"].createElement("div", { className: cx('Rating-star-half'), style: {
                        color: showColor
                    } }, char)),
                char));
        })));
    ...
    Rating.prototype.renderText = function () {
        ...
        if (!showText)
            return null;
        return (React__default["default"].createElement("span", { className: cx('Rating-text', textClassName, (_a = {},
    ...
    Rating.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('Rating', className), ref: this.ratingRef }, textPosition === 'left' ? (React__default["default"].createElement(React__default["default"].Fragment, null,
            this.renderText(),
            this.renderStars())) : (React__default["default"].createElement(React__default["default"].Fragment, null,
            this.renderStars(),
            this.renderText()))));
    };
    Rating.defaultProps = {
        ...
        value: 0,
        count: 5,
        char: React__default["default"].createElement(icons.Icon, { icon: "star", className: "icon", iconContent: "Rating-star-icon" }),
        colors: '',
        textPosition: 'right'
    };
    return Rating;
