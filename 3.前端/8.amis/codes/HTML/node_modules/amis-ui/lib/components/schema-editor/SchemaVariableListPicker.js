...
var SchemaVariableListPicker = /** @class */ (function (_super) {
    ...
    SchemaVariableListPicker.prototype.render = function () {
        ...
        return (React__default["default"].createElement(PickerContainer["default"], { onPickerOpen: onPickerOpen, title: title !== null && title !== void 0 ? title : __('Select.placeholder'), bodyRender: function (_a) {
                var _b;
                var value = _a.value, onChange = _a.onChange, stateSchemas = _a.schemas, isOpened = _a.isOpened;
                return isOpened ? (React__default["default"].createElement(SchemaVariableList["default"], { value: (_b = value === null || value === void 0 ? void 0 : value.value) !== null && _b !== void 0 ? _b : value, onSelect: function (value, schema) {
                        return onChange({
                            value: value,
                            schema: schema
                        });
                    }, schemas: stateSchemas !== null && stateSchemas !== void 0 ? stateSchemas : schemas, selectMode: selectMode, beforeBuildVariables: beforeBuildVariables, placeholderRender: placeholderRender })) : (React__default["default"].createElement(React__default["default"].Fragment, null));
