...
var CustomDaysView = /** @class */ (function (_super) {
    ...
    function CustomDaysView(props) {
        ...
        _this.showTime = function () {
            ...
            return (React__default["default"].createElement("div", { key: "stb", className: "rdtShowTime" }, (selectedDate || viewDate || moment__default["default"]()).format(timeFormat)));
        };
            ...
            timeFormat.split(':').forEach(function (format, i) {
                ...
                if (type) {
                    ...
                    inputs.push(React__default["default"].createElement(Downshift__default["default"], { key: i + 'input', inputValue: date.format(formatMap_1[type]) }, function (_a) {
                        ...
                        return (React__default["default"].createElement("div", { className: cx('CalendarInputWrapper', 'CalendarInputWrapperMT') },
        ...
        _this.renderFooter = function () {
            ...
            return (React__default["default"].createElement("tfoot", { key: "tf" },
                React__default["default"].createElement("tr", null,
                    React__default["default"].createElement("td", { colSpan: 7 }, _this.props.requiredConfirm ? (React__default["default"].createElement("div", { key: "button", className: "rdtActions" },
                        React__default["default"].createElement("a", { className: cx('Button', 'Button--default'), onClick: _this.cancel }, __('cancel')),
                        React__default["default"].createElement("a", { className: cx('Button', 'Button--primary', 'm-l-sm'), onClick: _this.confirm }, __('confirm')))) : null))));
        };
        ...
        _this.renderPicker = function () {
            ...
            return (React__default["default"].createElement(Picker["default"], { translate: _this.props.translate, locale: _this.props.locale, title: title, columns: _this.state.columns, value: _this.state.pickerValue, onChange: _this.onPickerChange, onConfirm: _this.onPickerConfirm, onClose: _this.cancel }));
        };
    ...
    CustomDaysView.prototype.renderDays = function () {
        ...
        while (prevMonth.isBefore(lastDay)) {
            ...
            if (days.length === 7) {
                weeks.push(React__default["default"].createElement('tr', { key: prevMonth.format('M_D') }, days));
                days = [];
            }
            prevMonth.add(1, 'd');
        }
    ...
    CustomDaysView.prototype.render = function () {
        var _a = this.props, date = _a.viewDate, useMobileUI = _a.useMobileUI, embed = _a.embed, timeFormat = _a.timeFormat; _a.classnames;
        var locale = date.localeData();
        var __ = this.props.translate;
        if (amisCore.isMobile() && useMobileUI && !embed) {
            return React__default["default"].createElement("div", { className: "rdtYears" }, this.renderPicker());
        }
        var tableChildren = [
            this.props.hideHeader ? null : (React__default["default"].createElement("thead", { key: "th" },
                React__default["default"].createElement("tr", null,
        ...
        return (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement("div", { className: timeFormat ? 'rdtDays' : '' },
                React__default["default"].createElement("table", { className: timeFormat ? 'rdtDaysPart' : '' }, tableChildren),
                timeFormat ? (React__default["default"].createElement("div", { className: timeFormat.toLowerCase().indexOf('s') > 0
                        ? 'rdtTimePartWithS'
                        : 'rdtTimePart' }, this.renderTimes())) : null),
            React__default["default"].createElement("table", null, this.renderFooter())));
    };
