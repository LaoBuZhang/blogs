...
var TreeSelection = /** @class */ (function (_super) {
    ...
    TreeSelection.prototype.renderItem = function (option, index, indexes) {
        ...
        var _a = this.props, labelClassName = _a.labelClassName, disabled = _a.disabled, cx = _a.classnames, itemClassName = _a.itemClassName, itemRender = _a.itemRender, multiple = _a.multiple, loadingConfig = _a.loadingConfig;
        var id = indexes.join('-');
        ...
        return (React__default["default"].createElement("div", { key: index, className: cx('TreeSelection-item', disabled || option.disabled || (option.defer && option.loading)
                ? 'is-disabled'
                : '', expaned ? 'is-expanded' : '') },
            React__default["default"].createElement("div", { className: cx('TreeSelection-itemInner', itemClassName, option.className, checked ? 'is-active' : ''), onClick: function () { return _this.toggleOption(option); } },
                hasChildren || option.defer ? (React__default["default"].createElement("a", { onClick: function (e) {
                        e.stopPropagation();
                ...
                option.defer && option.loading ? (React__default["default"].createElement(Spinner["default"], { loadingConfig: loadingConfig, show: true, size: "sm" })) : null,
                multiple && (!option.defer || option.loaded) ? (React__default["default"].createElement(Checkbox["default"], { size: "sm", checked: checked, partial: partial, disabled: disabled || option.disabled, labelClassName: labelClassName, description: option.description })) : null,
                React__default["default"].createElement("div", { className: cx('TreeSelection-itemLabel') }, itemRender(option, {
                    index: index,
                    multiple: multiple,
                    checked: checked,
                ...
                option.defer && option.loading ? (React__default["default"].createElement(Spinner["default"], { loadingConfig: loadingConfig, show: true, size: "sm" })) : null),
            hasChildren ? (React__default["default"].createElement("div", { className: cx('TreeSelection-sublist') }, option.children.map(function (option, key) {
    ...
    TreeSelection.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('TreeSelection', className) }, body && body.length ? (body) : (React__default["default"].createElement("div", { className: cx('TreeSelection-placeholder') }, (_a = placeholderRender === null || placeholderRender === void 0 ? void 0 : placeholderRender(this.props)) !== null && _a !== void 0 ? _a : __(placeholder)))));
    };
