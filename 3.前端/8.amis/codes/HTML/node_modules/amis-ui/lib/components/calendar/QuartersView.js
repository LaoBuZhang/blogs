...
var QuarterView = /** @class */ (function (_super) {
    ...
    QuarterView.prototype.renderQuarters = function () {
        ...
        while (i < 5) {
            ...
            if (quarters.length === 2) {
                rows.push(React__default["default"].createElement('tr', { key: quarter + '_' + rows.length }, quarters));
                quarters = [];
            }
            i++;
        }
    ...
    QuarterView.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('ClalendarQuarter') },
            hideHeader ? null : this.renderYear(),
            React__default["default"].createElement("table", null,
                React__default["default"].createElement("tbody", null, this.renderQuarters()))));
    };
    return QuarterView;
