...
var HeadCellDropDown = /** @class */ (function (_super) {
    ...
    HeadCellDropDown.prototype.render = function () {
        ...
        return (React__default["default"].createElement("span", { className: cx(className, active ? 'is-active' : '') },
            React__default["default"].createElement("span", { onClick: this.openLayer }, filterIcon && typeof filterIcon === 'function'
                ? filterIcon(active)
                : filterIcon || null),
            isOpened ? (React__default["default"].createElement(amisCore.Overlay, { container: popOverContainer || (function () { return ReactDOM.findDOMNode(_this); }), placement: "left-bottom-left-top right-bottom-right-top", target: popOverContainer ? function () { return ReactDOM.findDOMNode(_this).parentNode; } : null, show: true },
                React__default["default"].createElement(amisCore.PopOver, { classPrefix: ns, onHide: this.closeLayer, className: cx(layerClassName), overlay: true }, filterDropdown && typeof filterDropdown === 'function'
                    ? filterDropdown(tslib.__assign(tslib.__assign({}, this.props), { confirm: function (payload) {
                            if (!(payload && payload.closeDropdown === false)) {
                                _this.closeLayer();
                            }
                        } }))
                    : filterDropdown || null))) : null));
    };
