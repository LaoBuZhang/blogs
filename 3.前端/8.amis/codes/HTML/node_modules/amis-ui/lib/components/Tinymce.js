...
var TinymceEditor = /** @class */ (function (_super) {
    ...
    TinymceEditor.prototype.componentDidMount = function () {
        ...
        this.config = tslib.__assign(tslib.__assign({ inline: false, skin: false, content_css: false, height: 400, language: !locale || locale === 'zh-CN' ? 'zh_CN' : 'en', branding: false, plugins: [
            ...
            }, paste_data_images: true }, this.props.config), { target: this.elementRef.current, readOnly: this.props.disabled, promotion: false, setup: function (editor) {
                _this.editor = editor;
                editor.on('init', function (e) {
                    _this.initEditor(e, editor);
                });
            } });
        tinymce__default["default"].init(this.config);
    };
    ...
    TinymceEditor.prototype.render = function () {
        return React__default["default"].createElement("textarea", { ref: this.elementRef });
    };
