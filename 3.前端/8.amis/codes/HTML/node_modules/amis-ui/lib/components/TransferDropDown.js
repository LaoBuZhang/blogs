...
var TransferDropDown = /** @class */ (function (_super) {
    ...
    TransferDropDown.prototype.render = function () {
        ...
        return (React__default["default"].createElement(PopOverContainer.PopOverContainer, { onAfterHide: this.handleAfterPopoverHide, useMobileUI: useMobileUI, popOverContainer: popOverContainer, popOverClassName: cx('TransferDropDown-popover'), popOverRender: function (_a) {
                var onClose = _a.onClose;
                return (React__default["default"].createElement("div", { className: cx('TransferDropDown-content', {
                        'is-mobile': mobileUI
                    }) },
                    ...
                    searchResult !== null
                        ...
                        : _this.renderOptions(tslib.__assign(tslib.__assign({}, _this.props), { value: value, onChange: multiple
                                ? onChange
                                : function (value) {
                                    onClose();
                                    onChange === null || onChange === void 0 ? void 0 : onChange(value);
