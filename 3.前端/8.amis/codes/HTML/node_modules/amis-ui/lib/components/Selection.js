...
var BaseSelection = /** @class */ (function (_super) {
    ...
    BaseSelection.itemRender = function (option, states) {
        return (React__default["default"].createElement("span", { className: cx__default["default"]({ 'is-invalid': option === null || option === void 0 ? void 0 : option.__unmatched }) },
            option[(states === null || states === void 0 ? void 0 : states.labelField) || 'label'],
            option.tip || ''));
    };
    BaseSelection.value2array = function (value, options, option2value) {
        ...
        return value.map(function (value) {
            var option = amisCore.findTree(options, function (option) {
                return isEqual__default["default"](option2value(option), value);
            });
            return option || value;
        });
    };
    ...
    BaseSelection.prototype.toggleOption = function (option) {
        var _b = this.props, value = _b.value, onChange = _b.onChange, option2value = _b.option2value, options = _b.options, disabled = _b.disabled, multiple = _b.multiple, clearable = _b.clearable;
    ...
    BaseSelection.prototype.toggleAll = function () {
        var _b = this.props, value = _b.value, onChange = _b.onChange, option2value = _b.option2value, options = _b.options;
        var valueArray = [];
        ...
        if (!Array.isArray(value)) {
            ...
            valueArray = Array.from(new Set(tslib.__spreadArray(tslib.__spreadArray([], value, true), availableOptions, true)));
        }
        else {
    ...
    BaseSelection.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('Selection', className, inline ? 'Selection--inline' : ''), onClick: onClick }, body && body.length ? body : React__default["default"].createElement("div", null, __(placeholder))));
    };
    var _a;
    _a = BaseSelection;
