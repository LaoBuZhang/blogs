...
var Spinner = /** @class */ (function (_super) {
    ...
    Spinner.prototype.renderBody = function () {
        ...
        return (React__default["default"].createElement(Transition__default["default"], { mountOnEnter: true, unmountOnExit: true, in: this.state.spinning, timeout: timeout }, function (status) {
            var _a, _b, _c;
    ...
    Spinner.prototype.render = function () {
        ...
        if (doms === null || doms === void 0 ? void 0 : doms.length) {
            // TODO: 找到准确的 元素
            return ReactDOM__default["default"].createPortal(spinnerBody, doms[doms.length - 1]);
        }
        return (React__default["default"].createElement(React__default["default"].Fragment, null,
