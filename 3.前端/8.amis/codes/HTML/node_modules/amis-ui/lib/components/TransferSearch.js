...
var TransferSearch = /** @class */ (function (_super) {
    ...
    function TransferSearch() {
        ...
        _this.lazySearch = _.debounce(function () {
    ...
    TransferSearch.prototype.render = function () {
        var _a = this.props, cx = _a.classnames; _a.translate; var placeholder = _a.placeholder;
        var inputValue = this.state.inputValue;
        return (React__default["default"].createElement("div", { className: cx('Transfer-search') },
            React__default["default"].createElement(InputBox["default"], { value: inputValue, onChange: this.handleSearch, clearable: false, onKeyDown: this.handleSearchKeyDown, placeholder: placeholder }, !!inputValue ? (React__default["default"].createElement("a", { onClick: this.handleSeachCancel },
                React__default["default"].createElement(icons.Icon, { icon: "close", className: "icon" }))) : (React__default["default"].createElement(icons.Icon, { icon: "search", className: "icon" })))));
    };
    tslib.__decorate([
        amisCore.autobind,
