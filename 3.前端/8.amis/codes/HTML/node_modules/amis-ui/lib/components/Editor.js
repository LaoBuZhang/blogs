...
var Editor = /** @class */ (function (_super) {
    ...
    Editor.prototype.render = function () {
        ...
        style.width = width;
        style.height = height;
        return (React__default["default"].createElement("div", { className: cx("MonacoEditor", { 'is-fullscreen': this.state.isFullscreen }, className), style: style, ref: this.wrapperRef },
            this.editor && placeholder && !value ? (React__default["default"].createElement("span", { className: cx('MonacoEditor-placeholder') }, placeholder)) : null,
            this.editor && this.props.allowFullscreen ? (React__default["default"].createElement("div", { className: cx("MonacoEditor-header") },
                React__default["default"].createElement("a", { className: cx('Modal-close', "MonacoEditor-fullscreen"), "data-tooltip": this.state.isFullscreen
                        ? __('Editor.exitFullscreen')
                        : __('Editor.fullscreen'), "data-position": "left", onClick: this.handleFullscreenModeChange },
                    React__default["default"].createElement(icons.Icon, { icon: this.state.isFullscreen ? 'compress-alt' : 'expand-alt', className: "icon" })))) : null));
    };
    Editor.defaultProps = {
        language: 'javascript',
        editorTheme: 'vs',
