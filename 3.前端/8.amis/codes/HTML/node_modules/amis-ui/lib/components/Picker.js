...
var Picker = React.memo(function (props) {
    ...
    var _h = React.useState(fixToArray(props.value === undefined ? props.defaultValue || [] : value)), innerValue = _h[0], setInnerValue = _h[1];
    ...
    var onChange = function (itemValue, columnIndex, confirm) {
        var nextInnerValue = tslib.__spreadArray([], innerValue, true);
    ...
    return (React__default["default"].createElement("div", { className: cx(className, 'PickerColumns', 'PickerColumns-popOver') },
        hasHeader && (React__default["default"].createElement("div", { className: cx('PickerColumns-header') },
            showToolbar && (React__default["default"].createElement(Button["default"], { className: "PickerColumns-cancel", level: "default", onClick: close }, __('cancel'))),
            title && React__default["default"].createElement("div", { className: cx('PickerColumns-title') }, title),
            showToolbar && (React__default["default"].createElement(Button["default"], { className: "PickerColumns-confirm", level: "primary", onClick: confirm }, __('confirm'))))),
        React__default["default"].createElement("div", { className: cx('PickerColumns-columns'), style: columnsStyle },
            _columns.map(function (column, index) {
                return renderColumnItem(column, index);
            }),
            React__default["default"].createElement("div", { className: cx('PickerColumns-mask'), style: maskStyle }),
            React__default["default"].createElement("div", { className: cx('PickerColumns-frame'), style: frameStyle }))));
});
