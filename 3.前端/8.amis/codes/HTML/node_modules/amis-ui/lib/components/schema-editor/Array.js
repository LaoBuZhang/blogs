...
var SchemaEditorItemArray = /** @class */ (function (_super) {
    ...
    SchemaEditorItemArray.prototype.renderItems = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('SchemaEditorProps SchemaEditorArrayProps', {
                'SchemaEditorProps--depth': showInfo !== false
            }) },
            React__default["default"].createElement(Item.SchemaEditorItem, { types: types, onTypeChange: onTypeChange, prefix: React__default["default"].createElement("div", { className: cx('SchemaEditor-itemsLabel') }, __('JSONSchema.array_items')), value: items, onChange: this.handleItemsChange, renderExtraProps: renderExtraProps, renderModalProps: renderModalProps, locale: locale, translate: __, classnames: cx, classPrefix: classPrefix, disabled: disabled || !!(items === null || items === void 0 ? void 0 : items.$ref), enableAdvancedSetting: enableAdvancedSetting })));
    };
    SchemaEditorItemArray.prototype.render = function () {
        var _a = this.props, cx = _a.classnames, showInfo = _a.showInfo; _a.disabled;
        return (React__default["default"].createElement("div", { className: cx('SchemaEditorItem SchemaEditorArray') },
