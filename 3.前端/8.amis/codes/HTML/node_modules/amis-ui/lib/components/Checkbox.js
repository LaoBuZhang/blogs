    ...
    Checkbox.prototype.render = function () {
        ...
        var _checked = typeof checked !== 'undefined'
            ...
            : typeof value === 'undefined'
                ? value
                : value == trueValue;
        return (React__default["default"].createElement("label", { className: cx("Checkbox Checkbox--".concat(type), className, (_a = {
                ...
                _a)) },
            React__default["default"].createElement("input", { type: type, checked: typeof checked !== 'undefined'
                    ? checked
                    : typeof value === 'undefined'
                        ? value
            ...
            React__default["default"].createElement("span", { className: cx(labelClassName) }, children || label),
            description ? (React__default["default"].createElement("div", { className: cx('Checkbox-desc') }, description)) : null));
    };
