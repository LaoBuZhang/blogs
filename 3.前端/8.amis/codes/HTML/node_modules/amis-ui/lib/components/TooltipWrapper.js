...
var TooltipWrapper = /** @class */ (function (_super) {
    ...
    TooltipWrapper.prototype.render = function () {
        ...
        return [
            ...
            React__default["default"].createElement(amisCore.Overlay, { key: "overlay", target: this.getTarget, show: this.state.show && !disabled, onHide: this.handleHide, rootClose: rootClose, placement: placement, container: container, offset: Array.isArray(offset) ? offset : [0, 0] },
                React__default["default"].createElement(Tooltip["default"], { title: typeof title === 'string' ? title : undefined, style: style, className: tooltipClassName, tooltipTheme: tooltipTheme, showArrow: showArrow, onMouseEnter: ~triggers.indexOf('hover') ? this.tooltipMouseEnter : function () { }, onMouseLeave: ~triggers.indexOf('hover') ? this.tooltipMouseLeave : function () { } }, children ? (React__default["default"].createElement(React__default["default"].Fragment, null, typeof children === 'function' ? children() : children)) : (React__default["default"].createElement(Html["default"], { html: typeof content === 'string' ? content : '' }))))
        ];
    };
