...
var Drawer = /** @class */ (function (_super) {
    ...
    Drawer.prototype.renderResizeCtrl = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('Drawer-resizeCtrl'), ref: this.resizer, onMouseDown: this.resizeMouseDown },
            React__default["default"].createElement("div", { className: cx('Drawer-resizeIcon') }, "\u00B7\u00B7\u00B7")));
    };
    Drawer.prototype.render = function () {
        ...
        return (React__default["default"].createElement(Portal__default["default"], { container: container },
            React__default["default"].createElement(Transition__default["default"], { mountOnEnter: true, unmountOnExit: true, appear: true, in: show, timeout: 500, onEnter: this.handleEnter, onExited: this.handleExited, onEntered: this.handleEntered }, function (status) {
                var _a;
                ...
                return (React__default["default"].createElement("div", { ref: _this.modalRef, role: "dialog", className: cx__default["default"]("amis-dialog-widget ".concat(ns, "Drawer"), (_a = {},
                        _a["".concat(ns, "Drawer--").concat(position)] = position,
                        _a["".concat(ns, "Drawer--").concat(size)] = size,
                        _a["".concat(ns, "Drawer--noOverlay")] = !overlay,
                        _a), className) },
                    overlay ? (React__default["default"].createElement("div", { className: cx__default["default"]("".concat(ns, "Drawer-overlay"), fadeStyles[status]) })) : null,
                    React__default["default"].createElement("div", { ref: _this.contentRef, style: bodyStyle, className: cx__default["default"]("".concat(ns, "Drawer-content"), bodyClassName, fadeStyles[status]) },
                        show && showCloseButton ? (React__default["default"].createElement("a", { onClick: disabled ? undefined : onHide, className: "".concat(ns, "Drawer-close") },
