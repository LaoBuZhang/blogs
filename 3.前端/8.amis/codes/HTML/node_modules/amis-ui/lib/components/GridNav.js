...
var GridNavItem = function (_a) {
    ...
    var renderIcon = function () {
        ...
        if (typeof props.icon === 'string') {
            if (props.badge) {
                return (React__default["default"].createElement(Badge.Badge, tslib.__assign({}, props.badge),
                    React__default["default"].createElement("div", { className: cx('GridNavItem-image') },
                        React__default["default"].createElement("img", { src: props.icon, style: { width: ratio + '%' } }))));
            }
            return (React__default["default"].createElement("div", { className: cx('GridNavItem-image') },
                React__default["default"].createElement("img", { src: props.icon, style: { width: ratio + '%' } })));
        }
        if (React__default["default"].isValidElement(props.icon)) {
            return React__default["default"].createElement(Badge.Badge, tslib.__assign({}, props.badge), props.icon);
        }
        return null;
    };
    var renderText = function () {
        ...
        if (props.text) {
            return React__default["default"].createElement("span", { className: cx('GridNavItem-text') }, props.text);
        }
        return null;
    };
    ...
    var classes = cx("".concat(prefix, " ").concat(props.contentClassName || ''), (_b = {},
        ...
        _b));
    return (React__default["default"].createElement("div", { className: cx(className, { 'GridNavItem--square': square }), style: rootStyle },
        React__default["default"].createElement("div", { role: props.onClick ? 'button' : undefined, className: classes, style: contentStyle, onClick: props.onClick }, renderContent())));
};
var GridNav = function (_a) {
    ...
    return (React__default["default"].createElement("div", { style: tslib.__assign({ paddingLeft: addUnit(props.gutter) }, style), className: cx("GridNav ".concat(className || ''), {
