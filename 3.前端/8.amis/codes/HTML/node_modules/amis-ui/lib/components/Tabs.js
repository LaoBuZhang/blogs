...
var TabComponent = /** @class */ (function (_super) {
    ...
    TabComponent.prototype.render = function () {
        ...
        return (React__default["default"].createElement(Transition__default["default"], { in: activeKey === eventKey, mountOnEnter: mountOnEnter, unmountOnExit: typeof reload === 'boolean' ? reload : unmountOnExit, timeout: 500 }, function (status) {
            if (status === Transition.ENTERING) {
                _this.contentDom.offsetWidth;
            }
            return (React__default["default"].createElement("div", { ref: _this.contentRef, className: cx(transitionStyles[status], activeKey === eventKey ? 'is-active' : '', 'Tabs-pane', className) }, children));
        }));
    };
    return TabComponent;
...
var Tabs = /** @class */ (function (_super) {
            ...
            children: Array.isArray(this.props.children)
                ? this.props.children.map(function (item) {
                    ...
                    return ({
                        ...
                        title: (_b = item === null || item === void 0 ? void 0 : item.props) === null || _b === void 0 ? void 0 : _b.title
                    });
                })
                : this.props.children
        }, {
    ...
    Tabs.prototype.renderNav = function (child, index, showClose) {
        ...
        var iconElement = amisCore.generateIcon(cx, icon, 'Icon');
        var link = (React__default["default"].createElement("a", { title: typeof title === 'string' ? title : undefined }, editable && editingIndex === index ? (React__default["default"].createElement("input", { className: cx('Tabs-link-edit'), type: "text", value: editInputText, autoFocus: true, onFocus: function (e) {
            ...
            icon ? (iconPosition === 'right' ? (React__default["default"].createElement(React__default["default"].Fragment, null,
                title,
                " ",
                iconElement)) : (React__default["default"].createElement(React__default["default"].Fragment, null,
                iconElement,
                " ",
                title))) : (title),
            React__default["default"].isValidElement(toolbar) ? toolbar : null))));
        return (React__default["default"].createElement("li", { className: cx('Tabs-link', activeKey === eventKey ? 'is-active' : '', disabled ? 'is-disabled' : '', tabClassName), key: eventKey !== null && eventKey !== void 0 ? eventKey : index, onClick: function () { return (disabled ? '' : _this.handleSelect(eventKey)); }, onDoubleClick: function () {
                editable && _this.handleStartEdit(index, title);
            } },
            showTip ? (React__default["default"].createElement(TooltipWrapper["default"], { placement: "top", tooltip: title, trigger: "hover", tooltipClassName: showTipClassName }, link)) : (link),
            showClose && (tabClosable !== null && tabClosable !== void 0 ? tabClosable : closable) && (React__default["default"].createElement("span", { className: cx('Tabs-link-close'), onClick: function (e) {
                    e.stopPropagation();
                    _this.props.onClose &&
                        _this.props.onClose(index, eventKey !== null && eventKey !== void 0 ? eventKey : index);
                } },
                React__default["default"].createElement(icons.Icon, { icon: "close", className: cx('Tabs-link-close-icon') }))),
            mode === 'chrome' ? (React__default["default"].createElement("div", { className: "chrome-tab-background" },
                React__default["default"].createElement("svg", { viewBox: "0 0 124 124", className: "chrome-tab-background--right" },
                    React__default["default"].createElement("path", { d: "M0,0 C0,68.483309 55.516691,124 124,124 L0,124 L0,-1 C0.00132103964,-0.667821298 0,-0.334064922 0,0 Z" })),
                React__default["default"].createElement("svg", { viewBox: "0 0 124 124", className: "chrome-tab-background--left" },
                    React__default["default"].createElement("path", { d: "M124,0 L124,125 L0,125 L0,125 C68.483309,125 124,69.483309 124,1 L123.992,0 L124,0 Z" })))) : null));
    };
    Tabs.prototype.renderTab = function (child, index) {
        ...
        var activeKey = activeKeyProp === undefined && index === 0 ? eventKey : activeKeyProp;
        return React__default["default"].cloneElement(child, tslib.__assign(tslib.__assign({}, child.props), { key: eventKey, classnames: classnames, activeKey: activeKey }));
    };
    Tabs.prototype.renderArrow = function (type) {
        ...
        return isOverflow ? (React__default["default"].createElement("div", { onClick: function () { return _this.handleArrow(type); }, className: cx('Tabs-linksContainer-arrow', 'Tabs-linksContainer-arrow--' + type, disabled && 'Tabs-linksContainer-arrow--disabled') },
            React__default["default"].createElement("i", { className: 'iconfont icon-arrow-' + type }))) : null;
    };
    ...
    Tabs.prototype.renderNavs = function (showClose) {
        ...
        if (typeof collapseOnExceed == 'number' &&
            ...
            doms.push(React__default["default"].createElement(PopOverContainer.PopOverContainer, { key: "togglor", placement: "center-bottom-center-top center-top-center-bottom", popOverClassName: cx('Tabs-PopOver'), popOverContainer: popOverContainer || (function () { return ReactDOM.findDOMNode(_this); }), popOverRender: function (_a) {
                    var onClose = _a.onClose;
                    return (React__default["default"].createElement("ul", { className: cx('Tabs-PopOverList', 'DropDown-menu'), onClick: onClose }, rest_1));
                } }, function (_a) {
                var onClick = _a.onClick; _a.ref; var isOpened = _a.isOpened;
                return (React__default["default"].createElement("li", { className: cx('Tabs-link', rest_1.some(function (item) { return ~item.props.className.indexOf('is-active'); })
                        ? 'is-active'
                        : '') },
                    React__default["default"].createElement("a", { className: cx('Tabs-togglor', isOpened ? 'is-opened' : ''), onClick: onClick },
                        React__default["default"].createElement("span", null, __(collapseBtnLabel || 'more')),
                        React__default["default"].createElement("span", { className: cx('Tabs-togglor-arrow') },
    ...
    Tabs.prototype.render = function () {
        ...
        var mode = tabsMode || dMode;
        var toolButtons = (React__default["default"].createElement(React__default["default"].Fragment, null,
            addable && (React__default["default"].createElement("div", { className: cx('Tabs-addable'), onClick: function () { return _this.handleAddBtn(); } },
                React__default["default"].createElement(icons.Icon, { icon: "plus", className: cx('Tabs-addable-icon') }),
                addBtnText)),
            toolbar));
        return (React__default["default"].createElement("div", { className: cx("Tabs", (_a = {},
                _a["Tabs--".concat(mode)] = mode,
                _a["sidebar--".concat(sidePosition)] = mode === 'sidebar',
                _a), className), style: style },
            !['vertical', 'sidebar', 'chrome'].includes(mode) ? (React__default["default"].createElement("div", { className: cx('Tabs-linksContainer-wrapper', toolbar && 'Tabs-linksContainer-wrapper--toolbar'), ref: this.resizeDom },
                React__default["default"].createElement("div", { className: cx('Tabs-linksContainer', isOverflow && 'Tabs-linksContainer--overflow') },
                    this.renderArrow('left'),
                    React__default["default"].createElement("div", { className: cx('Tabs-linksContainer-main') },
                        React__default["default"].createElement("ul", { className: cx('Tabs-links', linksClassName), role: "tablist", ref: this.navMain },
                            this.renderNavs(true),
                            additionBtns,
                            !isOverflow && toolButtons)),
                    this.renderArrow('right')),
                isOverflow && toolButtons)) : (React__default["default"].createElement("div", { className: cx('Tabs-linksWrapper') },
                React__default["default"].createElement("ul", { className: cx('Tabs-links', linksClassName), role: "tablist" },
                    this.renderNavs(),
                    additionBtns,
                    toolbar))),
            React__default["default"].createElement("div", { className: cx('Tabs-content', contentClassName) }, children.map(function (child, index) {
                return _this.renderTab(child, index);
            })),
            draggable && (React__default["default"].createElement("div", { className: cx('Tabs-drag-tip'), ref: this.dragTipRef }))));
    };
    Tabs.defaultProps = {
        mode: '',
        contentClassName: '',
