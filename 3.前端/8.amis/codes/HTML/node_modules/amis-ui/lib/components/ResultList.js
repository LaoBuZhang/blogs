...
var ResultList = /** @class */ (function (_super) {
    ...
    ResultList.prototype.handleCloseItem = function (e, option) {
        ...
        if (searchable && searchResult) {
            // 删除普通值
            var valueArray = _.cloneDeep(value) || [];
    ...
    ResultList.prototype.renderOption = function (option, index, value, styles) {
        ...
        return (React__default["default"].createElement("div", { style: styles, className: cx('Selections-item', itemClassName, option === null || option === void 0 ? void 0 : option.className), key: index },
            ...
            React__default["default"].createElement("label", { className: cx('Selections-label', {
            ...
            !disabled ? (React__default["default"].createElement("a", { className: cx('Selections-delBtn'), "data-index": index, onClick: function (e) {
    ...
    ResultList.prototype.renderNormalList = function (value) {
        ...
        return (React__default["default"].createElement(React__default["default"].Fragment, null, Array.isArray(value) && value.length ? (React__default["default"].createElement("div", { className: cx('Selections-items') }, value.length > virtualThreshold ? (React__default["default"].createElement(AutoSizer["default"], null, function (_b) {
            var height = _b.height;
            return (React__default["default"].createElement(index["default"], { height: height, itemCount: value.length, itemSize: itemHeight, renderItem: function (_b) {
        ...
        })))) : (React__default["default"].createElement("div", { className: cx('Selections-placeholder') }, __(placeholder)))));
    };
