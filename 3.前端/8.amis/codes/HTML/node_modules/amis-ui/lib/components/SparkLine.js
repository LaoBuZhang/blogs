...
var SparkLine = /** @class */ (function (_super) {
    ...
    SparkLine.prototype.renderLines = function () {
        ...
        return (React__default["default"].createElement("g", null,
            React__default["default"].createElement("path", { className: cx("Sparkline-area"), d: areaD, stroke: "none" }),
            React__default["default"].createElement("path", { className: cx("Sparkline-line"), d: lineD, fill: "none" })));
    };
    SparkLine.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('Sparkline', className, onClick ? 'Sparkline--clickable' : ''), style: style, onClick: onClick }, Array.isArray(value) && value.length > 1 ? (React__default["default"].createElement("svg", { className: cx('Sparkline-svg'), width: width, height: height, viewBox: "0 0 ".concat(width, " ").concat(height) }, this.renderLines())) : (placeholder !== null && placeholder !== void 0 ? placeholder : __('placeholder.empty'))));
    };
