...
var MenuItem = /** @class */ (function (_super) {
    ...
    MenuItem.prototype.renderMenuItem = function () {
        ...
        var iconNode = icon ? (typeof icon === 'string' ? (this.isImgPath(icon) ? (React__default["default"].createElement("div", { className: cx("Nav-Menu-item-icon") },
            React__default["default"].createElement("img", { width: "14px", src: icon }))) : (React__default["default"].createElement("i", { className: cx("Nav-Menu-item-icon", icon, (_a = {},
        ...
        var labelNode = label && typeof label === 'string' ? (React__default["default"].createElement("span", { className: cx("Nav-Menu-item-label", (_c = {},
                _c['Nav-Menu-item-label-collapsed'] = isCollapsedNode,
                _c)), title: isCollapsedNode ? '' : label, style: this.getDynamicStyle(!!iconNode) }, isCollapsedNode ? label.slice(0, 1) : label)) : React__default["default"].isValidElement(label) ? (React__default["default"].cloneElement(label, {
        ...
        return (React__default["default"].createElement("div", { className: cx('Nav-Menu-item-wrap') },
            React__default["default"].createElement(Badge.Badge, { classnames: cx, badge: badge ? tslib.__assign(tslib.__assign({}, badge), { className: badgeClassName }) : null, data: amisCore.createObject(defaultData, link) },
                React__default["default"].createElement("a", { className: cx('Nav-Menu-item-link'), title: typeof (link === null || link === void 0 ? void 0 : link.label) === 'string' ? link === null || link === void 0 ? void 0 : link.label : undefined, "data-id": (link === null || link === void 0 ? void 0 : link.__id) || id, "data-depth": depth, onDragStart: onDragStart === null || onDragStart === void 0 ? void 0 : onDragStart(link) }, isCollapsedNode ? (React__default["default"].createElement(React__default["default"].Fragment, null, iconNode || labelNode)) : (React__default["default"].createElement(React__default["default"].Fragment, null,
                    dragNode,
                    iconNode,
                    labelNode,
                    labelExtra)))),
            extra ? (React__default["default"].createElement("div", { className: cx('Nav-Menu-item-extra') }, extra)) : null));
    };
    MenuItem.prototype.render = function () {
        var _a;
        var _b = this.props, className = _b.className, tooltipClassName = _b.tooltipClassName, cx = _b.classnames, label = _b.label, disabled = _b.disabled, disabledTip = _b.disabledTip, tooltipContainer = _b.tooltipContainer, tooltipTrigger = _b.tooltipTrigger, depth = _b.depth, hidden = _b.hidden;
        ...
        return hidden ? null : (React__default["default"].createElement(TooltipWrapper["default"], { tooltipClassName: cx('Nav-Menu-item-tooltip', tooltipClassName, (_a = {},
            ...
            React__default["default"].createElement("div", { className: cx('Nav-Menu-item-tooltip-wrap') },
                React__default["default"].createElement(RcMenu.Item, tslib.__assign({}, pick__default["default"](this.props, this.internalProps), { className: cx(className) }), this.renderMenuItem()))));
    };
