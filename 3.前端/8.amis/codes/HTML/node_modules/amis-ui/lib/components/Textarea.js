...
var Textarea = /** @class */ (function (_super) {
    ...
    Textarea.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx("TextareaControl", (_a = {},
                _a["TextareaControl--border".concat(amisCore.ucFirst(borderMode))] = borderMode,
                _a['is-focused'] = this.state.focused,
                _a['is-disabled'] = disabled,
                _a), className) },
            React__default["default"].createElement(BaseTextArea__default["default"], { className: cx("TextareaControl-input", {
            ...
            clearable && !disabled && value ? (React__default["default"].createElement("a", { onClick: this.handleClear, className: cx('TextareaControl-clear') },
                React__default["default"].createElement(icons.Icon, { icon: "input-clear", className: "icon" }))) : null,
            showCounter ? (React__default["default"].createElement("span", { className: cx('TextareaControl-counter', {
                    'is-empty': counter === 0,
