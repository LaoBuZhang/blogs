    ...
    ConditionField.prototype.render = function () {
        ...
        return (React__default["default"].createElement(PopOverContainer.PopOverContainer, { popOverContainer: popOverContainer || (function () { return ReactDOM.findDOMNode(_this); }), popOverRender: function (_a) {
                ...
                return (React__default["default"].createElement(React__default["default"].Fragment, null,
                    ...
                    selectMode === 'tree' ? (React__default["default"].createElement(TreeSelection["default"], { className: 'is-scrollable', multiple: false, options: _this.filterOptions(_this.props.options), value: value, loadingConfig: loadingConfig, onChange: function (value) {
                            _this.onPopClose(onClose);
                            onChange(value.name);
                        } })) : (React__default["default"].createElement(GroupedSelection["default"], { multiple: false, onClick: function () { return _this.onPopClose(onClose); }, options: _this.filterOptions(_this.props.options), value: [value], option2value: option2value, onChange: function (value) {
                            return onChange(Array.isArray(value) ? value[0] : value);
                        } }))));
            } }, function (_a) {
            var onClick = _a.onClick, ref = _a.ref, isOpened = _a.isOpened;
            return (React__default["default"].createElement("div", { className: cx('CBGroup-field') },
                React__default["default"].createElement(ResultBox["default"], { className: cx('CBGroup-fieldInput', fieldClassName, isOpened ? 'is-active' : ''), ref: ref, allowInput: false, result: value ? amisCore.findTree(options, function (item) { return item.name === value; }) : '', onResultChange: amisCore.noop, onResultClick: onClick, placeholder: __('Condition.field_placeholder'), disabled: disabled },
