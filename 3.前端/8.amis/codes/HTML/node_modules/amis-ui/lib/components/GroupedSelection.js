...
var GroupedSelection = /** @class */ (function (_super) {
    ...
    GroupedSelection.prototype.renderOption = function (option, index, key, styles) {
        ...
        if (Array.isArray(option.children)) {
            if (!option[labelField]) {
                return (React__default["default"].createElement(React__default["default"].Fragment, null, option.children.map(function (child, index) {
                    return _this.renderOption(child, index);
                })));
            }
            return (React__default["default"].createElement("div", { key: index, className: cx('GroupedSelection-group', option.className) },
                React__default["default"].createElement("div", { className: cx('GroupedSelection-itemLabel') }, itemRender(option, {
                    index: index,
                    multiple: multiple,
                    checked: false,
                ...
                React__default["default"].createElement("div", { className: cx('GroupedSelection-items', option.className) }, option.children.map(function (child, index) {
                    return _this.renderOption(child, index);
                }))));
        }
    ...
    GroupedSelection.prototype.renderOptionOrLabel = function (option, index, hasParent, styles) {
        ...
        if (option.children) {
            return (React__default["default"].createElement("div", { key: index, style: styles, className: cx('GroupedSelection-group', option.className) },
                React__default["default"].createElement("div", { className: cx('GroupedSelection-itemLabel') }, itemRender(option, {
                    index: index,
                    multiple: multiple,
                    checked: false,
        ...
        return hasParent ? (React__default["default"].createElement("div", { key: 'group' + index, style: styles, className: cx('GroupedSelection-group', option.className) },
            React__default["default"].createElement("div", { className: cx('GroupedSelection-items', option.className) }, this.renderPureOption(option, index)))) : (this.renderPureOption(option, index, undefined, styles));
    };
    GroupedSelection.prototype.renderPureOption = function (option, index, key, styles) {
        ...
        return (React__default["default"].createElement("div", { key: index, style: styles, className: cx('GroupedSelection-item', itemClassName, option.className, disabled || option.disabled ? 'is-disabled' : '', !!~valueArray.indexOf(option) ? 'is-active' : ''), onClick: function () { return _this.toggleOption(option); } },
    ...
    GroupedSelection.prototype.render = function () {
        ...
        if (Array.isArray(options) && options.length) {
            ...
            body =
                flattendOptions_1.length > virtualThreshold ? (React__default["default"].createElement(AutoSizer["default"], { minHeight: virtualListHeight }, function (_a) {
                    var height = _a.height;
                    return (React__default["default"].createElement(index["default"], { height: height, itemCount: flattendOptions_1.length, itemSize: itemHeight, renderItem: function (_a) {
        ...
        return (React__default["default"].createElement("div", { className: cx('GroupedSelection', className), onClick: onClick }, body ? (body) : (React__default["default"].createElement("div", { className: cx('GroupedSelection-placeholder') }, (_a = placeholderRender === null || placeholderRender === void 0 ? void 0 : placeholderRender(this.props)) !== null && _a !== void 0 ? _a : __(placeholder)))));
    };
