...
import { ClassNamesFn, ThemeProps, IconCheckedSchema } from 'amis-core';
/**
 * Avatar 属性
 */
...
declare const _default: {
    new (props: Pick<Omit<AvatarCmptProps, keyof ThemeProps>, never> & Partial<Pick<Omit<AvatarCmptProps, keyof ThemeProps>, "children" | "text" | "icon" | "alt" | "src" | "draggable" | "onError" | "size" | "crossOrigin" | "shape" | "fit" | "gap">> & Partial<Pick<Partial<AvatarCmptProps>, "classPrefix" | "classnames" | "className" | "style" | "theme">> & import("packages/amis-core/lib/theme").ThemeOutterProps): {
        ref: any;
