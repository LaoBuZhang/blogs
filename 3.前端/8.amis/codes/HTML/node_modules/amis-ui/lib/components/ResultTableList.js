...
var BaseResultTableSelection = /** @class */ (function (_super) {
    ...
    BaseResultTableSelection.prototype.handleCloseItem = function (option) {
        ...
        if (searching) {
            var searchArray = Selection.BaseSelection.value2array(searchTableOptions, options, option2value);
    ...
    BaseResultTableSelection.defaultProps = tslib.__assign(tslib.__assign({}, Selection.BaseSelection.defaultProps), { cellRender: function (column, option, colIndex, rowIndex) { return React__default["default"].createElement("span", null, amisCore.resolveVariable(column.name, option)); } });
    tslib.__decorate([
        amisCore.autobind,
