...
var HandleItem = /** @class */ (function (_super) {
    ...
    HandleItem.prototype.render = function () {
        ...
        return disabled ? (React__default["default"].createElement("div", { className: cx('InputRange-handle'), style: style },
            React__default["default"].createElement("div", { className: cx('InputRange-handle-icon') },
                React__default["default"].createElement(icons.Icon, { icon: "slider-handle", className: "icon" })))) : (React__default["default"].createElement("div", { className: cx('InputRange-handle'), style: style, ref: this.handleRef },
            React__default["default"].createElement("div", { className: cx(isDrag ? 'InputRange-handle-drage' : 'InputRange-handle-icon'), onMouseDown: this.onMouseDown, onMouseEnter: this.onMouseEnter, onMouseLeave: this.onMouseLeave },
                React__default["default"].createElement(icons.Icon, { icon: "slider-handle", className: "icon" })),
            React__default["default"].createElement(amisCore.Overlay, { placement: tooltipPlacement, target: function () { return ReactDOM.findDOMNode(_this); }, container: function () { return ReactDOM.findDOMNode(_this); }, rootClose: false, show: true },
                React__default["default"].createElement(Label, { show: labelActive, classPrefix: this.props.classPrefix, classnames: cx, value: value, tooltipVisible: tooltipVisible, tipFormatter: tipFormatter, unit: unit, placement: tooltipPlacement }))));
    };
    tslib.__decorate([
        amisCore.autobind,
    ...
    Label.prototype.render = function () {
        ...
        var isShow = tooltipVisible !== undefined
            ? tooltipVisible && tipFormatter
                ...
                : tooltipVisible
            : show;
        return (React__default["default"].createElement("div", { className: cx('InputRange-label', "pos-".concat(amisCore.camel(placement)), {
                'InputRange-label-visible': isShow
            }) },
            React__default["default"].createElement("span", null, value + unit)));
    };
    return Label;
}(React__default["default"].Component));
var Range = /** @class */ (function (_super) {
    ...
    Range.prototype.renderSteps = function () {
        ...
        return (isShowSteps && (React__default["default"].createElement("div", null, partLengthList.map(function (item) { return (React__default["default"].createElement("span", { key: item, className: cx('InputRange-track-dot'), style: { left: (item * 100) / (max - min) + '%' } })); }))));
    };
    /**
     * 双滑块改变最大值、最小值
    ...
    Range.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('InputRange-wrap') },
            React__default["default"].createElement("div", { ref: this.trackRef, className: cx('InputRange-track', 'InputRange-track--background'), onClick: this.onClickTrack },
                React__default["default"].createElement("div", { className: cx('InputRange-track-active'), style: traceActiveStyle }),
                this.renderSteps(),
                multiple ? (['min', 'max'].map(function (type) { return (React__default["default"].createElement(HandleItem, { key: type, value: _this.multipleValue[type], type: type, min: min, max: max, classPrefix: _this.props.classPrefix, classnames: cx, disabled: disabled, tooltipVisible: tooltipVisible, tipFormatter: tipFormatter, unit: unit, tooltipPlacement: tooltipPlacement, onAfterChange: onAfterChange, onChange: _this.onGetChangeValue.bind(_this) })); })) : (React__default["default"].createElement(HandleItem, { value: +value, min: min, max: max, classPrefix: this.props.classPrefix, classnames: cx, disabled: disabled, tooltipVisible: tooltipVisible, tipFormatter: tipFormatter, unit: unit, tooltipPlacement: tooltipPlacement, onAfterChange: onAfterChange, onChange: this.onChange.bind(this) })),
                marks && (React__default["default"].createElement("div", { className: cx('InputRange-marks') }, keys__default["default"](marks).map(function (key) {
                    var _a, _b;
                    var offsetLeft = _this.getOffsetLeft(key);
                    if (MARKS_REG.test(offsetLeft)) {
                        return (React__default["default"].createElement("div", { key: key, style: { left: offsetLeft } },
                            React__default["default"].createElement("span", { style: (_a = marks[key]) === null || _a === void 0 ? void 0 : _a.style }, ((_b = marks[key]) === null || _b === void 0 ? void 0 : _b.label) || marks[key])));
                    }
                    else {
                        return null;
                    }
