...
var BaseResultTreeList = /** @class */ (function (_super) {
    ...
    BaseResultTreeList.getDerivedStateFromProps = function (props) {
        ...
        return {
            treeOptions: _.cloneDeep(newOptions)
        };
    };
    // 删除非选中节点
    BaseResultTreeList.prototype.deleteTreeChecked = function (option) {
        ...
        var cb = function (node) {
            ...
            if (_.isEqual(_.omit(node, 'parent'), _.omit(option, 'parent'))) {
                temNode = [node];
            }
        };
        ...
        onChange &&
            onChange(value.filter(function (item) {
                return !arr.find(function (arrItem) {
                    ...
                    return _.isEqual(_.omit(arrItem, ['isChecked', 'childrens', 'parent']), _.omit(item, 'parent'));
                });
            }));
        // 搜索时，重新生成树
    ...
    BaseResultTreeList.prototype.deleteResultTreeNode = function (option) {
        var arr = deepDeleteTree(_.cloneDeep(this.state.searchTreeOptions) || [], option, this.props.valueField);
