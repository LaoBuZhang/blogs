...
var HeadCellSelect = /** @class */ (function (_super) {
    ...
    HeadCellSelect.prototype.render = function () {
        ...
        return (React__default["default"].createElement(HeadCellDropDown["default"], { className: "".concat(ns, "TableCell-selectionBtn"), layerClassName: "".concat(ns, "TableCell-selectionPopOver"), filterIcon: React__default["default"].createElement(icons.Icon, { icon: "left-arrow", className: "icon" }), active: false, popOverContainer: popOverContainer ? popOverContainer : function () { return ReactDOM.findDOMNode(_this); }, filterDropdown: function (_a) {
