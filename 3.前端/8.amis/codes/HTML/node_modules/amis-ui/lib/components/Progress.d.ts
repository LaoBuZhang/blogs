...
declare const _default: {
    new (props: Pick<Omit<ProgressProps, keyof ThemeProps>, never> & Partial<Pick<Omit<ProgressProps, keyof ThemeProps>, "type" | "map" | "animate" | "value" | "placeholder" | "format" | "showLabel" | "stripe" | "gapDegree" | "gapPosition" | "strokeWidth" | "progressClassName" | "threshold" | "showThresholdText">> & Partial<Pick<Partial<ProgressProps>, "classPrefix" | "classnames" | "className" | "style" | "theme">> & import("packages/amis-core/lib/theme").ThemeOutterProps): {
        ref: any;
