...
var SubMenu = /** @class */ (function (_super) {
    ...
    SubMenu.prototype.renderSubMenuTitle = function () {
        ...
        var labelNode = label && typeof label === 'string' ? (React__default["default"].createElement("span", { className: cx('Nav-Menu-item-label', (_c = {},
                ...
                _c)), title: isCollapsedNode ? '' : label, style: this.getDynamicStyle(!!iconNode) }, label)) : React__default["default"].isValidElement(label) ? (React__default["default"].cloneElement(label, {
        ...
        var renderContent = function () {
            return isCollapsedNode ? (React__default["default"].createElement(React__default["default"].Fragment, null, iconNode || labelNode)) : (React__default["default"].createElement(React__default["default"].Fragment, null,
                dragNode,
                iconNode,
                labelNode,
                !stacked ? (React__default["default"].createElement("span", { key: "expand-toggle", className: cx('Nav-Menu-submenu-arrow') },
                    React__default["default"].createElement(CaretIcon, null))) : null));
        };
        return (React__default["default"].createElement("div", { className: cx('Nav-Menu-item-wrap') },
            React__default["default"].createElement(Badge.Badge, { classnames: cx, badge: badge ? tslib.__assign(tslib.__assign({}, badge), { className: badgeClassName }) : null, data: amisCore.createObject(defaultData, link) },
                React__default["default"].createElement("a", { className: cx("Nav-Menu-item-link"), "data-id": (link === null || link === void 0 ? void 0 : link.__id) || id, "data-depth": depth, onDragStart: onDragStart === null || onDragStart === void 0 ? void 0 : onDragStart(link) }, renderContent())),
