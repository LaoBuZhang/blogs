...
var CustomTimeView = /** @class */ (function (_super) {
    ...
    function CustomTimeView(props) {
        ...
        _this.renderDayPart = function () {
            ...
            return (React__default["default"].createElement("div", { key: "dayPart", className: cx('CalendarCounter CalendarCounter--daypart') },
                React__default["default"].createElement("span", { key: "up", className: cx('CalendarCounter-btn CalendarCounter-btn--up'), onClick: _this.onStartClicking('toggleDayPart', 'hours'), onContextMenu: _this.disableContextMenu },
                    React__default["default"].createElement(icons.Icon, { icon: "right-arrow-bold" })),
                React__default["default"].createElement("div", { className: cx('CalendarCounter-value'), key: _this.state.daypart }, __(_this.state.daypart)),
                React__default["default"].createElement("span", { key: "down", className: cx('CalendarCounter-btn CalendarCounter-btn--down'), onClick: _this.onStartClicking('toggleDayPart', 'hours'), onContextMenu: _this.disableContextMenu },
                    React__default["default"].createElement(icons.Icon, { icon: "right-arrow-bold" }))));
        };
        ...
        _this.renderCounter = function (type) {
            ...
            if (type !== 'daypart') {
                ...
                return (React__default["default"].createElement("div", { key: type, className: cx('CalendarCounter') },
                    React__default["default"].createElement("span", { key: "up", className: cx('CalendarCounter-btn CalendarCounter-btn--up'), onMouseDown: _this.onStartClicking('increase', type), onContextMenu: _this.disableContextMenu },
                        React__default["default"].createElement(icons.Icon, { icon: "right-arrow-bold" })),
                    React__default["default"].createElement("div", { key: "c", className: cx('CalendarCounter-value') },
                        React__default["default"].createElement("input", { type: "text", value: _this.pad(type, value), className: cx('CalendarInput'), min: min_1, max: max_1, step: step, onChange: function (e) {
                                return _this.props.setTime(type, Math.max(min_1, Math.min(parseInt(e.currentTarget.value.replace(/\D/g, ''), 10) ||
                                    0, max_1)));
                            } })),
                    React__default["default"].createElement("span", { key: "do", className: cx('CalendarCounter-btn CalendarCounter-btn--down'), onMouseDown: _this.onStartClicking('decrease', type), onContextMenu: _this.disableContextMenu },
                        React__default["default"].createElement(icons.Icon, { icon: "right-arrow-bold" }))));
            }
            return null;
        };
        ...
        _this.renderTimeViewPicker = function () {
            ...
            return (React__default["default"].createElement(Picker["default"], { translate: _this.props.translate, locale: _this.props.locale, title: title, columns: columns, value: values, onConfirm: _this.onConfirm, onClose: _this.props.onClose, showToolbar: _this.props.showToolbar, onChange: _this.onPickerChange }));
        };
    ...
    CustomTimeView.prototype.renderHeader = function () {
        ...
        return React__default["default"].createElement('thead', { key: 'h' }, React__default["default"].createElement('tr', {}, React__default["default"].createElement('th', {
            className: 'rdtSwitch',
            colSpan: 4,
    ...
    CustomTimeView.prototype.render = function () {
        ...
        if (amisCore.isMobile() && this.props.useMobileUI) {
            return (React__default["default"].createElement("div", { className: cx('CalendarTime') }, this.renderTimeViewPicker()));
        }
        timeFormat.split(':').forEach(function (format, i) {
            var type = /h/i.test(format)
                ? 'hours'
            ...
            if (type) {
                ...
                inputs.push(React__default["default"].createElement(Downshift__default["default"], { key: i + 'input', inputValue: date.format(formatMap_1[type]) }, function (_a) {
                    ...
                    return (React__default["default"].createElement("div", { className: cx('CalendarInputWrapper') },
                        React__default["default"].createElement("div", { className: cx('CalendarInput-sugs', type === 'hours'
                            ...
                            var _a;
                            return (React__default["default"].createElement("div", { key: option.value, className: cx('CalendarInput-sugsItem', {
                ...
                inputs.push(React__default["default"].createElement("span", { key: i + 'divider' }));
            }
        });
        ...
        return (React__default["default"].createElement(React__default["default"].Fragment, null,
            ...
            this.props.requiredConfirm && (React__default["default"].createElement("div", { className: cx('TimeFooterWrapper') },
                React__default["default"].createElement("div", { className: cx('QuickWrapper') }, quickLists),
                React__default["default"].createElement("a", { className: cx('Button', 'Button--primary', 'Button--size-sm'), onClick: this.confirm }, __('confirm'))))));
    };
