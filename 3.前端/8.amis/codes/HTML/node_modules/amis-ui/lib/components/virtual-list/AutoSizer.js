...
var AutoSizer = /** @class */ (function (_super) {
    ...
    AutoSizer.prototype.render = function () {
        ...
        return (React__namespace.createElement(WrapperCmpt, { style: tslib.__assign({ display: 'block', position: 'relative', width: '100%', height: '100%' }, (minHeight ? { minHeight: minHeight } : {})) }, children({
            width: width,
            height: height
        })));
    };
