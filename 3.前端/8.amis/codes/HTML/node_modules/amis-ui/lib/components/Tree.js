...
var TreeSelector = /** @class */ (function (_super) {
    ...
    TreeSelector.prototype.flattenOptions = function (props, initial) {
        ...
        amisCore.eachTree((props === null || props === void 0 ? void 0 : props.options) || this.props.options, function (item, key, level, paths) {
    ...
    TreeSelector.prototype.renderItem = function (_a) {
        ...
        return (React__default["default"].createElement("li", { key: item.key, className: cx("Tree-item ".concat(itemClassName || ''), {
    ...
    TreeSelector.prototype.renderList = function (list, value) {
        ...
        if (virtualThreshold && list.length > virtualThreshold) {
            return (React__default["default"].createElement(index["default"], { height: list.length > 8 ? 266 : list.length * itemHeight, itemCount: list.length, itemSize: itemHeight, 
