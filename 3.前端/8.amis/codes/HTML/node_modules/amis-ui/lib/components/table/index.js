...
function buildColumns(columns, thColumns, tdColumns, depth, id, fixed) {
    ...
    Array.isArray(columns) &&
        columns.forEach(function (column) {
            ...
            var newColumn = tslib.__assign(tslib.__assign({}, column), { rowSpan: childMaxLevel ? 1 : maxLevel - childMaxLevel + depth, colSpan: getThColSpan(column), groupId: groupId, depth: depth });
...
function getSummaryColumns(summary) {
    ...
    return tslib.__spreadArray([first], last, true);
}
...
var Table = /** @class */ (function (_super) {
    ...
    function Table(props) {
        ...
        _this.state = {
            ...
            expandedRowKeys: tslib.__spreadArray(tslib.__spreadArray([], (props.expandable ? props.expandable.expandedRowKeys || [] : []), true), (props.expandable
    ...
    Table.prototype.updateTableBodyFixed = function () {
        ...
        var tdColumns = tslib.__spreadArray([], this.tdColumns, true);
        if (!tbodyDom) {
            return;
        }
    ...
    Table.prototype.componentDidUpdate = function (prevProps, prevState) {
        ...
        if (!isEqual__default["default"](prevProps.dataSource, this.props.dataSource)) {
            this.setState({ dataSource: tslib.__spreadArray([], this.props.dataSource, true) }, function () {
    ...
    Table.prototype.updateTheadFixedRow = function (thead, columns) {
        ...
        for (var i = 0; i < children.length; i++) {
            var cols = tslib.__spreadArray([], columns[i], true);
            if (i === 0) {
    ...
    Table.prototype.getDataChildrenKeys = function (data) {
        ...
        if (this.hasChildrenRow(data)) {
            ...
            data[key].forEach(function (item) {
                return (keys = tslib.__spreadArray(tslib.__spreadArray(tslib.__spreadArray([], keys, true), _this.getDataChildrenKeys(item), true), [
    ...
    Table.prototype.hasCheckedRows = function (data) {
        ...
        return (intersection__default["default"](selectedRowKeys, tslib.__spreadArray(tslib.__spreadArray([], childrenKeys, true), [
                    ...
                    case 0:
                        ...
                        if (value) {
                            if (isRadio) {
                                ...
                                selectedRowKeys = tslib.__spreadArray(tslib.__spreadArray(tslib.__spreadArray([], this.state.selectedRowKeys, true), [
                                    data[defaultKey]
                            ...
                            if (!isRadio) {
                                selectedRowKeys = this.state.selectedRowKeys.filter(function (key) {
                                    return !tslib.__spreadArray([data[defaultKey]], _this.getDataChildrenKeys(data), true).includes(key);
                                });
                            }
                        }
    ...
    Table.prototype.renderRow = function (data, rowIndex, levels) {
        ...
        var children = !draggable && isExpandableRow && isExpanded ? (React__default["default"].createElement("tr", { key: "expanded", className: cx('Table-expanded-row', expandedRowClassName) },
            ...
            return _this.renderRow(item, index, tslib.__spreadArray(tslib.__spreadArray([], levels, true), [rowIndex], false));
        })) : null;
