...
var ResultBox = /** @class */ (function (_super) {
    ...
    ResultBox.prototype.renderMultipeTags = function (tags) {
        ...
        if (maxTagCount != null &&
            ...
            return tslib.__spreadArray(tslib.__spreadArray([], tags.slice(0, maxVisibleCount_1), true), [
                ...
                return index === maxVisibleCount_1 ? (React__default["default"].createElement(TooltipWrapper["default"], { key: tags.length, tooltip: tslib.__assign(tslib.__assign({}, tooltipProps_1), { children: function () { return (React__default["default"].createElement("div", { className: cx('ResultBox-overflow-wrapper') }, tags
                            .slice(maxVisibleCount_1, tags.length)
                            .map(function (item, index) {
                            var itemIndex = index + maxVisibleCount_1;
                            return (React__default["default"].createElement("div", { className: cx('ResultBox-value', {
                                    'is-invalid': showInvalidMatch && (item === null || item === void 0 ? void 0 : item.__unmatched)
                                }), key: itemIndex },
                                React__default["default"].createElement("span", { className: cx('ResultBox-valueLabel') }, itemRender(item)),
                                React__default["default"].createElement("a", { "data-index": itemIndex, onClick: _this.removeItem },
                                    React__default["default"].createElement(icons.Icon, { icon: "close", className: "icon" }))));
                        }))); } }) },
                    React__default["default"].createElement("div", { className: cx('ResultBox-value', {
                            'is-invalid': isShowInvalid
                        }), key: index },
                        React__default["default"].createElement("span", { className: cx('ResultBox-valueLabel') }, item.label)))) : (React__default["default"].createElement("div", { className: cx('ResultBox-value', {
                        'is-invalid': isShowInvalid
                    }), key: index },
                    React__default["default"].createElement("span", { className: cx('ResultBox-valueLabel') }, itemRender(item)),
                    React__default["default"].createElement("a", { "data-index": index, onClick: _this.removeItem },
                        React__default["default"].createElement(icons.Icon, { icon: "close", className: "icon" }))));
            });
        }
        return tags.map(function (item, index) { return (React__default["default"].createElement("div", { className: cx('ResultBox-value', {
                'is-invalid': showInvalidMatch && (item === null || item === void 0 ? void 0 : item.__unmatched)
            }), key: index },
            React__default["default"].createElement("span", { className: cx('ResultBox-valueLabel') }, itemRender(item)),
            React__default["default"].createElement("a", { "data-index": index, onClick: _this.removeItem },
    ...
    ResultBox.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('ResultBox', className, (_a = {
            ...
            React__default["default"].createElement("div", { className: cx('ResultBox-value-wrap') },
                Array.isArray(result) && result.length ? (this.renderMultipeTags(result)) : result && !Array.isArray(result) ? (React__default["default"].createElement("span", { className: cx('ResultBox-singleValue') }, isPlainObject__default["default"](result) ? itemRender(result) : result)) : allowInput && !disabled ? null : (React__default["default"].createElement("span", { className: cx('ResultBox-placeholder') }, __(placeholder || 'placeholder.noData'))),
                allowInput && !disabled ? (React__default["default"].createElement(Input["default"], tslib.__assign({}, rest, { className: cx('ResultBox-value-input'), onKeyPress: onKeyPress, ref: this.inputRef, value: value || '', onChange: this.handleChange, placeholder: __(
                ...
                children),
            React__default["default"].createElement("div", { className: cx('ResultBox-actions') },
                clearable &&
                    !disabled &&
                    (Array.isArray(result) ? result.length : result) ? (React__default["default"].createElement("a", { onClick: this.clearValue, className: cx('ResultBox-clear', {
                        'ResultBox-clear-with-arrow': hasDropDownArrow
                    }) },
                    React__default["default"].createElement("div", { className: cx('ResultBox-clear-wrap') },
                        React__default["default"].createElement(icons.Icon, { icon: "input-clear", className: "icon" })))) : null,
                actions,
                hasDropDownArrow && !mobileUI && (React__default["default"].createElement("span", { className: cx('ResultBox-pc-arrow') },
                    React__default["default"].createElement(icons.Icon, { icon: "right-arrow-bold", className: "icon" }))),
                !allowInput && mobileUI ? (React__default["default"].createElement("span", { className: cx('ResultBox-arrow') },
    ...
    ResultBox.defaultProps = {
        ...
        itemRender: function (option) { return (React__default["default"].createElement("span", null, "".concat(option.scopeLabel || '').concat(option.label))); }
    };
    tslib.__decorate([
        amisCore.autobind,
