...
var AsideNav = /** @class */ (function (_super) {
    ...
    AsideNav.prototype.renderLink = function (link, key, props, depth) {
        ...
        return (React__default["default"].createElement("li", tslib.__assign({}, props, { key: key, className: cx("AsideNav-item", link.className, (_a = {},
    ...
    AsideNav.prototype.render = function () {
        ...
        navigations.forEach(function (navigation, index) {
            ...
            navigation.label &&
                links.push(React__default["default"].createElement("li", { key: "".concat(index, "-label"), className: cx("AsideNav-label", navigation.className) },
                    React__default["default"].createElement("span", null, navigation.label)));
        ...
        return (React__default["default"].createElement("nav", { className: cx("AsideNav", className) },
            React__default["default"].createElement("ul", { className: cx("AsideNav-list") }, links)));
    };
    AsideNav.defaultProps = {
        renderLink: function (item) { return React__default["default"].createElement("a", null, item.label); },
        renderSubLinks: function (link, renderLink, depth, _a) {
            var cx = _a.classnames;
            return link.children && link.children.length ? (React__default["default"].createElement("ul", { className: cx('AsideNav-subList') },
                link.label ? (React__default["default"].createElement("li", { key: "subHeader", className: cx('AsideNav-subHeader') }, renderLink(tslib.__assign(tslib.__assign({}, link), { children: undefined }), 'subHeader', {}, depth))) : null,
                link.children.map(function (link, key) {
                    return renderLink(link, key, {}, depth + 1);
                }))) : link.label && depth === 1 ? (React__default["default"].createElement("div", { className: cx('AsideNav-tooltip') }, link.label)) : null;
        },
