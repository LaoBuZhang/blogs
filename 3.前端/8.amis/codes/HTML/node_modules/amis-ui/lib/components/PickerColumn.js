...
var PickerColumn = React.forwardRef(function (props, ref) {
    ...
    var renderOptions = function () {
        ...
        return state.options.map(function (option, index) {
            ...
            return (React__default["default"].createElement("li", tslib.__assign({}, data, { ref: menuItemRef }), props.optionRender ? (props.optionRender(option)) : (React__default["default"].createElement("div", tslib.__assign({}, childData)))));
        });
    };
    ...
    return (React__default["default"].createElement("div", { ref: root, className: props.classnames('PickerColumns', props.className), onTouchStart: onTouchStart, onTouchMove: onTouchMove, onTouchEnd: onTouchEnd, onTouchCancel: onTouchEnd },
        React__default["default"].createElement("ul", { ref: wrapper, style: wrapperStyle, className: props.classnames('PickerColumns-columnWrapper'), onTransitionEnd: stopMomentum }, renderOptions())));
});
