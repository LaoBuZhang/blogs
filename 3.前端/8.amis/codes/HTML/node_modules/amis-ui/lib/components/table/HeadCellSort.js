...
var HeadCellSort = /** @class */ (function (_super) {
    ...
    HeadCellSort.prototype.render = function () {
        ...
        return (React__default["default"].createElement("span", { className: cx('TableCell-sortBtn'), onClick: function () { return tslib.__awaiter(_this, void 0, void 0, function () {
            ...
            React__default["default"].createElement("i", { className: cx('TableCell-sortBtn--down', active && this.state.order === 'desc' ? 'is-active' : '') },
                React__default["default"].createElement(icons.Icon, { icon: "sort-desc", className: "icon" })),
            React__default["default"].createElement("i", { className: cx('TableCell-sortBtn--up', active && this.state.order === 'asc' ? 'is-active' : '') },
                React__default["default"].createElement(icons.Icon, { icon: "sort-asc", className: "icon" })),
            React__default["default"].createElement("i", { className: cx('TableCell-sortBtn--default', active ? '' : 'is-active') },
                React__default["default"].createElement(icons.Icon, { icon: "sort-default", className: "icon" }))));
    };
    return HeadCellSort;
