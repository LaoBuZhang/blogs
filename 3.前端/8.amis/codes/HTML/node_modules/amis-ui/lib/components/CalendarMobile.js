...
var CalendarMobile = /** @class */ (function (_super) {
    ...
    CalendarMobile.prototype.renderMobileDay = function (props, currentDate) {
        ...
        return (React__default["default"].createElement("td", tslib.__assign({}, renderProps.props),
            React__default["default"].createElement("div", { className: "calendar-wrap", onClick: function () { return _this.handleCalendarClick(renderProps.rdtDisabled); } },
                currentDate.date(),
                React__default["default"].createElement("div", { className: cx('CalendarMobile-range-text') }, renderProps.footerText))));
    };
    ...
    CalendarMobile.prototype.renderMobileCalendarBody = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('CalendarMobile-body'), ref: this.mobileBody, onScroll: this.onMobileBodyScroll }, calendarDates.map(function (calendarDate, index) {
            var rdtOldNone = showViewMode === 'months' &&
                calendarDate.clone().startOf('month').day() === 1
                ? 'rdtOldNone'
                : '';
            return (React__default["default"].createElement("div", { className: cx('CalendarMobile-calendar-wrap', rdtOldNone), key: 'calendar-wrap' + index },
                showViewMode === 'months' && (React__default["default"].createElement("div", { className: cx('CalendarMobile-calendar-mark'), key: 'calendar-mark' + index }, calendarDate.month() + 1)),
                React__default["default"].createElement("div", { className: cx('CalendarMobile-calendar-header') },
                    React__default["default"].createElement("span", { className: "rdtSwitch" }, calendarDate.format(__('dateformat.year'))),
                    showViewMode === 'months' && (React__default["default"].createElement("span", { className: "rdtSwitch" }, calendarDate.format(__('MMM'))))),
                React__default["default"].createElement(Calendar["default"], { className: cx('CalendarMobile-calendar', rdtOldNone), viewDate: calendarDate, value: calendarDate, onChange: _this.handleMobileChange, requiredConfirm: false, dateFormat: dateFormat, inputFormat: inputFormat, timeFormat: "", isValidDate: _this.checkIsValidDate, viewMode: viewMode, input: false, onClose: close, renderDay: _this.renderMobileDay, renderMonth: _this.renderMonth, renderQuarter: _this.renderQuarter, locale: locale, hideHeader: true, updateOn: viewMode, key: 'calendar' + index })));
        })));
    };
    CalendarMobile.prototype.renderMobileTimePicker = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('CalendarMobile-time') },
            React__default["default"].createElement("div", { className: cx('CalendarMobile-time-title') }, isDatePicker
                ? __('Date.titleTime')
                : startDate && endDate
                    ? __('Calendar.endPick')
                    : __('Calendar.startPick')),
            React__default["default"].createElement(Calendar["default"], { className: cx('CalendarMobile-time-calendar'), value: defaultDate, onChange: this.handleTimeChange, requiredConfirm: false, timeFormat: timeFormat, viewMode: "time", input: false, onClose: close, locale: locale, useMobileUI: true, showToolbar: false, viewDate: moment__default["default"]().set({
                    hour: dateTime[0],
                    minute: dateTime[1],
                    second: dateTime[2] || 0
    ...
    CalendarMobile.prototype.render = function () {
        ...
        var header = (React__default["default"].createElement("div", { className: cx('CalendarMobile-header'), ref: this.mobileHeader },
            React__default["default"].createElement("div", { className: cx('CalendarMobile-subtitle') },
                React__default["default"].createElement("span", { className: "subtitle-text" },
                    currentDate &&
                        currentDate.isSameOrBefore(minDate, showViewMode) ? null : (React__default["default"].createElement("a", { className: "rdtPrev", onClick: this.scrollPreYear }, "\u2039")),
                    dateNow,
                    (currentDate &&
                        currentDate.isSameOrAfter(maxDate, showViewMode)) ||
                        isScrollToBottom ? null : (React__default["default"].createElement("a", { className: "rdtNext", onClick: this.scrollAfterYear }, "\u203A")))),
            showViewMode === 'months' ? (React__default["default"].createElement("div", { className: cx('CalendarMobile-weekdays') }, this.getDaysOfWeek().map(function (day, index) { return (React__default["default"].createElement("span", { key: day + index, className: "weekday" }, day)); }))) : null));
        var footer = (React__default["default"].createElement("div", { className: cx('CalendarMobile-footer') },
            timeFormat && startDate && this.renderMobileTimePicker(),
            React__default["default"].createElement("div", { className: cx('CalendarMobile-footer-toolbar') },
                React__default["default"].createElement("div", { className: cx('CalendarMobile-footer-ranges') }, footerExtra),
                confirm && !embed && (React__default["default"].createElement("a", { className: cx('Button', 'Button--primary', 'date-range-confirm', {
                        'is-disabled': !startDate || !(endDate || isDatePicker)
                    }), onClick: function () {
                        confirm(startDate, endDate);
                        close && close();
                    } }, __('confirm'))))));
        return (React__default["default"].createElement("div", { className: cx('CalendarMobile', embed ? 'CalendarMobile-embed' : '', className) },
            React__default["default"].createElement("div", { className: cx('CalendarMobile-wrap') },
                header,
                this.renderMobileCalendarBody(),
                footer),
            showToast ? (React__default["default"].createElement("div", { className: cx('CalendarMobile-toast') }, __('Calendar.toast'))) : null));
    };
