...
var SchemaEditorItemCommon = /** @class */ (function (_super) {
    ...
    SchemaEditorItemCommon.prototype.renderCommon = function () {
        ...
        return (React__default["default"].createElement(React__default["default"].Fragment, null,
            prefix,
            types.length > 1 ? (React__default["default"].createElement(Select["default"], { options: types, className: cx('SchemaEditor-type'), value: (value === null || value === void 0 ? void 0 : value.$ref) || (value === null || value === void 0 ? void 0 : value.type) || 'string', onChange: this.handleTypeChange, clearable: false, disabled: disabled || typeMutable === false, simpleValue: true })) : null,
            onRequiredChange ? (React__default["default"].createElement(Checkbox["default"], { className: cx('SchemaEditor-required'), label: __('Required'), value: required, onChange: onRequiredChange, disabled: disabled || typeMutable === false })) : null, renderExtraProps === null || renderExtraProps === void 0 ? void 0 :
            renderExtraProps(value, this.handlePropsChange),
            enableAdvancedSetting ? (React__default["default"].createElement(PickerContainer["default"], { value: value, bodyRender: function (_a) {
                    var isOpened = _a.isOpened, value = _a.value, onChange = _a.onChange, ref = _a.ref;
                    return isOpened ? (React__default["default"].createElement(Form["default"], { defaultValue: value, onSubmit: onChange, ref: ref }, function (_a) {
                        var control = _a.control, getValues = _a.getValues, setValue = _a.setValue;
                        return (React__default["default"].createElement(React__default["default"].Fragment, null,
                            React__default["default"].createElement(FormField.Controller, { label: __('JSONSchema.title'), name: "title", control: control, rules: { maxLength: 20 }, isRequired: true, render: function (_a) {
                                    var field = _a.field;
                                    return (React__default["default"].createElement(InputBox["default"], tslib.__assign({}, field, { disabled: disabled })));
                                } }),
                            React__default["default"].createElement(FormField.Controller, { label: __('JSONSchema.description'), name: "description", control: control, render: function (_a) {
                                    var field = _a.field;
                                    return (React__default["default"].createElement(Textarea["default"], tslib.__assign({}, field, { disabled: disabled })));
                                } }),
                            React__default["default"].createElement(FormField.Controller, { label: __('JSONSchema.default'), name: "default", control: control, render: function (_a) {
                                    var field = _a.field;
                                    return (React__default["default"].createElement(InputBox["default"], tslib.__assign({}, field, { disabled: disabled })));
                ...
                return (React__default["default"].createElement(Button["default"], { disabled: disabled || !!(value === null || value === void 0 ? void 0 : value.$ref), className: cx('SchemaEditor-btn'), onClick: onClick },
                    React__default["default"].createElement(icons.Icon, { icon: "setting", className: "icon" })));
            })) : null,
            affix));
    };
    SchemaEditorItemCommon.prototype.render = function () {
        var cx = this.props.classnames;
        return React__default["default"].createElement("div", { className: cx('SchemaEditorItem') }, this.renderCommon());
    };
    tslib.__decorate([
        amisCore.autobind,
