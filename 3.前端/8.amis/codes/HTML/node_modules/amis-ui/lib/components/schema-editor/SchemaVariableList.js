...
var SchemaVariableList = /** @class */ (function (_super) {
    ...
    SchemaVariableList.prototype.itemRender = function (option) {
        ...
        return (React__default["default"].createElement("span", { className: cx("FormulaEditor-VariableList-item") },
            React__default["default"].createElement("label", null, option.label),
            React__default["default"].createElement(TooltipWrapper["default"], { tooltip: option.description, tooltipTheme: "dark" },
                React__default["default"].createElement("span", { className: cx("FormulaEditor-VariableList-item-tag") }, __("SchemaType.".concat(option.type || 'any'))))));
    };
    SchemaVariableList.prototype.render = function () {
        ...
        return (React__default["default"].createElement(VariableList["default"], { data: this.state.variables, value: value, onSelect: this.handleSelect, selectMode: selectMode || 'tree', itemRender: this.itemRender, placeholderRender: placeholderRender }));
    };
    tslib.__decorate([
        amisCore.autobind,
