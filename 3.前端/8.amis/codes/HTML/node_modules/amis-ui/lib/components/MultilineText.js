...
var MultilineText = /** @class */ (function (_super) {
    ...
    MultilineText.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('MultilineText', className), style: style },
            React__default["default"].createElement("div", { ref: this.ref, className: cx('MultilineText-counter'), style: {
                    height: "".concat(maxRows * 20, "px")
                } }, text),
            React__default["default"].createElement("div", { className: cx('MultilineText-display'), style: {
                    height: (showBtn && !isExpend) ? "".concat(maxRows * 20, "px") : 'auto'
                } }, text),
            showBtn &&
                React__default["default"].createElement("div", { className: cx('MultilineText-button-wrapper') },
                    React__default["default"].createElement(Button["default"], { className: cx('MultilineText-button'), level: "link", onClick: this.toggleExpend }, !isExpend ? expendButtonText : collapseButtonText))));
    };
