...
var NumberInput = /** @class */ (function (_super) {
    ...
    NumberInput.prototype.handleChange = function (value) {
        var _a = this.props, min = _a.min, max = _a.max, step = _a.step, precision = _a.precision, resetValue = _a.resetValue, onChange = _a.onChange;
        var finalPrecision = NumberInput.normalizePrecision(precision, step);
        var result = NumberInput.normalizeValue(value, min, max, finalPrecision, resetValue, this.isBig);
    ...
    NumberInput.prototype.renderBase = function () {
        ...
        return (React__default["default"].createElement(InputNumber__default["default"], tslib.__assign({ className: cx(className, showSteps === false ? 'no-steps' : '', displayMode === 'enhance' ? 'Number--enhance-input' : '', (_a = {},
    ...
    NumberInput.prototype.render = function () {
        ...
        return (React__default["default"].createElement(React__default["default"].Fragment, null, displayMode === 'enhance' ? (React__default["default"].createElement("div", { className: cx('Number--enhance', disabled ? 'Number--enhance-disabled' : '', showSteps === false ? 'Number--enhance-no-steps' : '', (_a = {},
                _a["Number--enhance-border".concat(amisCore.ucFirst(borderMode))] = borderMode,
                _a)) },
            React__default["default"].createElement("div", { className: cx('Number--enhance-left-icon', value && value === min ? 'Number--enhance-border-min' : '', disabled ? 'Number--enhance-border-disabled' : '', readOnly ? 'Number--enhance-border-readOnly' : ''), onClick: function () { return _this.handleEnhanceModeChange('subtract'); } },
                React__default["default"].createElement(icons.Icon, { icon: "minus", className: "icon", wrapClassName: cx('InputNumber-enhance-minus icon'), iconContent: "InputNumber-enhance-minus" })),
            this.renderBase(),
            React__default["default"].createElement("div", { className: cx('Number--enhance-right-icon', value && value === max ? 'Number--enhance-border-max' : '', disabled ? 'Number--enhance-border-disabled' : '', readOnly ? 'Number--enhance-border-readOnly' : ''), onClick: function () { return _this.handleEnhanceModeChange('add'); } },
                React__default["default"].createElement(icons.Icon, { icon: "plus", className: "icon", wrapClassName: cx('InputNumber-enhance-plus icon'), iconContent: "InputNumber-enhance-plus" })))) : (this.renderBase())));
    };
     ...
     * @param isBig 是否为大数模式
     */
    NumberInput.normalizeValue = function (value, min, max, precision, resetValue, isBig) {
        /**
         * 输入不合法时重置为resetValue
        ...
        if (value == null) {
            if (typeof resetValue !== 'number') {
                return resetValue !== null && resetValue !== void 0 ? resetValue : '';
            }
            value = resetValue;
        }
        // 处理max & min
