...
export declare class TableSelection extends BaseSelection<TableSelectionProps, any> {
    ...
    renderVirtualTable(): JSX.Element;
    render(): JSX.Element;
}
declare const _default: {
    new (props: Omit<Pick<Omit<TableSelectionProps, keyof import("amis-core").LocaleProps>, "classPrefix" | "classnames" | "className" | "style" | "theme" | "disabled" | "columns" | "value" | "onChange" | "onClick" | "inline" | "itemClassName" | "labelClassName" | "labelField" | "options" | "onDeferLoad" | "onLeftDeferLoad" | "option2value" | "virtualListHeight" | "placeholderRender" | "resultMode"> & Partial<Pick<Omit<TableSelectionProps, keyof import("amis-core").LocaleProps>, "multiple" | "placeholder" | "itemHeight" | "clearable" | "virtualThreshold" | "itemRender" | "cellRender">> & Partial<Pick<{
        cellRender: (column: {
            [propName: string]: any;
            name: string;
            label: string;
