...
var PullRefresh = React.forwardRef(function (props, ref) {
    ...
    return (React__default["default"].createElement("div", { className: cx('PullRefresh'), onTouchStart: onTouchStart, onTouchMove: onTouchMove, onTouchEnd: onTouchEnd, onTouchCancel: onTouchEnd },
        React__default["default"].createElement("div", { className: cx('PullRefresh-wrap'), style: transformStyle },
            React__default["default"].createElement("div", { className: cx('PullRefresh-header') },
                state.status === 'loading' && (React__default["default"].createElement(icons.Icon, { icon: "loading-outline", className: "icon loading-icon" })),
