...
var Progress = /** @class */ (function (_super) {
    ...
    Progress.prototype.getLabel = function (prefixCls) {
        ...
        return (React__default["default"].createElement("span", { className: cx("".concat(prefixCls, "-text")), key: "value" }, content));
    };
    Progress.prototype.render = function () {
        ...
        if (typeof value !== 'number') {
            viewValue = React__default["default"].createElement("span", { className: "text-muted" }, placeholder);
        }
        else if (type === 'line') {
            var barStyle = {
                width: "".concat(value, "%")
            ...
            viewValue = [
                React__default["default"].createElement("div", { className: cx(prefixCls, progressClassName), key: "circle", style: circleStyle },
                    React__default["default"].createElement(rcProgress.Circle, { percent: value, strokeColor: !isColorClass ? bgColor : '', strokeWidth: circleWidth, trailWidth: circleWidth, prefixCls: isColorClass ? bgColor : '', gapDegree: getGapDegree(), gapPosition: gapPos, style: circleStyle }),
                    this.getLabel(prefixCls))
            ];
        }
        return React__default["default"].createElement("div", { className: cx('Progress', className), style: style }, viewValue);
    };
