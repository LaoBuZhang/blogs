...
var Cascader = /** @class */ (function (_super) {
    ...
    Cascader.prototype.componentDidMount = function () {
        ...
        var tabs = parentTree.map(function (option) {
            ...
            return multiple && !onlyLeaf
                ? {
                    options: tslib.__spreadArray([
                        tslib.__assign(tslib.__assign({}, option), { isCheckAll: true })
        ...
        this.setState({
            ...
            tabs: tslib.__spreadArray(tslib.__spreadArray([], this.state.tabs, true), tabs, true)
        });
    };
    ...
    Cascader.prototype.renderOption = function (option, tabIndex) {
        ...
        var Text = optionRender ? (optionRender({ option: option, selected: selfChecked })) : (React__default["default"].createElement("span", null, option[labelField]));
        return (React__default["default"].createElement("li", { className: cx('Cascader-option', {
            ...
            React__default["default"].createElement("span", { className: cx('Cascader-option--text') }, Text)));
    };
    Cascader.prototype.renderOptions = function (options, tabIndex) {
        var _this = this;
        var cx = this.props.classnames;
        return (React__default["default"].createElement("ul", { key: tabIndex, className: cx('Cascader-options') }, options.map(function (option) { return _this.renderOption(option, tabIndex); })));
    };
    Cascader.prototype.renderTabs = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx("Cascader-tabs", depth > 3 ? 'scrollable' : ''), ref: this.tabsRef },
            tabs.map(function (tab, tabIndex) {
                var options = tab.options;
                return (React__default["default"].createElement("div", { className: cx("Cascader-tab"), ref: _this.tabRef, key: tabIndex }, _this.renderOptions(options, tabIndex)));
            }),
            depth <= 3 && options.length
                ? Array(amisCore.getTreeDepth(options) - tabs.length)
                    .fill(1)
                    .map(function (item, index) { return (React__default["default"].createElement("div", { className: cx("Cascader-tab"), key: index })); })
                : null));
    };
    Cascader.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx("Cascader", className) },
            React__default["default"].createElement("div", { className: cx("Cascader-btnGroup") },
                React__default["default"].createElement(Button["default"], { className: cx("Cascader-btnCancel"), level: "text", onClick: onClose }, __('cancel')),
                React__default["default"].createElement(Button["default"], { className: cx("Cascader-btnConfirm"), level: "text", onClick: this.confirm, disabled: this.state.disableConfirm }, __('confirm'))),
            this.renderTabs()));
    };
