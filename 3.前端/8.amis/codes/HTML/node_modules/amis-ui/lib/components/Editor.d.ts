...
declare const _default: {
    new (props: Omit<Pick<Omit<EditorProps, keyof LocaleProps>, "classPrefix" | "classnames" | "className" | "style" | "defaultValue" | "value" | "placeholder" | "onFocus" | "onBlur" | "onChange" | "context" | "isDiffEditor" | "editorDidMount" | "editorWillMount" | "editorWillUnmount" | "editorFactory"> & Partial<Pick<Omit<EditorProps, keyof LocaleProps>, "width" | "height" | "options" | "language" | "editorTheme" | "allowFullscreen">> & Partial<Pick<{
        language: string;
        editorTheme: string;
        width: string;
        height: string;
