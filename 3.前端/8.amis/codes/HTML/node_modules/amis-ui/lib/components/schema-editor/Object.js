...
var SchemaEditorItemObject = /** @class */ (function (_super) {
    ...
    SchemaEditorItemObject.prototype.rendererProps = function () {
        ...
        var members = this.state.members;
        return (React__default["default"].createElement("div", { className: cx('SchemaEditorProps', {
                'SchemaEditorProps--depth': showInfo !== false
            }) },
            members.length ? (members.map(function (member, index) { return (React__default["default"].createElement(Item.SchemaEditorItem, { key: member.id, types: types, onTypeChange: onTypeChange, enableAdvancedSetting: enableAdvancedSetting, prefix: React__default["default"].createElement(React__default["default"].Fragment, null,
                    React__default["default"].createElement(InputBox["default"], { className: cx('SchemaEditor-key'), hasError: member.hasError, value: member.key || '', onChange: _this.handlePropKeyChange.bind(_this, index), placeholder: __('JSONSchema.key'), disabled: disabled || !!(value === null || value === void 0 ? void 0 : value.$ref) }),
                    React__default["default"].createElement(InputBox["default"], { className: cx('SchemaEditor-title'), value: member.schema.title || '', onChange: _this.handlePropTitleChange.bind(_this, index), placeholder: __('JSONSchema.title'), disabled: disabled || !!(value === null || value === void 0 ? void 0 : value.$ref) })), affix: React__default["default"].createElement(Button["default"], { className: cx('SchemaEditor-btn'), onClick: _this.handlePropRemove.bind(_this, index), iconOnly: true, disabled: disabled || !!(value === null || value === void 0 ? void 0 : value.$ref) },
                    React__default["default"].createElement(icons.Icon, { icon: "remove", className: "icon" })), value: member.schema, onChange: _this.handlePropChange.bind(_this, index), renderExtraProps: renderExtraProps, renderModalProps: renderModalProps, locale: locale, translate: __, classnames: cx, classPrefix: classPrefix, disabled: disabled || !!(value === null || value === void 0 ? void 0 : value.$ref), required: member.required, onRequiredChange: _this.handlePropRequiredChange.bind(_this, index) })); })) : (React__default["default"].createElement("div", { className: cx('SchemaEditorProps-placeholder') }, __('placeholder.empty'))),
            React__default["default"].createElement(Button["default"], { level: "link", onClick: this.handleAdd, size: "xs", disabled: disabled || !!(value === null || value === void 0 ? void 0 : value.$ref) }, __('JSONSchema.add_prop'))));
    };
    SchemaEditorItemObject.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('SchemaEditorItem SchemaEditorObject', {
                'is-collapsed': this.state.collapsed
            }) },
            showInfo !== false ? (React__default["default"].createElement(React__default["default"].Fragment, null,
                React__default["default"].createElement("a", { className: cx('SchemaEditor-caret', {
                        'is-collapsed': this.state.collapsed
