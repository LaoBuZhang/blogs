...
var ArrayInput = /** @class */ (function (_super) {
    ...
    ArrayInput.prototype.renderItem = function (value, index, collection) {
        ...
        return (React__default["default"].createElement("div", { className: cx('ArrayInput-item'), key: index },
            sortable && collection.length > 1 && !disabled ? (React__default["default"].createElement("a", { className: cx('ArrayInput-itemDrager drag-bar') },
            ...
            removable !== false &&
                !disabled &&
                (!minLength || collection.length > minLength) ? (React__default["default"].createElement("a", { "data-index": index, className: cx('ArrayInput-itemRemove'), onClick: this.handleRemove },
    ...
    ArrayInput.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('ArrayInput') },
            Array.isArray(value) && value.length ? (React__default["default"].createElement("div", { className: cx('ArrayInput-items drag-group') }, value.map(function (item, index) { return _this.renderItem(item, index, value); }))) : (React__default["default"].createElement("div", { className: cx('ArrayInput-placeholder') }, __(placeholder))),
            React__default["default"].createElement("div", { className: cx('ArrayInput-toolbar', sortable && Array.isArray(value) && value.length > 1
                    ? 'ArrayInput-toolbar--dnd'
                    : '') },
                !Array.isArray(value) || !maxLength || value.length < maxLength ? (React__default["default"].createElement(Button["default"], { className: cx('ArrayInput-addBtn'), onClick: this.handleAdd, level: "", disabled: disabled },
                ...
                sortable && Array.isArray(value) && value.length ? (React__default["default"].createElement("span", { className: cx("ArrayInput-sortTip"), ref: this.dragTipRef }, Array.isArray(value) && value.length > 1 ? __(sortTip) : '')) : null)));
    };
    ArrayInput.defaultProps = {
        placeholder: 'empty',
        itemRender: function (_a) {
            var value = _a.value, onChange = _a.onChange;
            return React__default["default"].createElement(InputBox["default"], { value: value, onChange: onChange });
        }
    };
    tslib.__decorate([
        amisCore.autobind,
