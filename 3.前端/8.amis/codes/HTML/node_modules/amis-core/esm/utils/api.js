...
import { qsparse, JSONTraverse, uuid, qsstringify, isObjectShallowModified, hasFile, object2formData } from './helper.js';
import isPlainObject from 'lodash/isPlainObject';
import { debug, warning } from './debug.js';
...
function responseAdaptor(ret, api) {
    ...
    if (payload.ok && api.responseData) {
        ...
        var responseData = dataMapping(api.responseData, createObject({ api: api }, (Array.isArray(payload.data)
            ? {
                items: payload.data
            }
...
export { buildApi, clearApiCache, getApiCache, isApiOutdated, isApiOutdatedWithData, isEffectiveApi, isSameApi, isValidApi, jsFetcher, jsonpFetcher, normalizeApi, normalizeApiResponseData, responseAdaptor, setApiCache, str2AsyncFunction, str2function, wrapAdaptor, wrapFetcher };
