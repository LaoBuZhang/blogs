            ...
            switch (_f.label) {
                ...
                case 1:
                    ...
                    if (!json.ok) {
                        ...
                        getEnv(self).notify('error', (_e = (_d = apiObject.messages) === null || _d === void 0 ? void 0 : _d.failed) !== null && _e !== void 0 ? _e : (self.errors.join('') || "".concat(apiObject.url, "\uFF1A").concat(json.msg)), json.msgTimeout !== undefined
                            ? {
                                closeButton: true,
