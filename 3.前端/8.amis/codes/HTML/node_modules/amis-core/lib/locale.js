...
function makeTranslator(locale) {
    ...
    var fn = function (str) {
        ...
        var value = ((_a = locales[locale]) === null || _a === void 0 ? void 0 : _a[str]) ||
            ...
            str;
        return format.apply(void 0, tslib.__spreadArray([value], args, false));
    };
...
function localeable(ComposedComponent) {
    ...
    var result = hoistNonReactStatic__default["default"]((_a = /** @class */ (function (_super) {
            ...
            class_1.prototype.render = function () {
                ...
                var body = (React__default["default"].createElement(ComposedComponent, tslib.__assign({}, this.props, injectedProps, refConfig)));
                return this.context ? (body) : (React__default["default"].createElement(LocaleContext.Provider, { value: locale }, body));
            };
            return class_1;
