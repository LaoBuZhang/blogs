...
function themeable(ComposedComponent) {
    ...
    var result = hoistNonReactStatic__default["default"]((_a = /** @class */ (function (_super) {
            ...
            class_1.prototype.render = function () {
                ...
                var body = (React__default["default"].createElement(ComposedComponent, tslib.__assign({}, config.getComponentConfig(ComposedComponent.themeKey), this.props, injectedProps, refConfig)));
                return this.context ? (body) : (React__default["default"].createElement(ThemeContext.Provider, { value: theme }, body));
            };
            return class_1;
