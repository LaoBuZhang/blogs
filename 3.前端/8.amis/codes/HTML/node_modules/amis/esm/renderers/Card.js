...
import { __extends, __assign, __rest, __decorate, __metadata, __spreadArray } from 'tslib';
import React from 'react';
import omit from 'lodash/omit';
import { filter, evalExpression, noop, padArr, isVisible, isDisabled, resolveVariable, hashCode, resolveVariableAndFilter, Renderer } from 'amis-core';
...
var CardRenderer = /** @class */ (function (_super) {
    ...
    CardRenderer.prototype.renderToolbar = function () {
        ...
        if (selectable && !hideCheckToggler) {
            toolbars.push(React.createElement(Checkbox, { key: "check", className: cx('Card-checkbox'), type: multiple ? 'checkbox' : 'radio', disabled: !checkable, checked: selected, onChange: checkOnItemClick ? noop : this.handleCheck }));
        }
