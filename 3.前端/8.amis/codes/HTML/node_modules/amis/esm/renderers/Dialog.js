...
import { guid, filter, autobind, isVisible, createObject, ScopedContext, Renderer, ModalStore, isObjectShallowModified } from 'amis-core';
...
var Dialog = /** @class */ (function (_super) {
    ...
    Dialog.prototype.renderFooter = function () {
        ...
        return (React.createElement("div", { className: cx('Modal-footer') },
            (showLoading !== false && store.loading) ||
                ...
                store.error && showErrorMsg !== false ? (React.createElement("span", { className: cx('Dialog-error') }, store.msg)) : null)) : null,
    ...
    Dialog.prototype.render = function () {
        ...
        return (React.createElement(Wrapper, { classPrefix: classPrefix, className: cx(className), style: style, size: size, height: height, width: width, backdrop: "static", onHide: this.handleSelfClose, keyboard: closeOnEsc && !store.loading, closeOnEsc: closeOnEsc, closeOnOutside: !store.dialogOpen && closeOnOutside, show: show, onEntered: this.handleEntered, onExited: this.handleExited, container: env && env.getModalContainer ? env.getModalContainer : undefined, enforceFocus: false, disabled: store.loading },
            title && typeof title === 'string' ? (React.createElement("div", { className: cx('Modal-header', headerClassName) },
                ...
                React.createElement("div", { className: cx('Modal-title') }, filter(__(title), store.formData)))) : title ? (React.createElement("div", { className: cx('Modal-header', headerClassName) },
            ...
            header
                ...
                : null,
            (!store.entered && lazyRender) || (lazySchema && !body) ? (React.createElement("div", { className: cx('Modal-body', bodyClassName), role: "dialog-body" },
                React.createElement(Spinner, { overlay: true, show: true, size: "lg", loadingConfig: loadingConfig }))) : body ? (
            // dialog-body 用于在 editor 中定位元素
            React.createElement("div", { className: cx('Modal-body', bodyClassName), role: "dialog-body" }, this.renderBody(body, 'body'))) : null,
            this.renderFooter(),
            body
...
/** @class */ ((function (_super) {
    ...
    DialogRenderer.prototype.handleAction = function (e, action, data, throwErrors, delegate) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _a, onAction, store, onConfirm, env, dispatchEvent, onClose, scoped, rendererEvent, rendererEvent, handleResult, ret;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 5:
                        if (action.actionType === 'next' || action.actionType === 'prev') {
                            ...
                            ret = onAction(e, __assign(__assign({}, action), { close: false }), data, throwErrors, delegate || this.context);
                            action.close &&
                                (ret && ret.then
