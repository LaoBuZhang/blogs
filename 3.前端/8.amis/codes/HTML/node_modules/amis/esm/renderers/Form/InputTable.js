...
import { SimpleMap, isPureVariable, resolveVariableAndFilter, getVariable, dataMapping, isEffectiveApi, filterDate, setVariable, isExpression, createObject, filter, generateIcon, getTree, spliceTree, autobind, FormItem } from 'amis-core';
...
var FormTable = /** @class */ (function (_super) {
    ...
    FormTable.prototype.componentDidUpdate = function (nextProps) {
        ...
        if (props.value !== nextProps.value) {
            toUpdate = __assign(__assign({}, toUpdate), { items: Array.isArray(props.value) ? props.value.concat() : [], editIndex: -1, raw: undefined });
        }
    ...
    FormTable.prototype.validate = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, value, __, columns, minLength, maxLength, subForms_1, results_1, msg, uniqueColumn_1, children;
            var _this = this;
    ...
    FormTable.prototype.doAction = function (action, ctx) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _c, onAction, valueField, env, needConfirm, addable, addApi, __, items_1, toAdd_1, payload, items_2, toRemove;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _c = this.props, onAction = _c.onAction, valueField = _c.valueField, env = _c.env, _c.onChange, _c.editable, needConfirm = _c.needConfirm, addable = _c.addable, addApi = _c.addApi, __ = _c.translate;
    ...
    FormTable.prototype.copyItem = function (index) {
        ...
        this.setState({
            ...
            if (needConfirm === false) {
                ...
                _this.startEdit(index, true, true);
            }
        });
    };
    ...
    FormTable.prototype.startEdit = function (index, isCreate, isCopy) {
    ...
    FormTable.prototype.confirmEdit = function () {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var _c, addApi, updateApi, data, env, __, subForms, items, item, isNew, remote, apiMsg;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _c = this.props, addApi = _c.addApi, updateApi = _c.updateApi, data = _c.data, env = _c.env, __ = _c.translate;
                        subForms = [];
                        ...
                        remote = null;
                        apiMsg = undefined;
                        if (!(isNew && isEffectiveApi(addApi, createObject(data, item)))) return [3 /*break*/, 2];
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2:
                        if (!isEffectiveApi(updateApi, createObject(data, item))) return [3 /*break*/, 4];
    ...
    FormTable.prototype.removeItem = function (index) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var _c, value, onChange, deleteApi, deleteConfirmText, env, data, __, newValue, item, ctx, confirmed, result;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!isEffectiveApi(deleteApi, ctx)) return [3 /*break*/, 3];
    ...
    FormTable.prototype.buildColumns = function (props, isCreateMode) {
            ...
            btns.push({
                children: function (_a) {
                    ...
                    return (~_this.state.editIndex && needConfirm !== false) ||
                        maxLength <= _this.state.items.length ? null : (React.createElement(Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('Table.addRow'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, onClick: _this.addItem.bind(_this, rowIndex + offset, undefined) },
                        props.addBtnLabel ? React.createElement("span", null, props.addBtnLabel) : null,
                        props.addBtnIcon ? (typeof props.addBtnIcon === 'string' ? (React.createElement(Icon, { icon: props.addBtnIcon, className: "icon" })) : (generateIcon(props.classnames, props.addBtnIcon))) : null));
                }
            });
        }
        if (props.copyable && props.showCopyBtn !== false) {
            btns.push({
                children: function (_a) {
                    var key = _a.key, rowIndex = _a.rowIndex, offset = _a.offset;
                    return ~_this.state.editIndex && needConfirm !== false ? null : (React.createElement(Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('Table.copyRow'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, onClick: _this.copyItem.bind(_this, rowIndex + offset, undefined) },
                        props.copyBtnLabel ? React.createElement("span", null, props.copyBtnLabel) : null,
                        props.copyBtnIcon ? (typeof props.copyBtnIcon === 'string' ? (React.createElement(Icon, { icon: props.copyBtnIcon, className: "icon" })) : (generateIcon(props.classnames, props.copyBtnIcon))) : null));
                }
            });
        }
        if (props.needConfirm === false) {
            columns = columns.map(function (column) {
                ...
                return quickEdit === false
                    ...
                    : __assign(__assign({}, column), { quickEdit: __assign(__assign(__assign({}, _this.columnToQuickEdit(column)), quickEdit), { saveImmediately: true, mode: 'inline' }) });
            });
        }
            ...
            props.editable &&
                btns.push({
                    children: function (_a) {
                        ...
                        return ~_this.state.editIndex || (data && data.__isPlaceholder) ? null : (React.createElement(Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('Table.editRow'), tooltipContainer: env && env.getModalContainer
                            ...
                            typeof props.updateBtnIcon !== 'undefined' ? (props.updateBtnIcon ? (typeof props.updateBtnIcon === 'string' ? (React.createElement(Icon, { icon: props.updateBtnIcon, className: "icon" })) : (generateIcon(props.classnames, props.updateBtnIcon))) : null) : props.editBtnIcon ? (typeof props.editBtnIcon === 'string' ? (React.createElement(Icon, { icon: props.editBtnIcon, className: "icon" })) : (generateIcon(props.classnames, props.editBtnIcon))) : null));
                    }
                });
            btns.push({
                children: function (_a) {
                    var key = _a.key, rowIndex = _a.rowIndex, offset = _a.offset;
                    return _this.state.editIndex === rowIndex + offset ? (React.createElement(Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('save'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, onClick: _this.confirmEdit },
                        props.confirmBtnLabel ? (React.createElement("span", null, props.confirmBtnLabel)) : null,
                        props.confirmBtnIcon ? (typeof props.confirmBtnIcon === 'string' ? (React.createElement(Icon, { icon: props.confirmBtnIcon, className: "icon" })) : (generateIcon(props.classnames, props.confirmBtnIcon))) : null)) : null;
                }
            });
            btns.push({
                children: function (_a) {
                    var key = _a.key, rowIndex = _a.rowIndex, offset = _a.offset;
                    return _this.state.editIndex === rowIndex + offset ? (React.createElement(Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('cancel'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, onClick: _this.cancelEdit },
                        props.cancelBtnLabel ? (React.createElement("span", null, props.cancelBtnLabel)) : null,
                        props.cancelBtnIcon ? (typeof props.cancelBtnIcon === 'string' ? (React.createElement(Icon, { icon: props.cancelBtnIcon, className: "icon" })) : (generateIcon(props.classnames, props.cancelBtnIcon))) : null)) : null;
                }
            });
        }
        if (props.removable) {
            btns.push({
                children: function (_a) {
                    ...
                    return ((~_this.state.editIndex || (data && data.__isPlaceholder)) &&
                        needConfirm !== false) ||
                        minLength >= _this.state.items.length ? null : (React.createElement(Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('Table.deleteRow'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, onClick: _this.removeItem.bind(_this, rowIndex + offset) },
                        props.deleteBtnLabel ? (React.createElement("span", null, props.deleteBtnLabel)) : null,
                        props.deleteBtnIcon ? (typeof props.deleteBtnIcon === 'string' ? (React.createElement(Icon, { icon: props.deleteBtnIcon, className: "icon" })) : (generateIcon(props.classnames, props.deleteBtnIcon))) : null));
                }
            });
        }
        if (btns.length) {
    ...
    FormTable.prototype.handlePristineChange = function (data, rowIndex) {
        ...
        this.setState(function (prevState) {
            var items = cloneDeep(prevState.items);
    ...
    FormTable.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx('InputTable', className) },
            ...
            (addable &&
                ...
                showPager ? (React.createElement("div", { className: cx('InputTable-toolbar') },
                addable && showAddBtn !== false ? (React.createElement(Button, { disabled: disabled, size: "sm", onClick: function () { return _this.addItem(_this.state.items.length); } },
                    React.createElement(Icon, { icon: "plus", className: "icon" }),
                    React.createElement("span", null, __('add')))) : null,
                showPager
                    ? render('pager', {
                        type: 'pagination'
                    }, {
