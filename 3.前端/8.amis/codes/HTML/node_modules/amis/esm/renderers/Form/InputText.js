...
import { isEffectiveApi, createObject, setVariable, resolveEventData, ucFirst, highlight, filter, generateIcon, insertCustomStyle, autobind, OptionsControl } from 'amis-core';
...
var TextControl = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, dispatchEvent('enter', resolveEventData(this.props, { value: value_1 }, 'value'))];
                    case 2:
    ...
    TextControl.prototype.renderSugestMode = function () {
        ...
        return (React.createElement(Downshift, { isOpen: this.state.isOpen && !disabled && !readOnly, inputValue: this.state.inputValue, onChange: this.handleChange, onStateChange: this.handleStateChange, selectedItem: selectedOptions.map(function (item) { return item[valueField || 'value']; }) }, function (_a) {
            ...
            return (React.createElement("div", { className: cx("TextControl-input TextControl-input--withAC", inputControlClassName, inputOnly ? className : '', (_c = {
                        'is-opened': isOpen,
                ...
                React.createElement(React.Fragment, null,
                    placeholder &&
                        ...
                        !_this.state.isFocused ? (React.createElement("div", { className: cx('TextControl-placeholder') }, placeholder)) : null,
                ...
                clearable && !disabled && !readOnly && value ? (React.createElement("a", { onClick: _this.clearValue },
                    React.createElement(Icon, { icon: "input-clear", className: "icon", wrapClassName: cx('TextControl-clear'), iconContent: "InputBox-clear" }))) : null,
                ...
                isOpen && filtedOptions.length ? (React.createElement("div", { className: cx('TextControl-sugs') }, filtedOptions.map(function (option) {
    ...
    TextControl.prototype.renderNormal = function () {
        ...
        return (React.createElement("div", { className: cx('TextControl-input', (_a = {},
            ...
            type === 'password' && revealPassword && !disabled ? (React.createElement("a", { onClick: this.toggleRevealPassword, className: cx('TextControl-revealPassword') }, this.state.revealPassword ? (React.createElement(Icon, { icon: "view", className: cx('TextControl-icon-view'), wrapClassName: cx('TextControl-icon-view'), iconContent: "InputText-view" })) : (React.createElement(Icon, { icon: "invisible", className: cx('TextControl-icon-invisible'), wrapClassName: cx('TextControl-icon-invisible'), iconContent: "InputText-invisible" })))) : null,
    ...
    TextControl.prototype.renderBody = function (body) {
        var _a, _b;
        var _c = this.props, cx = _c.classnames, className = _c.className; _c.style; var ns = _c.classPrefix, addOnRaw = _c.addOn, render = _c.render, data = _c.data, disabled = _c.disabled, inputOnly = _c.inputOnly, isStatic = _c.static, addOnClassName = _c.addOnClassName;
        var addOn = typeof addOnRaw === 'string'
            ...
            : addOnRaw;
        var iconElement = generateIcon(cx, addOn === null || addOn === void 0 ? void 0 : addOn.icon, 'Icon');
        var addOnDom = addOn && !isStatic ? (addOn.actionType ||
            ~['button', 'submit', 'reset', 'action'].indexOf(addOn.type) ? (React.createElement("div", { className: cx("".concat(ns, "TextControl-button"), addOnClassName) }, render('addOn', addOn, {
            disabled: disabled
        }))) : (React.createElement("div", { className: cx("".concat(ns, "TextControl-addOn"), addOnClassName) },
            iconElement,
    ...
    TextControl.prototype.render = function () {
        var _a = this.props, options = _a.options, source = _a.source, autoComplete = _a.autoComplete, css = _a.css, inputControlClassName = _a.inputControlClassName, id = _a.id, addOnClassName = _a.addOnClassName;
