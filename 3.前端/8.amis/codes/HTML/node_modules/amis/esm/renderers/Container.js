...
import { isPureVariable, resolveVariableAndFilter, buildStyle, Renderer } from 'amis-core';
...
var Container = /** @class */ (function (_super) {
    ...
    Container.prototype.render = function () {
        ...
        var contentDom = (React.createElement(Component, { className: cx('Container', size && size !== 'none' ? "Container--".concat(size) : '', className), style: buildStyle(style, data) }, this.renderBody()));
