...
import { removeHTMLTag, decodeEntity, filter, getImageDimensions, toDataURL, getVariable, createObject, isPureVariable, resolveVariableAndFilter, TableStore } from 'amis-core';
        ...
        return __generator(this, function (_m) {
            switch (_m.label) {
                ...
                case 3:
                    ...
                    _m.label = 4;
                case 4:
                    if (!(_g < rows_1.length)) return [3 /*break*/, 22];
                    row = rows_1[_g];
                    ...
                    _m.label = 5;
                case 5:
                    if (!(_h < filteredColumns_1.length)) return [3 /*break*/, 21];
                ...
                case 12:
                    ...
                    if (isPureVariable(source)) {
                        sourceValue = resolveVariableAndFilter(source, rowData, '| raw');
                    }
                ...
                case 15:
                    ...
                    return [3 /*break*/, 20];
                case 16:
                    if (!(type === 'date' || type === 'static-date')) return [3 /*break*/, 17];
                    viewValue = void 0;
                    ...
                    return [3 /*break*/, 20];
                case 17:
                    if (!(type === 'input-city')) return [3 /*break*/, 19];
                ...
                case 21:
                    _g++;
                    return [3 /*break*/, 4];
                case 22: return [4 /*yield*/, workbook.xlsx.writeBuffer()];
                case 23:
                    buffer = _m.sent();
                    if (buffer) {
