...
import { resolveEventData, isObject, generateIcon, autobind, FormItem } from 'amis-core';
...
var SwitchControl = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dispatchEvent('change', resolveEventData(this.props, { value: checked }, 'value'))];
                    case 1:
    ...
    SwitchControl.prototype.getResult = function () {
        var _a = this.props, cx = _a.classnames, onText = _a.onText, offText = _a.offText;
        var on = isObject(onText)
            ? generateIcon(cx, onText.icon, 'Switch-icon')
            : onText;
        var off = isObject(offText)
    ...
    SwitchControl.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx("SwitchControl", className) }, this.renderBody(React.createElement(Switch, { classPrefix: ns, value: value, trueValue: trueValue, falseValue: falseValue, onText: on, offText: off, disabled: disabled, onChange: this.handleChange, size: size }))));
    };
