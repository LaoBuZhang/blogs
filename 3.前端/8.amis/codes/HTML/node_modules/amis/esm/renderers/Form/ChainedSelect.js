...
import { isEffectiveApi, resolveEventData, isMobile, OptionsControl } from 'amis-core';
...
var ChainedSelectControl = /** @class */ (function (_super) {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, dispatchEvent('change', resolveEventData(this.props, { value: valueRes }, 'value'))];
                        case 1:
    ...
    ChainedSelectControl.prototype.renderStatic = function (displayValue) {
        ...
        var allOptions = __spreadArray([
            { options: options, visible: true }
        ], (this.state.stack || []), true);
    ...
    ChainedSelectControl.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx("".concat(ns, "ChainedSelectControl"), className) },
            React.createElement(Select, __assign({}, rest, { useMobileUI: useMobileUI, popOverContainer: mobileUI && env && env.getModalContainer
            ...
            this.state.stack.map(function (_a, index) {
                ...
                return visible === false ? null : (React.createElement(Select, __assign({}, rest, { useMobileUI: useMobileUI, popOverContainer: mobileUI && env && env.getModalContainer
                        ? env.getModalContainer
