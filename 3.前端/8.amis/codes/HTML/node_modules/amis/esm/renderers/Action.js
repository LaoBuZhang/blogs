...
import { normalizeApi, str2AsyncFunction, insertCustomStyle, generateIcon, filter, autobind, themeable, isObject, createObject, ScopedContext, Renderer } from 'amis-core';
import { TooltipWrapper, Button, withBadge } from 'amis-ui';
...
var Action = /** @class */ (function (_super) {
    ...
    Action.prototype.render = function () {
        ...
        var iconElement = generateIcon(cx, icon, 'Button-icon', iconClassName);
        var rightIconElement = generateIcon(cx, rightIcon, 'Button-icon', rightIconClassName);
        return (React.createElement(Button, { loadingConfig: loadingConfig, className: cx(className, (_a = {},
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if ((action === null || action === void 0 ? void 0 : action.actionType) === 'click' && isObject(action === null || action === void 0 ? void 0 : action.args)) {
                            mergedData = createObject(data, __assign(__assign({}, action.args), { nativeEvent: e }));
                        }
                        ...
                        return [4 /*yield*/, env.confirm(confirmText)];
                    case 1:
                        confirmed = _b.sent();
