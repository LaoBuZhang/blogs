...
import { filterDate, resolveVariableAndFilter, anyChanged, isPureVariable, createObject, resolveEventData, isMobile, autobind, FormItem } from 'amis-core';
...
var DateControl = /** @class */ (function (_super) {
    ...
    function DateControl(props) {
        ...
        if (defaultValue && value === defaultValue) {
            var date = filterDate(defaultValue, data, format);
    ...
    DateControl.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (prevProps.defaultValue !== props.defaultValue) {
            var date = filterDate(props.defaultValue, props.data, props.format);
            props.setPrinstineValue((props.utc ? moment.utc(date) : date).format(props.format));
        }
    ...
    DateControl.prototype.dispatchEvent = function (e) {
        ...
        dispatchEvent(e, resolveEventData(this.props, { value: value }, 'value'));
    };
    // 动作
    ...
    DateControl.prototype.handleChange = function (nextValue) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                dispatcher = dispatchEvent('change', resolveEventData(this.props, { value: nextValue }, 'value'));
    ...
    DateControl.prototype.render = function () {
        var _a = this.props, className = _a.className; _a.style; _a.defaultValue; _a.defaultData; var cx = _a.classnames; _a.minDate; _a.maxDate; var type = _a.type, format = _a.format, timeFormat = _a.timeFormat, valueFormat = _a.valueFormat, env = _a.env, largeMode = _a.largeMode; _a.render; var useMobileUI = _a.useMobileUI, rest = __rest(_a, ["className", "style", "defaultValue", "defaultData", "classnames", "minDate", "maxDate", "type", "format", "timeFormat", "valueFormat", "env", "largeMode", "render", "useMobileUI"]);
        ...
        return (React.createElement("div", { className: cx("DateControl", {
            ...
            React.createElement(DatePicker, __assign({}, rest, { useMobileUI: useMobileUI, popOverContainer: mobileUI && env && env.getModalContainer
...
var DateControlRenderer = /** @class */ (function (_super) {
    ...
    DateControlRenderer.defaultProps = __assign(__assign({}, DateControl.defaultProps), { placeholder: 'Date.placeholder', dateFormat: 'YYYY-MM-DD', timeFormat: '', strictMode: false });
...
/** @class */ ((function (_super) {
    ...
    DatetimeControlRenderer.defaultProps = __assign(__assign({}, DateControl.defaultProps), { placeholder: 'DateTime.placeholder', inputFormat: 'YYYY-MM-DD HH:mm:ss', dateFormat: 'LL', timeFormat: 'HH:mm:ss', closeOnSelect: false, strictMode: false });
...
/** @class */ ((function (_super) {
    ...
    TimeControlRenderer.defaultProps = __assign(__assign({}, DateControl.defaultProps), { placeholder: 'Time.placeholder', inputFormat: 'HH:mm', dateFormat: '', timeFormat: 'HH:mm', viewMode: 'time', closeOnSelect: false });
...
/** @class */ ((function (_super) {
    ...
    MonthControlRenderer.defaultProps = __assign(__assign({}, DateControl.defaultProps), { placeholder: 'Month.placeholder', inputFormat: 'YYYY-MM', dateFormat: 'MM', timeFormat: '', viewMode: 'months', closeOnSelect: true, strictMode: false });
...
/** @class */ ((function (_super) {
    ...
    QuarterControlRenderer.defaultProps = __assign(__assign({}, DateControl.defaultProps), { placeholder: 'Quarter.placeholder', inputFormat: 'YYYY [Q]Q', dateFormat: 'YYYY [Q]Q', timeFormat: '', viewMode: 'quarters', closeOnSelect: true, strictMode: false });
...
/** @class */ ((function (_super) {
    ...
    YearControlRenderer.defaultProps = __assign(__assign({}, DateControl.defaultProps), { placeholder: 'Year.placeholder', inputFormat: 'YYYY', dateFormat: 'YYYY', timeFormat: '', viewMode: 'years', closeOnSelect: true, strictMode: false });
