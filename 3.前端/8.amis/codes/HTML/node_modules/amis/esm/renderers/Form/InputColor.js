...
import { isMobile, FormItem } from 'amis-core';
...
var ColorControl = /** @class */ (function (_super) {
    ...
    ColorControl.prototype.render = function () {
        var _a = this.props, className = _a.className; _a.style; var ns = _a.classPrefix, value = _a.value, env = _a.env; _a.static; var useMobileUI = _a.useMobileUI, rest = __rest(_a, ["className", "style", "classPrefix", "value", "env", "static", "useMobileUI"]);
        ...
        return (React.createElement("div", { className: cx("".concat(ns, "ColorControl"), className) },
            React.createElement(Suspense, { fallback: React.createElement("div", null, "...") },
                React.createElement(ColorPicker, __assign({ classPrefix: ns }, rest, { useMobileUI: useMobileUI, popOverContainer: mobileUI && env && env.getModalContainer
