...
import { filter, resolveEventData, autobind, stripNumber, FormItem } from 'amis-core';
...
var Input = /** @class */ (function (_super) {
    ...
    Input.prototype.handleInputNumberChange = function (value) {
        var _a;
        var _b = this.props, multiple = _b.multiple, originValue = _b.value, type = _b.type, min = _b.min, onChange = _b.onChange;
        var _value = this.getValue(value, type);
        onChange === null || onChange === void 0 ? void 0 : onChange(multiple
            ? __assign(__assign({}, originValue), (_a = {}, _a[type] = _value, _a)) : value !== null && value !== void 0 ? value : min);
    };
    /**
     * 双滑块 更新value
    ...
    Input.prototype.render = function () {
        var _a = this.props, cx = _a.classnames; _a.style; var value = _a.value, multiple = _a.multiple, type = _a.type, step = _a.step, ns = _a.classPrefix, disabled = _a.disabled, max = _a.max, min = _a.min;
        var _value = multiple
            ? type === 'min'
        ...
        return (React.createElement("div", { className: cx("".concat(ns, "InputRange-input")) },
            React.createElement(NumberInput, { value: +_value, step: step, max: this.checkNum(max), min: this.checkNum(min), onChange: this.handleInputNumberChange, disabled: disabled, onBlur: this.onBlur, onFocus: this.onFocus })));
    };
    __decorate([
        autobind,
...
var RangeControl = /** @class */ (function (_super) {
    ...
    RangeControl.prototype.render = function () {
        var _this = this;
        var value = this.state.value;
        var props = __assign(__assign({}, this.props), { value: value, onChange: this.handleChange, onAfterChange: this.onAfterChange });
        ...
        return (React.createElement("div", { className: cx('RangeControl', "".concat(ns, "InputRange"), { 'is-disabled': disabled }, className) },
