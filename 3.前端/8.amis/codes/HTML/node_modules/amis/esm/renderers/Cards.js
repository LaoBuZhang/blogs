...
import { resolveVariableAndFilter, getScrollParent, anyChanged, isPureVariable, createObject, difference, filter, ucFirst, autobind, Renderer, ListStore } from 'amis-core';
...
var Cards = /** @class */ (function (_super) {
    ...
    Cards.prototype.renderDragToggler = function () {
        ...
        return (React.createElement(Button, { iconOnly: true, key: "dragging-toggle", tooltip: __('Card.toggleDrag'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, size: "sm", active: store.dragging, onClick: function (e) {
                e.preventDefault();
    ...
    Cards.prototype.renderCard = function (index, card, item, itemClassName) {
        ...
        return (React.createElement("div", { key: item.index, className: cx(itemClassName) }, render("card/".concat(index), __assign({ 
            // @ts-ignore
    ...
    Cards.prototype.render = function () {
        var _this = this;
        var _a = this.props, className = _a.className, style = _a.style, store = _a.store, columnsCount = _a.columnsCount, itemClassName = _a.itemClassName, placeholder = _a.placeholder, card = _a.card, render = _a.render, affixHeader = _a.affixHeader, masonryLayout = _a.masonryLayout, itemsClassName = _a.itemsClassName, cx = _a.classnames, __ = _a.translate, _b = _a.loading, loading = _b === void 0 ? false : _b, loadingConfig = _a.loadingConfig;
        ...
        return (React.createElement("div", { ref: this.bodyRef, className: cx('Cards', className, {
            ...
            header,
            heading,
            store.items.length ? (React.createElement("div", { ref: this.itemsRef, className: cx('Cards-body Grid', itemsClassName, masonryClassName) }, store.items.map(function (item, index) {
