...
var CheckboxesControl = /** @class */ (function (_super) {
    ...
    CheckboxesControl.prototype.render = function () {
        ...
        if (checkAll && body.length && optionType === 'default') {
            body.unshift(React.createElement(Checkbox, { key: "checkall", className: itemClassName, onChange: onToggleAll, checked: !!selectedOptions.length, partial: inRange(selectedOptions.length, 0, flattenTreeWithLeafNodes(options).length), disabled: disabled, inline: inline, labelClassName: labelClassName }, __('Checkboxes.selectAll')));
        }
