...
import { isApiOutdated, createObject, isPureVariable, resolveVariableAndFilter, isEffectiveApi, resolveEventData, filter, getVariable, noop, autobind, OptionsControl } from 'amis-core';
...
var PickerControl = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dispatchEvent('change', resolveEventData(this.props, { value: value, option: option, selectedItems: option }, 'value'))];
                    case 1:
    ...
    PickerControl.prototype.renderValues = function () {
        ...
        return (React.createElement("div", { className: "".concat(ns, "Picker-values") }, selectedOptions.map(function (item, index) { return (React.createElement("div", { key: index, className: cx("".concat(ns, "Picker-value"), {
                'is-disabled': disabled
            }) },
            React.createElement("span", { "data-tooltip": __('delete'), "data-position": "bottom", className: "".concat(ns, "Picker-valueIcon"), onClick: function (e) {
                    e.stopPropagation();
                    _this.removeItem(index);
                } }, "\u00D7"),
            React.createElement("span", { className: "".concat(ns, "Picker-valueLabel"), onClick: function (e) {
                    e.stopPropagation();
                    _this.handleItemClick(item);
                } }, labelTpl ? (React.createElement(Html, { html: filter(labelTpl, item) })) : ("".concat(getVariable(item, labelField || 'label') ||
                getVariable(item, 'id')))))); })));
    };
    ...
    PickerControl.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx("PickerControl", className) }, embed ? (React.createElement("div", { className: cx('Picker') }, this.renderBody({ popOverContainer: popOverContainer }))) : (React.createElement("div", { className: cx("Picker", {
                'Picker--single': !multiple,
                'Picker--multi': multiple,
                'is-focused': this.state.isFocused,
                'is-disabled': disabled
            }) },
            React.createElement("div", { onClick: this.handleClick, className: cx('Picker-input') },
                ...
                React.createElement("div", { className: cx('Picker-valueWrap') },
                    this.renderValues(),
                    React.createElement("input", { onChange: noop, value: '', ref: this.input, onKeyDown: this.handleKeyDown, onFocus: this.handleFocus, onBlur: this.handleBlur })),
                ...
                React.createElement("span", { onClick: this.open, className: cx('Picker-btn') },
                    React.createElement(Icon, { icon: "window-restore", className: "icon" }))),
            render('modal', {
