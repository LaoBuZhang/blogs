...
export declare const ColorPicker: React.LazyExoticComponent<{
    new (props: Omit<Pick<Omit<import("amis-ui/lib/components/ColorPicker").ColorProps, keyof import("amis-core").LocaleProps>, "placement" | "className" | "disabled" | "style" | "classPrefix" | "classnames" | "theme" | "useMobileUI" | "popOverContainer" | "onChange" | "value" | "resetValue" | "popoverClassName" | "presetColors"> & Partial<Pick<Omit<import("amis-ui/lib/components/ColorPicker").ColorProps, keyof import("amis-core").LocaleProps>, "placeholder" | "clearable" | "format" | "allowCustomColor">> & Partial<Pick<{
        format: string;
        clearable: boolean;
        placeholder: string;
