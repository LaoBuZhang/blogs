...
var Log = /** @class */ (function (_super) {
    ...
    Log.prototype.loadLogs = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _d, source, data, env, __, encoding, maxLength, api, res, body, reader, lastline, logs, _e, done, value, text, lines;
            var _this = this;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        _d = this.props, source = _d.source, data = _d.data, env = _d.env, __ = _d.translate, encoding = _d.encoding, maxLength = _d.maxLength;
                    ...
                    case 5:
                        _e = _f.sent(), done = _e.done, value = _e.value;
                        if (value) {
    ...
    Log.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx('Log', className), style: style },
            React.createElement("div", { className: cx('Log-operation') }, operation && (operation === null || operation === void 0 ? void 0 : operation.length) > 0 && (React.createElement(React.Fragment, null,
                ...
                operation && operation.includes('filter') && (React.createElement(SearchBox, { className: cx('Log-filter-box'), placeholder: "\u8FC7\u6EE4\u8BCD", onChange: this.changeFilterWord }))))),
