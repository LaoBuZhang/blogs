...
import { __extends, __assign, __awaiter, __generator, __spreadArray, __decorate } from 'tslib';
import React, { Suspense } from 'react';
import { guid, isEmpty, dataMapping, prettyBytes, buildApi, createObject, qsparse, qsstringify, resolveEventData, filter, FormItem } from 'amis-core';
...
var ImageControl = /** @class */ (function (_super) {
    ...
    function ImageControl(props) {
        var _this_1 = this;
        var _a;
        _this_1 = _super.call(this, props) || this;
        _this_1.state = {
            uploading: false,
            locked: false,
            files: []
        ...
        var files = [];
        _this_1.initAutoFill = !!((_a = props.initAutoFill) !== null && _a !== void 0 ? _a : true);
        if (value) {
        ...
        _this_1.state = __assign(__assign({}, _this_1.state), { files: (_this_1.files = files), crop: _this_1.buildCrop(props), frameImageWidth: 0 });
    ...
    ImageControl.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (prevProps.value !== props.value) {
            ...
            if (value) {
                files = (Array.isArray(value)
                    ...
                    if (obj &&
                        ...
                        obj = __assign(__assign(__assign({}, org), obj), { id: org.id || obj.id });
                    }
                    return obj;
                })
                    .filter(function (item) { return item; });
            ...
            }, this.initAutoFill ? this.syncAutoFill : function () { });
        }
    ...
    ImageControl.prototype.handleDropRejected = function (rejectedFiles, evt) {
        ...
        var files = rejectedFiles.map(function (fileRejection) { return (__assign(__assign({}, fileRejection.file), { state: 'invalid', id: guid(), name: fileRejection.file.name })); });
        // this.setState({
    ...
    ImageControl.prototype.addFiles = function (files) {
        ...
        if (this.reuploadIndex !== undefined) {
            ...
            finalFiles.splice.apply(finalFiles, __spreadArray([this.reuploadIndex, 1], inputFiles, false));
            this.reuploadIndex = undefined;
        }
        else {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.dispatchEvent('success', __assign(__assign({}, file), { item: __assign(__assign({}, file), ret.data), value: obj.value }))];
                    case 1:
                        dispatcher = _a.sent();
                        if (dispatcher === null || dispatcher === void 0 ? void 0 : dispatcher.prevented) {
                            return [2 /*return*/];
        ...
        img.onload = function () {
            ...
            _this_1.unmounted ||
                _this_1.setState({
                    ...
                    if (!needUploading) {
                        _this_1.onChange(false, true, _this_1.initAutoFill);
                    }
                });
        };
        img.src = imgDom.src;
    ...
    ImageControl.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx("ImageControl", className) }, cropFile ? (React.createElement("div", { className: cx('ImageControl-cropperWrapper') },
            ...
            React.createElement("div", { className: cx('ImageControl-croperToolbar') },
                ...
                React.createElement("a", { className: cx('ImageControl-cropConfirm'), onClick: this.handleCrop, "data-tooltip": __('confirm'), "data-position": "left" },
                    React.createElement(Icon, { icon: "check", className: "icon" }))))) : (React.createElement(DropZone, { key: "drop-zone", ref: this.dropzone, onDrop: this.handleDrop, onDropRejected: this.handleDropRejected, accept: accept, multiple: multiple, disabled: disabled }, function (_a) {
            ...
            return (React.createElement("div", __assign({}, getRootProps({
                ...
                isDragActive || isDragAccept || isDragReject ? (React.createElement("div", { className: cx('ImageControl-acceptTip', {
                    ...
                    files && files.length
                        ? files.map(function (file, key) { return (React.createElement("div", { key: file.id || key, className: cx('ImageControl-item', {
                            ...
                            file.state === 'error' ? (React.createElement("div", { className: cx('Image--thumb') },
                            React.createElement("div", { className: cx('Image-thumbWrap') },
                                ...
                                React.createElement("div", { className: cx('Image-overlay') },
                                    React.createElement("a", { "data-tooltip": __('File.repick'), "data-position": "bottom", onClick: _this_1.handleRetry.bind(_this_1, key) },
                    ...
                    (multiple && (!maxLength || files.length < maxLength)) ||
                        (!multiple && !files.length) ? (React.createElement("label", { className: cx('ImageControl-addBtn', {
                            'is-disabled': disabled
                        ...
                        filterFrameImage ? (React.createElement(ThemedImageThumb, { key: "upload-default-image", src: filterFrameImage, className: cx(fixedSize ? 'Image-thumb--fixed-size' : ''), onLoad: _this_1.handleFrameImageLoaded.bind(_this_1), thumbMode: thumbMode, thumbRatio: thumbRatio })) : (React.createElement(React.Fragment, null,
                            React.createElement(Icon, { icon: "plus-fine", className: "icon" }),
                            React.createElement("span", { className: cx('ImageControl-addBtn-text') }, __('Image.upload')))),
                        isFocused ? (React.createElement("span", { className: cx('ImageControl-pasteTip') }, __('Image.pasteTip'))) : null)) : null,
