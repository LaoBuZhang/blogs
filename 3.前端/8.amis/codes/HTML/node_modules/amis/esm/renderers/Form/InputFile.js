...
import { guid, createObject, normalizeApi, buildApi, isEmpty, dataMapping, qsstringify, resolveEventData, prettyBytes, FormItem, isEffectiveApi, isApiOutdated, isApiOutdatedWithData } from 'amis-core';
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.dispatchEvent('success', __assign(__assign({}, file), { item: __assign(__assign({}, file), ret.data), value: value }))];
                    case 1:
                        dispatcher = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, env.fetcher(api, data, __assign(__assign({ method: 'post' }, options), { withCredentials: true, cancelExecutor: function (cancelExecutor) {
                                    // 记录取消器，取消的时候要调用
        ...
        return (React.createElement("div", { className: cx('FileControl', className) },
            ...
            React.createElement(DropZone, { disabled: disabled, key: "drop-zone", ref: this.dropzone, onDrop: this.handleDrop, onDropRejected: this.handleDropRejected, accept: accept === '*' ? '' : accept, multiple: multiple }, function (_a) {
                ...
                return (React.createElement("div", __assign({}, getRootProps({
                    ...
                    React.createElement("input", __assign({ disabled: disabled }, getInputProps())),
                    drag || isDragActive ? (React.createElement("div", { className: cx('FileControl-acceptTip'), onClick: _this.handleSelect },
                        ...
                        React.createElement(Button, { level: "default", disabled: disabled, className: cx('FileControl-selectBtn', btnClassName, {
            ...
            Array.isArray(files) ? (React.createElement("ul", { className: cx('FileControl-list') }, files.map(function (file, index) {
                ...
                return (React.createElement("li", { key: file.id },
                    React.createElement(TooltipWrapper, { placement: "bottom", tooltipClassName: cx('FileControl-list-tooltip'), tooltip: file.state === 'invalid' || file.state === 'error'
                            ? file.error ||
