...
import { normalizeApi, buildApi, qsstringify, ucFirst, LazyComponent, FormItem } from 'amis-core';
...
var RichTextControl = /** @class */ (function (_super) {
    ...
    function RichTextControl(props) {
        ...
        var imageReceiver = normalizeApi(props.receiver, props.receiver.method || 'post');
        ...
        if (finnalVendor === 'froala') {
            ...
            _this.config = __assign(__assign({ imageAllowedTypes: ['jpeg', 'jpg', 'png', 'gif'], imageDefaultAlign: 'left', imageEditButtons: props.imageEditable
                    ? [
                        'imageReplace',
                        'imageAlign',
                        'imageRemove',
            ...
            _this.config = __assign(__assign({}, props.options), { images_upload_handler: function (blobInfo, progress) {
    ...
    RichTextControl.prototype.render = function () {
        var _a;
        var _b = this.props, className = _b.className; _b.style; var ns = _b.classPrefix, value = _b.value; _b.onChange; var disabled = _b.disabled; _b.size; var vendor = _b.vendor, env = _b.env, locale = _b.locale, translate = _b.translate, borderMode = _b.borderMode;
        ...
        return (React.createElement("div", { className: cx("".concat(ns, "RichTextControl"), className, (_a = {
                ...
                _a)) },
            React.createElement(LazyComponent, { getComponent: loadRichText(finnalVendor), model: value, onModelChange: this.handleChange, onFocus: this.handleFocus, onBlur: this.handleBlur, config: this.config, disabled: disabled, locale: locale, translate: translate })));
    };
