...
import { resolveEventData, isEffectiveApi, normalizeOptions, getTreeAncestors, toNumber, isMobile, Overlay, PopOver, autobind, OptionsControl } from 'amis-core';
...
var TreeSelectControl = /** @class */ (function (_super) {
    ...
    function TreeSelectControl(props) {
        ...
        _this.handleInputChange = debouce(_this.handleInputChange.bind(_this), 150, {
            trailing: true,
            leading: false
        });
    ...
    TreeSelectControl.prototype.handleFocus = function (e) {
        ...
        dispatchEvent('focus', resolveEventData(this.props, { value: value }, 'value'));
    };
    TreeSelectControl.prototype.handleBlur = function (e) {
        var _a = this.props, dispatchEvent = _a.dispatchEvent, value = _a.value; _a.data;
        dispatchEvent('blur', resolveEventData(this.props, { value: value }, 'value'));
    };
        ...
        if (Array.isArray(selectedOptions) && selectedOptions.length) {
            selectedOptions.forEach(function (option) {
                if (!find(combinedOptions, function (item) { return item.value == option.value; })) {
                    combinedOptions.push(__assign(__assign({}, option), { visible: false }));
                }
            });
        }
    ...
    TreeSelectControl.prototype.resultChangeEvent = function (value) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.props, onChange = _a.onChange, dispatchEvent = _a.dispatchEvent, _a.data;
    ...
    TreeSelectControl.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: this.container, className: cx("TreeSelectControl", className) },
            React.createElement(ResultBox, { maxTagCount: maxTagCount, overflowTagPopover: overflowTagPopover, disabled: disabled, ref: this.targetRef, placeholder: __(placeholder !== null && placeholder !== void 0 ? placeholder : 'placeholder.empty'), inputPlaceholder: '', className: cx("TreeSelect", {
            ...
            mobileUI ? (React.createElement(PopUp, { container: env && env.getModalContainer ? env.getModalContainer : undefined, className: cx("".concat(ns, "TreeSelect-popup")), isShow: isOpened, onHide: this.close }, this.renderOuter())) : null));
    };
