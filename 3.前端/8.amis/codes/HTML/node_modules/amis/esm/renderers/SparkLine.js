...
import { createObject, getPropValue, autobind, Renderer } from 'amis-core';
...
/** @class */ ((function (_super) {
    ...
    SparkLineRenderer.prototype.render = function () {
        ...
        return (React.createElement(SparkLine, __assign({ onClick: clickAction ? this.handleClick : undefined }, this.props, { value: finalValue })));
    };
    __decorate([
        autobind,
