...
import { isApiOutdated, isPureVariable, resolveVariableAndFilter, filter, createObject, resizeSensor, loadScript, isEffectiveApi, normalizeApiResponseData, dataMapping, LazyComponent, ScopedContext, Renderer, ServiceStore, findObjectsWithKey } from 'amis-core';
...
var Chart = /** @class */ (function (_super) {
    ...
    function Chart(props) {
        ...
        _this.reloadEcharts = debouce(_this.reloadEcharts.bind(_this), 300); //过于频繁更新 ECharts 会报错
    ...
    Chart.prototype.reload = function (subpath, query, ctx, silent, replace) {
        ...
        env
            ...
            if (!result.ok) {
                return env.notify('error', (_b = (_a = api === null || api === void 0 ? void 0 : api.messages) === null || _a === void 0 ? void 0 : _a.failed) !== null && _b !== void 0 ? _b : (result.msg || __('fetchFailed')), result.msgTimeout !== undefined
                    ? {
                        closeButton: true,
    ...
    Chart.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx("".concat(ns, "Chart"), className), style: style },
