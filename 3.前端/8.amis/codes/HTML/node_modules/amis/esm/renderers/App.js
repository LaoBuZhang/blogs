...
import { Html, AsideNav, Layout, NotFound, Spinner } from 'amis-ui';
import { isApiOutdated, isEffectiveApi, generateIcon, autobind, ScopedContext, Renderer, AppStore, replaceText } from 'amis-core';
...
var App = /** @class */ (function (_super) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: cx('Layout-brandBar') },
                ...
                React.createElement("div", { className: cx('Layout-brand') },
                    logo && ~logo.indexOf('<svg') ? (React.createElement(Html, { className: cx('AppLogo-html'), html: logo })) : logo ? (React.createElement("img", { className: cx('AppLogo'), src: logo })) : null,
    ...
    App.prototype.renderAside = function () {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(AsideNav, { navigations: store.navigations, renderLink: function (_a, key) {
                    ...
                    link.badge &&
                        children.push(React.createElement("b", { key: "badge", className: cx("AsideNav-itemBadge", link.badgeClassName || 'bg-info') }, link.badge));
                    ...
                    children.push(React.createElement("span", { className: cx('AsideNav-itemLabel'), key: "label" }, link.label));
                    return link.path ? (/^https?\:/.test(link.path) ? (React.createElement("a", { target: "_blank", href: link.path, rel: "noopener" }, children)) : (React.createElement("a", { onClick: _this.handleNavClick, href: link.path || (link.children && link.children[0].path) }, children))) : (React.createElement("a", { onClick: link.children ? function () { return toggleExpand(link); } : undefined }, children));
    ...
    App.prototype.render = function () {
        ...
        return (React.createElement(Layout, { header: this.renderHeader(), aside: this.renderAside(), footer: this.renderFooter(), folded: store.folded, offScreen: store.offScreen },
