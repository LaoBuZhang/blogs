...
import { __extends, __awaiter, __generator, __assign, __decorate, __metadata, __spreadArray } from 'tslib';
import React from 'react';
import { findDOMNode } from 'react-dom';
import Sortable from 'sortablejs';
import cloneDeep from 'lodash/cloneDeep';
import { anyChanged, createObject, RootClose, noop, Overlay, PopOver, generateIcon, filter, autobind } from 'amis-core';
import { Modal, Icon, TooltipWrapper, Checkbox, Button, getIcon } from 'amis-ui';
...
var ColumnToggler = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        onColumnToggle && onColumnToggle(__spreadArray([], tempColumns, true));
                        this.setState({
                            isOpened: false,
                            enableSorting: false
                        });
    ...
    ColumnToggler.prototype.renderOuter = function () {
        ...
        var body = (React.createElement(RootClose, { disabled: !this.state.isOpened, onRootClose: closeOnOutside !== false ? this.close : noop }, function (ref) {
            return (React.createElement("ul", { className: cx('ColumnToggler-menu'), onClick: closeOnClick ? _this.close : noop, ref: ref }, children));
        }));
        if (popOverContainer) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(Modal, { closeOnEsc: true, onHide: this.close, show: this.state.isOpened, contentClassName: cx('ColumnToggler-modal'), container: modalContainer || this.target, overlay: typeof overlay === 'boolean' ? overlay : false },
                ...
                React.createElement("ul", { className: cx('ColumnToggler-modal-content'), ref: this.dragRef }, Array.isArray(tempColumns)
                    ? tempColumns.map(function (column, index) { return (React.createElement(TooltipWrapper, { tooltipClassName: cx('ColumnToggler-tooltip'), placement: "top", tooltip: column.label || '', trigger: enableSorting ? [] : 'hover', key: column.index },
    ...
    ColumnToggler.prototype.render = function () {
        ...
        var button = (React.createElement("button", { onClick: this.toggle, disabled: disabled || btnDisabled, className: cx('Button', btnClassName, typeof level === 'undefined'
            ...
            icon ? (typeof icon === 'string' ? (getIcon(icon) ? (React.createElement(Icon, { icon: icon, className: cx('icon', { 'm-r-xs': !!label }) })) : (generateIcon(cx, icon, label ? 'm-r-xs' : ''))) : React.isValidElement(icon) ? (React.cloneElement(icon, {
                className: cx({ 'm-r-xs': !!label })
            })) : (React.createElement(Icon, { icon: "columns", className: "icon m-r-none" }))) : (React.createElement(Icon, { icon: "columns", className: "icon m-r-none" })),
        ...
        return (React.createElement("div", { className: cx('ColumnToggler', {
            ...
            draggable ? (button) : (React.createElement(TooltipWrapper, { placement: placement, tooltip: disabled ? disabledTip : tooltip, container: tooltipContainer, trigger: tooltipTrigger, rootClose: tooltipRootClose }, button)),
            this.state.isOpened
                ? draggable
                    ? this.renderModal()
                    : this.renderOuter()
