...
import { isEffectiveApi, until, toNumber, tokenize, getScrollParent, resizeSensor, isApiOutdated, createObject, filter, isVisible, SkipOperation, autobind, evalExpression, ScopedContext, Renderer, ServiceStore } from 'amis-core';
...
var Wizard = /** @class */ (function (_super) {
            ...
            store
                ...
                var state = {
                    currentStep: typeof _this.props.startStep === 'string'
                        ? toNumber(tokenize(_this.props.startStep, _this.props.data), 1)
                        : 1
                };
                if (value &&
                    value.data &&
    ...
    Wizard.prototype.renderSteps = function () {
        ...
        return (React.createElement("div", { className: "".concat(ns, "Wizard-steps"), id: "form-wizard" }, Array.isArray(steps) && steps.length ? (React.createElement("ul", null, steps.map(function (step, key) {
            ...
            return (React.createElement("li", { key: key, className: cx({
                ...
                React.createElement("span", { className: cx('Badge', {
                        // 'Badge--success': canJump && currentStep != key + 1,
                        'is-complete': isComplete,
                        'is-active': isActive || (canJump && currentStep != key + 1)
                    }) }, isComplete && !isActive ? (React.createElement(Icon, { icon: "check", className: "icon" })) : (key + 1)),
    ...
    Wizard.prototype.renderFooter = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { role: "wizard-footer", ref: this.footerDom, className: cx('Panel-footer Wizard-footer') }, actions),
            affixFooter ? (React.createElement("div", { ref: this.affixDom, className: cx('Panel-fixedBottom Wizard-footer') },
                React.createElement("div", { className: cx('Panel-footer') }, actions))) : null));
    };
    Wizard.prototype.renderWizard = function () {
        var _a = this.props, className = _a.className, style = _a.style, steps = _a.steps, render = _a.render, store = _a.store, ns = _a.classPrefix, cx = _a.classnames, popOverContainer = _a.popOverContainer, mode = _a.mode, __ = _a.translate, loadingConfig = _a.loadingConfig;
        var currentStep = this.state.currentStep;
        var step = Array.isArray(steps) ? steps[currentStep - 1] : null;
        return (React.createElement("div", { ref: this.domRef, className: cx("".concat(ns, "Panel ").concat(ns, "Panel--default ").concat(ns, "Wizard ").concat(ns, "Wizard--").concat(mode), className), style: style },
            React.createElement("div", { className: "".concat(ns, "Wizard-step") },
                this.renderSteps(),
                React.createElement("div", { role: "wizard-body", className: "".concat(ns, "Wizard-stepContent clearfix") }, step ? (render('body', __assign(__assign({}, step), { type: 'form', wrapWithPanel: false, 
                    // 接口相关需要外部来接管
                    api: null }), {
