        ...
        descriptor.value = function () {
            ...
            if (props.static) {
                ...
                if (staticSchema && (staticSchema.type
                    ...
                    body = target.renderStatic.apply(this, __spreadArray(__spreadArray([], args, true), [isValueEmpty ? staticPlaceholder : displayValue], false));
                }
                ...
                return React.createElement("div", { className: cx("".concat(ns, "Form-static"), className) }, body);
            }
