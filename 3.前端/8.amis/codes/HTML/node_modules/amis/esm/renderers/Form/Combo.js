...
import { guid, createObject, extendObject, anyChanged, isPureVariable, resolveVariableAndFilter, resolveEventData, isEffectiveApi, isObjectShallowModified, evalExpression, dataMapping, filter, isObject, str2AsyncFunction, autobind, FormItem, ComboStore, resolveVariable } from 'amis-core';
...
var ComboControl = /** @class */ (function (_super) {
    ...
    ComboControl.prototype.renderMultipe = function () {
        ...
        return (React.createElement("div", { className: cx("Combo Combo--multi", multiLine ? "Combo--ver" : "Combo--hor", noBorder ? "Combo--noBorder" : '', disabled ? 'is-disabled' : '', !isStatic &&
                !disabled &&
                draggable &&
                Array.isArray(value) &&
                value.length > 1
