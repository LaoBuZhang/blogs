...
import { guid, autobind, filter, isVisible, createObject, ScopedContext, Renderer, ModalStore, isObjectShallowModified } from 'amis-core';
...
var Drawer = /** @class */ (function (_super) {
    ...
    Drawer.prototype.renderFooter = function () {
        ...
        return (React.createElement("div", { className: cx('Drawer-footer', footerClassName) },
            store.loading || store.error ? (React.createElement("div", { className: cx('Drawer-info') },
                ...
                showErrorMsg && store.error ? (React.createElement("span", { className: cx('Drawer-error') }, store.msg)) : null)) : null,
    ...
    Drawer.prototype.render = function () {
        ...
        return (React.createElement(Container, { resizable: resizable, classPrefix: ns, className: className, style: style, size: size, onHide: this.handleSelfClose, disabled: store.loading, show: show, showCloseButton: showCloseButton, width: width, height: height, position: position, overlay: overlay, onEntered: this.handleEntered, onExited: this.handleExited, closeOnEsc: closeOnEsc, closeOnOutside: !store.drawerOpen && !store.dialogOpen && closeOnOutside, container: drawerContainer
                ? drawerContainer
                : env && env.getModalContainer
                    ? env.getModalContainer
                    : undefined },
            React.createElement("div", { className: cx('Drawer-header', headerClassName) },
                title ? (React.createElement("div", { className: cx('Drawer-title') }, render('title', title, {
                    data: store.formData,
                ...
                header
                    ...
                    : null),
            !store.entered ? (React.createElement("div", { className: cx('Drawer-body', bodyClassName) },
                React.createElement(Spinner, { overlay: true, show: true, size: "lg", loadingConfig: loadingConfig }))) : body ? (
            // dialog-body 用于在 editor 中定位元素
            React.createElement("div", { className: cx('Drawer-body', bodyClassName), role: "dialog-body" }, this.renderBody(body, 'body'))) : null,
            this.renderFooter(),
            body
