...
import { buildApi, isValidApi, setVariable, isEffectiveApi, resolveEventData, FormItem } from 'amis-core';
...
var MatrixCheckbox = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dispatchEvent('change', resolveEventData(this.props, { value: value.concat() }, 'value'))];
                    case 1:
    ...
    MatrixCheckbox.prototype.renderInput = function (forceDisabled) {
        ...
        return (React.createElement("div", { className: cx('Table m-b-none') },
                ...
                React.createElement("table", { className: cx('Table-table') },
                    React.createElement("thead", null,
                        React.createElement("tr", null,
                            ...
                            columns.map(function (column, x) { return (React.createElement("th", { key: x, className: "text-center" }, column.label)); }))),
                    React.createElement("tbody", null, rows.map(function (row, y) { return (React.createElement("tr", { key: y },
                        ...
                        columns.map(function (column, x) { return (React.createElement("td", { key: x, className: "text-center" },
