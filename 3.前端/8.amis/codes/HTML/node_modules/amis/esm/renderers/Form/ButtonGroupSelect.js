...
import { getLevelFromClassName, autobind, OptionsControl } from 'amis-core';
    ...
    ButtonGroupControl.prototype.render = function (props) {
        ...
        if (options && options.length) {
            ...
            body = buttons.map(function (button, key) {
                return render("button/".concat(key), __assign({ size: size, block: block, activeLevel: btnActiveLevel, level: btnLevel, disabled: disabled }, button), {
                    key: key,
