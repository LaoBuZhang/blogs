...
import { __extends, __awaiter, __generator, __spreadArray, __assign, __decorate, __metadata } from 'tslib';
import React from 'react';
import { bulkBindFunctions, isEffectiveApi, scrollPosition, isApiOutdated, isObjectShallowModified, filter, isVisible, createObject, evalExpression, buildStyle, isMobile, autobind, ScopedContext, Renderer, ServiceStore } from 'amis-core';
...
var Page = /** @class */ (function (_super) {
    ...
    function Page(props) {
        ...
        _this.asideInner = React.createRef();
    ...
    Page.prototype.componentDidMount = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, initApi, initFetch, initFetchOn, store, messages, asideSticky, data, dispatchEvent, dom, rendererEvent;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.props, initApi = _a.initApi, initFetch = _a.initFetch, initFetchOn = _a.initFetchOn, store = _a.store, messages = _a.messages, asideSticky = _a.asideSticky, data = _a.data, dispatchEvent = _a.dispatchEvent;
                        this.mounted = true;
                        if (asideSticky && this.asideInner.current) {
                            dom = this.asideInner.current;
                            dom.style.cssText += "position: sticky; top: ".concat(scrollPosition(dom).top, "px;");
                        }
    ...
    Page.prototype.renderHeader = function () {
        ...
        if (Array.isArray(regions) ? ~regions.indexOf('header') : title || subTitle) {
            header = (React.createElement("div", { className: cx("Page-header", headerClassName) },
                title ? (React.createElement("h2", { className: cx('Page-title') },
        ...
        if (Array.isArray(regions) ? ~regions.indexOf('toolbar') : toolbar) {
            right = (React.createElement("div", { className: cx("Page-toolbar", toolbarClassName) }, render('toolbar', toolbar || '', subProps)));
        }
        if (header && right) {
    ...
    Page.prototype.render = function () {
        ...
        var pageContent = (React.createElement("div", { className: cx('Page-content') },
            React.createElement("div", { className: cx('Page-main') },
                this.renderHeader(),
                React.createElement("div", { className: cx("Page-body", bodyClassName), role: "page-body" },
                    React.createElement(Spinner, { size: "lg", overlay: true, key: "info", show: store.loading, loadingConfig: loadingConfig }),
                    store.error && showErrorMsg !== false ? (React.createElement(Alert2, { level: "danger", showCloseButton: true, onClose: store.clearMessage }, store.msg)) : null,
                    (Array.isArray(regions) ? ~regions.indexOf('body') : body)
                        ? render('body', body || '', subProps)
                        : null))));
        return (React.createElement("div", { className: cx("Page", hasAside ? "Page--withSidebar" : '', className), onClick: this.handleClick, style: styleVar },
            hasAside ? (React.createElement("div", { className: cx("Page-aside", asideResizor ? 'relative' : 'Page-aside--withWidth', asideClassName) },
                React.createElement("div", { className: cx("Page-asideInner"), ref: this.asideInner }, render('aside', aside || '', __assign(__assign({}, subProps), (typeof aside === 'string'
                    ? {
                        inline: false,
            ...
            useMobileUI && isMobile() && pullRefresh && !pullRefresh.disabled ? (React.createElement(PullRefresh, __assign({}, pullRefresh, { translate: __, onRefresh: this.handleRefresh }), pageContent)) : (pageContent),
...
/** @class */ ((function (_super) {
    ...
    PageRenderer.prototype.handleDialogConfirm = function (values, action) {
        ...
        _super.prototype.handleDialogConfirm.apply(this, __spreadArray([values, action], rest, false));
        var scoped = this.context;
        var store = this.props.store;
