...
import { generateIcon, isMobile, autobind, themeable, Renderer, filter } from 'amis-core';
import { hasIcon, Icon, TooltipWrapper } from 'amis-ui';
...
var Remark = /** @class */ (function (_super) {
    ...
    Remark.prototype.renderLabel = function (finalIcon, finalLabel, cx, shape) {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            finalIcon ? (typeof finalIcon === 'object' ? (generateIcon(cx, finalIcon)) : hasIcon(finalIcon) ? (React.createElement("span", { className: cx('Remark-icon', shapeClass) },
                React.createElement(Icon, { icon: finalIcon }))) : (React.createElement("i", { className: cx('Remark-icon', finalIcon) }))) : finalIcon === false && finalLabel ? null : (React.createElement("span", { className: cx('Remark-icon icon', shapeClass) },
                React.createElement(Icon, { icon: "question-mark" })))));
    };
