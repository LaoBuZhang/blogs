...
/** @class */ ((function (_super) {
    ...
    SearchBoxRenderer.prototype.dispatchEvent = function (name) {
        ...
        dispatchEvent(name, resolveEventData(this.props, { value: this.state.value }, 'value'));
    };
