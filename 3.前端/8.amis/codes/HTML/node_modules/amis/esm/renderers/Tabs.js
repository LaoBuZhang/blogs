...
import { tokenize, resolveVariableAndFilter, createObject, isObject, getVariable, isObjectShallowModified, isVisible, resolveEventData, filter, isDisabled, autobind, ScopedContext, Renderer, str2AsyncFunction } from 'amis-core';
...
var Tabs = /** @class */ (function (_super) {
    ...
    Tabs.prototype.initTabArray = function (tabs, source, data) {
        ...
        arr.forEach(function (value, index) {
            ...
            sourceTabs.push.apply(sourceTabs, tabs.map(function (tab) { return (__assign(__assign({}, tab), { ctx: ctx })); }));
        });
    ...
    Tabs.prototype.componentDidUpdate = function (preProps, prevState) {
        ...
        var localTabs = this.state.localTabs;
        var prevActiveKey = tokenize(preProps.defaultActiveKey, preProps.data);
        var activeKey = tokenize(props.defaultActiveKey, props.data);
        // 响应外部修改 tabs
    ...
    Tabs.prototype.renderTabs = function () {
        ...
        if (isFromSource) {
            children = tabs.map(function (tab, index) {
                return isVisible(tab, tab.ctx) ? (React.createElement(Tab, __assign({}, tab, { title: filter(tab.title, tab.ctx), disabled: isDisabled(tab, tab.ctx), key: index, eventKey: index, mountOnEnter: mountOnEnter, unmountOnExit: typeof tab.reload === 'boolean'
                        ? tab.reload
            ...
            children = tabs.map(function (tab, index) {
                return isVisible(tab, data) ? (React.createElement(Tab, __assign({}, tab, { title: filter(tab.title, data), disabled: isDisabled(tab, data), key: index, eventKey: tab.hash || index, mountOnEnter: mountOnEnter, unmountOnExit: typeof tab.reload === 'boolean'
                        ? tab.reload
                        : typeof tab.unmountOnExit === 'boolean'
                            ? tab.unmountOnExit
