...
import { ResultBox, Spinner, ListMenu } from 'amis-ui';
...
var TagControl = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dispatchEvent(eventName, resolveEventData(this.props, __assign({ options: options, items: options }, eventData), 'value'))];
                    case 1:
    ...
    TagControl.prototype.normalizeMergedValue = function (inputValue, normalized) {
        ...
        var options = unionWith(selectedOptions.concat(), this.normalizeInputValue(inputValue), function (origin, input) { return origin.value === input.value; });
    ...
    TagControl.prototype.handleKeyDown = function (evt) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, selectedOptions, onChange, delimiter, value, selectedItems, newValueRes, isPrevented, newValueRes, isPrevented;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.props, selectedOptions = _a.selectedOptions, onChange = _a.onChange, delimiter = _a.delimiter;
                        value = this.state.inputValue.trim();
                        selectedItems = selectedOptions.concat({ label: value, value: value });
        ...
        return (React.createElement(Downshift, { selectedItem: selectedOptions, isOpen: this.state.isFocused, inputValue: this.state.inputValue, onChange: this.handleOptionChange, itemToString: this.renderItem }, function (_a) {
            ...
            return (React.createElement("div", { className: cx(className, "TagControl") },
                React.createElement(ResultBox, __assign({}, getInputProps({
                    ...
                    disabled: disabled
                }), { inputPlaceholder: '', onChange: _this.handleInputChange, className: cx('TagControl-input'), result: selectedOptions, onResultChange: _this.handleChange, itemRender: _this.renderItem, clearable: clearable, maxTagCount: maxTagCount, overflowTagPopover: overflowTagPopover, allowInput: true }), loading ? (React.createElement(Spinner, { loadingConfig: loadingConfig, size: "sm" })) : undefined),
                dropdown !== false ? (React.createElement(Overlay, { container: popOverContainer || _this.getParent, target: _this.getTarget, placement: 'auto', show: isOpen && !!finnalOptions.length },
