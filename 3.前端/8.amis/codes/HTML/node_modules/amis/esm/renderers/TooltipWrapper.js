...
import { buildStyle, filter, Renderer } from 'amis-core';
...
var TooltipWrapper = /** @class */ (function (_super) {
    ...
    TooltipWrapper.prototype.renderBody = function () {
        ...
        return (React.createElement(Comp, { className: cx('TooltipWrapper', className, {
            ...
            }), style: buildStyle(style, data) }, render('body', body)));
    };
    TooltipWrapper.prototype.render = function () {
        ...
        return (React.createElement(TooltipWrapper$1, { classPrefix: ns, classnames: cx, tooltip: tooltipObj }, this.renderBody()));
    };
