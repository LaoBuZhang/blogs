...
import { createObject, filter, autobind, Renderer } from 'amis-core';
...
var Icon = /** @class */ (function (_super) {
    ...
    Icon.prototype.render = function () {
        var _a = this.props, vendor = _a.vendor, cx = _a.classnames, className = _a.className, style = _a.style, data = _a.data;
