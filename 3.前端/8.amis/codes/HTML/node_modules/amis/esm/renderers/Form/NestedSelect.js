...
import { resolveEventData, string2regExp, getTreeAncestors, flattenTree, getTreeParent, filterTree, RootClose, Overlay, PopOver, isMobile, ucFirst, autobind, OptionsControl } from 'amis-core';
...
var NestedSelectControl = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dispatchEvent(eventName, resolveEventData(this.props, eventData, 'value'))];
                    case 1:
    ...
    NestedSelectControl.prototype.renderValue = function (option, key) {
        ...
        return (React.createElement("span", { className: cx('Select-valueLabel'), key: key || option[valueField || 'value'] }, ancestors
                ...
                return (React.createElement("span", { key: index },
                    regexp.test(value) || regexp.test(label)
                        ? unmatchText.map(function (text, textIndex) {
                            ...
                            return (React.createElement("span", { key: textIndex, className: cx({
    ...
    NestedSelectControl.prototype.handleInputChange = function (inputValue) {
        ...
        var filtedOptions = inputValue && this.state.isOpened
            ? filterTree(options, function (option) {
    ...
    NestedSelectControl.prototype.renderOptions = function () {
        ...
        return (React.createElement(React.Fragment, null, stack.map(function (options, index) { return (React.createElement("div", { key: index, className: cx('NestedSelect-menu', menuClassName) },
    ...
    NestedSelectControl.prototype.renderSearchResult = function () {
        ...
        // 一个stack一个menu
        var resultBody = (React.createElement("div", { className: cx('NestedSelect-menu') }, flattenTreeWithNodes.length ? (flattenTreeWithNodes.map(function (option, index) {
            var ancestors = getTreeAncestors(propOptions, option);
    ...
    NestedSelectControl.prototype.render = function () {
        var _a;
        var _b = this.props, className = _b.className; _b.style; var disabled = _b.disabled, cx = _b.classnames, multiple = _b.multiple, placeholder = _b.placeholder, __ = _b.translate, inline = _b.inline, searchable = _b.searchable; _b.autoComplete; var selectedOptions = _b.selectedOptions, clearable = _b.clearable, loading = _b.loading, borderMode = _b.borderMode, useMobileUI = _b.useMobileUI, env = _b.env, loadingConfig = _b.loadingConfig;
        var mobileUI = useMobileUI && isMobile();
        return (React.createElement("div", { className: cx('NestedSelectControl', className) },
            React.createElement(ResultBox, { useMobileUI: useMobileUI, disabled: disabled, ref: this.domRef, placeholder: __(placeholder !== null && placeholder !== void 0 ? placeholder : 'placeholder.empty'), inputPlaceholder: '', className: cx("NestedSelect", (_a = {
            ...
            mobileUI ? (React.createElement(PopUp, { className: cx("NestedSelect-popup"), container: env && env.getModalContainer ? env.getModalContainer : undefined, isShow: this.state.isOpened, onHide: this.close, showConfirm: false, showClose: false },
