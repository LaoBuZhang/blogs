...
import { isApiOutdated, isObjectShallowModified, isEffectiveApi, isObject, str2AsyncFunction, buildApi, isEmpty, evalExpression, createObject, filter, isVisible, autobind, qsstringify, ScopedContext, Renderer, ServiceStore } from 'amis-core';
...
var Service = /** @class */ (function (_super) {
    ...
    Service.prototype.initDataProviders = function (provider) {
        var _this = this;
        var dataProvider = cloneDeep(provider);
        var fnCollection = {};
        if (dataProvider) {
    ...
    Service.prototype.afterDataFetch = function (result) {
        ...
        var _b = this.props, onBulkChange = _b.onBulkChange, dispatchEvent = _b.dispatchEvent, store = _b.store;
        dispatchEvent === null || dispatchEvent === void 0 ? void 0 : dispatchEvent('fetchInited', __assign(__assign({}, data), { __response: { msg: store.msg, error: store.error } }));
    ...
    Service.prototype.afterSchemaFetch = function (schema) {
        ...
        dispatchEvent === null || dispatchEvent === void 0 ? void 0 : dispatchEvent('fetchSchemaInited', __assign(__assign({}, schema), { __response: { msg: store.msg, error: store.error } }));
    ...
    Service.prototype.render = function () {
        var _a = this.props, className = _a.className, style = _a.style, store = _a.store, render = _a.render, ns = _a.classPrefix, cx = _a.classnames, loadingConfig = _a.loadingConfig;
        return (React.createElement("div", { className: cx("".concat(ns, "Service"), className), style: style },
            store.error ? (React.createElement("div", { className: cx("Alert Alert--danger") },
                React.createElement("button", { className: cx('Alert-close'), onClick: function () { return store.updateMessage(''); }, type: "button" },
