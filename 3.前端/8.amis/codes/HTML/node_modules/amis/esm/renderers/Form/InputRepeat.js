    ...
    RepeatControl.prototype.renderInput = function () {
        ...
        return (React.createElement("div", { className: "repeat-control hbox" },
            ...
            React.createElement("div", { className: "col v-middle repeat-btn" },
                React.createElement(Select, { classPrefix: ns, className: input ? 'pull-right' : '', options: optionsArray, placeholder: __(placeholder), onChange: this.handleOptionChange, value: parts[0], clearable: false, searchable: false, disabled: disabled, joinValues: false }))));
    };
