...
import { Overlay, PopOver } from 'amis-core';
    ...
    return function (Component) {
        var QuickEditComponent = /** @class */ (function (_super) {
            ...
            QuickEditComponent.prototype.buildSchema = function () {
                ...
                if (quickEdit === true) {
                    ...
                    if (quickEdit.body &&
                        ...
                        schema = __assign(__assign({ title: '', autoFocus: quickEdit.mode !== 'inline' }, quickEdit), { mode: 'normal', type: 'form' });
                    }
                    else {
                        schema = {
                            title: '',
                            ...
                            mode: 'normal',
                            body: [
                                __assign(__assign({ type: quickEdit.type || 'input-text', name: quickEdit.name || name }, quickEdit), { mode: undefined })
                            ]
                        };
                    }
                }
                if (schema) {
                    schema = __assign(__assign({}, schema), { wrapWithPanel: quickEdit.mode !== 'inline', actions: quickEdit.mode === 'inline'
                            ? []
                            : [
                                {
                                    type: 'button',
            ...
            QuickEditComponent.prototype.renderPopOver = function () {
                ...
                return (React.createElement(Overlay, { container: popOverContainer, target: function () { return _this.target; }, onHide: this.closeQuickEdit, placement: "left-top right-top left-bottom right-bottom left-top", show: true },
            ...
            QuickEditComponent.prototype.render = function () {
                var _a = this.props, onQuickChange = _a.onQuickChange, quickEdit = _a.quickEdit, quickEditEnabled = _a.quickEditEnabled, className = _a.className, cx = _a.classnames, render = _a.render, noHoc = _a.noHoc, canAccessSuperData = _a.canAccessSuperData, disabled = _a.disabled, readOnly = _a.readOnly;
                if (!quickEdit ||
                    !onQuickChange ||
                ...
                if (quickEdit.mode === 'inline') {
                    return (React.createElement(Component, __assign({}, this.props), render('inline-form', this.buildSchema(), {
                        value: undefined,
                    ...
                    return (React.createElement(Component, __assign({}, this.props, { className: cx("Field--quickEditable", className, {
                        ...
                        React.createElement(Component, __assign({}, this.props, { wrapperComponent: '', noHoc: true })),
                        React.createElement("span", { key: "edit-btn", className: cx('Field-quickEditBtn'), onClick: this.openQuickEdit },
