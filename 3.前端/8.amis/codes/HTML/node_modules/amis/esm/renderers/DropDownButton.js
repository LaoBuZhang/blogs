...
import { createObject, generateIcon, isVisible, isDisabled, RootClose, noop, Overlay, PopOver, filter, Renderer } from 'amis-core';
import { TooltipWrapper, hasIcon, Icon } from 'amis-ui';
...
var DropDownButton = /** @class */ (function (_super) {
    ...
    DropDownButton.prototype.open = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, dispatchEvent, data, buttons;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.props, dispatchEvent = _a.dispatchEvent, data = _a.data, buttons = _a.buttons;
    ...
    DropDownButton.prototype.close = function () {
        ...
        this.timer = setTimeout(function () {
            _this.props.dispatchEvent('mouseleave', createObject(_this.props.data, { items: _this.props.buttons }));
            _this.setState({
                isOpened: false
            });
        }, 200);
    ...
    DropDownButton.prototype.renderButton = function (button, index) {
        ...
        if (typeof button !== 'string' && Array.isArray(button === null || button === void 0 ? void 0 : button.children)) {
            return (React.createElement("div", { key: index, className: cx('DropDown-menu') },
        ...
        if (typeof button !== 'string' && !isVisible(button, data)) {
            ...
            return (React.createElement("li", { key: index, className: cx('DropDown-button', (_a = {},
                    ...
                    _a)) }, render("button/".concat(index), __assign(__assign({ type: 'button' }, button), { isMenuItem: true }))));
        }
    };
    DropDownButton.prototype.renderOuter = function () {
        ...
        var body = (React.createElement(RootClose, { disabled: !this.state.isOpened, onRootClose: closeOnOutside !== false ? this.close : noop }, function (ref) {
            return (React.createElement("ul", { className: cx('DropDown-menu-root', 'DropDown-menu', menuClassName), onClick: function (e) {
                    closeOnClick ? _this.close() : noop;
                    e.preventDefault();
                }, onMouseEnter: _this.keepOpen, ref: ref }, children
                ? children
        ...
        if (popOverContainer) {
            return (React.createElement(Overlay, { container: popOverContainer, target: function () { return _this.target; }, show: true },
                React.createElement(PopOver, { overlay: true, onHide: this.close, classPrefix: ns, className: cx('DropDown-popover', menuClassName), style: { minWidth: (_a = this.target) === null || _a === void 0 ? void 0 : _a.offsetWidth } }, body)));
        }
        return body;
    };
    DropDownButton.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx('DropDown ', {
            ...
            React.createElement(TooltipWrapper, { placement: placement, tooltip: disabled ? disabledTip : tooltip, container: tooltipContainer, trigger: tooltipTrigger, rootClose: tooltipRootClose },
                React.createElement("button", { onClick: this.toogle, disabled: disabled || btnDisabled, className: cx('Button', btnClassName, typeof level === 'undefined'
                    ...
                    hasIcon(icon) ? (React.createElement(Icon, { icon: icon, className: "icon" })) : (generateIcon(cx, icon, 'm-r-xs')),
                    typeof label === 'string' ? filter(label, data) : label,
                    rightIcon && hasIcon(rightIcon) ? (React.createElement(Icon, { icon: icon, className: "icon" })) : (generateIcon(cx, rightIcon, 'm-l-xs')),
