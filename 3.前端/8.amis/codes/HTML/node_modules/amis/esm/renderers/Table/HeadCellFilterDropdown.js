...
import { isApiOutdated, getVariable, isEffectiveApi, normalizeApi, normalizeOptions, isNumeric, createObject, Overlay, PopOver } from 'amis-core';
...
var HeadCellFilterDropDown = /** @class */ (function (_super) {
    ...
    HeadCellFilterDropDown.prototype.fetchOptions = function () {
        ...
        var api = normalizeApi(filterable.source);
