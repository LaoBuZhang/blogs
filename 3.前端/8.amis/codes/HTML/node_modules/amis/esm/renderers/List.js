...
import { __extends, __assign, __decorate, __spreadArray, __rest } from 'tslib';
import React from 'react';
import { findDOMNode } from 'react-dom';
import Sortable from 'sortablejs';
import omit from 'lodash/omit';
import { Icon, Button, Spinner, Checkbox } from 'amis-ui';
import { resolveVariableAndFilter, getScrollParent, anyChanged, isPureVariable, createObject, difference, filter, Renderer, ListStore, isClickOnInput, noop, isVisible, isDisabled, resolveVariable } from 'amis-core';
...
var List = /** @class */ (function (_super) {
    ...
    List.prototype.renderDragToggler = function () {
        ...
        return (React.createElement(Button, { iconOnly: true, key: "dragging-toggle", tooltip: "\u5BF9\u5217\u8868\u8FDB\u884C\u6392\u5E8F\u64CD\u4F5C", tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, size: "sm", active: store.dragging, onClick: function (e) {
                e.preventDefault();
    ...
    List.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx('List', className, (_a = {},
            ...
            affixHeader && heading && header ? (React.createElement("div", { className: cx('List-fixedTop') },
                header,
                heading)) : null,
            header,
            heading,
...
var ListItem = /** @class */ (function (_super) {
    ...
    ListItem.prototype.handleClick = function (e) {
        ...
        onAction === null || onAction === void 0 ? void 0 : onAction(e, hasClickActions ? undefined : itemAction, hasClickActions ? item : item === null || item === void 0 ? void 0 : item.data);
    ...
    ListItem.prototype.renderLeft = function () {
        ...
        if (dragging) {
            ...
            return (React.createElement("div", { className: cx('ListItem-checkBtn') },
                React.createElement(Checkbox, { classPrefix: ns, type: multiple ? 'checkbox' : 'radio', disabled: !checkable, checked: selected, onChange: checkOnItemClick ? noop : this.handleCheck, inline: true })));
        }
        return null;
    };
