...
import { addSchemaFilter, FormRenderer, getLevelFromClassName } from 'amis-core';
...
addSchemaFilter(function (schema, renderer, props) {
    ...
    if (type === 'combo' && Array.isArray(schema.conditions)) {
        schema = __assign(__assign({}, schema), { conditions: schema.conditions.map(function (condition) {
    ...
    if ((schema === null || schema === void 0 ? void 0 : schema.controls) &&
        ...
        schema = __assign(__assign({}, schema), (_a = {}, _a[schema.type === 'combo' ? "items" : 'body'] = (Array.isArray(schema.controls)
            ? schema.controls
        ...
        schema = __assign(__assign({}, schema), { quickEdit: __assign(__assign({}, schema.quickEdit), { body: (Array.isArray(schema.quickEdit.controls)
        ...
        schema = __assign(__assign({}, schema), { quickEdit: controlToNormalRenderer(schema.quickEdit) });
    }
    else if (type === 'tabs' && Array.isArray(schema.tabs)) {
        schema = __assign(__assign({}, schema), { tabs: schema.tabs.map(function (tab) {
        ...
        schema = __assign(__assign({}, schema), { links: schema.links.map(function (link) {
        ...
        schema = __assign(__assign({}, schema), { items: Array.isArray(schema.items)
        ...
        schema = __assign(__assign({}, schema), { columns: schema.columns.map(function (column) {
        ...
        schema = __assign(__assign({}, schema), { body: (Array.isArray(schema.body.controls)
