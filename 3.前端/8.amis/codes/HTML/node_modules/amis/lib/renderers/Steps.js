...
function StepsCmpt(props) {
    ...
    return (React__default["default"].createElement(amisUi.Steps, { current: currentValue, steps: resolveSteps, className: className, style: style, status: statusValue, mode: mode, progressDot: progressDot, labelPlacement: labelPlacement, useMobileUI: useMobileUI }));
}
