...
var TextControl = /** @class */ (function (_super) {
            ...
            return tslib.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, dispatchEvent('enter', amisCore.resolveEventData(this.props, { value: value_1 }, 'value'))];
                    case 2:
    ...
    TextControl.prototype.renderSugestMode = function () {
        ...
        return (React__default["default"].createElement(Downshift__default["default"], { isOpen: this.state.isOpen && !disabled && !readOnly, inputValue: this.state.inputValue, onChange: this.handleChange, onStateChange: this.handleStateChange, selectedItem: selectedOptions.map(function (item) { return item[valueField || 'value']; }) }, function (_a) {
            ...
            return (React__default["default"].createElement("div", { className: cx("TextControl-input TextControl-input--withAC", inputControlClassName, inputOnly ? className : '', (_c = {
                ...
                clearable && !disabled && !readOnly && value ? (React__default["default"].createElement("a", { onClick: _this.clearValue },
                    React__default["default"].createElement(amisUi.Icon, { icon: "input-clear", className: "icon", wrapClassName: cx('TextControl-clear'), iconContent: "InputBox-clear" }))) : null,
                showCounter ? (React__default["default"].createElement("span", { className: cx('TextControl-counter') }, "".concat((_d = _this.valueToString(value)) === null || _d === void 0 ? void 0 : _d.length).concat(typeof maxLength === 'number' && maxLength
                    ? "/".concat(maxLength)
                    : ''))) : null,
                loading ? (React__default["default"].createElement(amisUi.Spinner, { show: true, icon: "reload", size: "sm", spinnerClassName: cx('TextControl-spinner'), loadingConfig: loadingConfig })) : null,
    ...
    TextControl.prototype.renderNormal = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('TextControl-input', (_a = {},
            ...
            clearable && !disabled && !readOnly && value ? (React__default["default"].createElement("a", { onClick: this.clearValue, className: cx('TextControl-clear') },
                React__default["default"].createElement(amisUi.Icon, { icon: "input-clear", className: "icon", iconContent: "InputText-clear" }))) : null,
            type === 'password' && revealPassword && !disabled ? (React__default["default"].createElement("a", { onClick: this.toggleRevealPassword, className: cx('TextControl-revealPassword') }, this.state.revealPassword ? (React__default["default"].createElement(amisUi.Icon, { icon: "view", className: cx('TextControl-icon-view'), wrapClassName: cx('TextControl-icon-view'), iconContent: "InputText-view" })) : (React__default["default"].createElement(amisUi.Icon, { icon: "invisible", className: cx('TextControl-icon-invisible'), wrapClassName: cx('TextControl-icon-invisible'), iconContent: "InputText-invisible" })))) : null,
    ...
    TextControl.prototype.renderBody = function (body) {
        ...
        var addOnDom = addOn && !isStatic ? (addOn.actionType ||
            ~['button', 'submit', 'reset', 'action'].indexOf(addOn.type) ? (React__default["default"].createElement("div", { className: cx("".concat(ns, "TextControl-button"), addOnClassName) }, render('addOn', addOn, {
            disabled: disabled
        }))) : (React__default["default"].createElement("div", { className: cx("".concat(ns, "TextControl-addOn"), addOnClassName) },
            iconElement,
