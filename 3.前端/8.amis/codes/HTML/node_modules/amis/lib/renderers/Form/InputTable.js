...
var FormTable = /** @class */ (function (_super) {
            ...
            btns.push({
                children: function (_a) {
                    ...
                    return (~_this.state.editIndex && needConfirm !== false) ||
                        maxLength <= _this.state.items.length ? null : (React__default["default"].createElement(amisUi.Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('Table.addRow'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, onClick: _this.addItem.bind(_this, rowIndex + offset, undefined) },
            ...
            btns.push({
                children: function (_a) {
                    ...
                    return ((~_this.state.editIndex || (data && data.__isPlaceholder)) &&
                        needConfirm !== false) ||
                        minLength >= _this.state.items.length ? null : (React__default["default"].createElement(amisUi.Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('Table.deleteRow'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, onClick: _this.removeItem.bind(_this, rowIndex + offset) },
    ...
    FormTable.prototype.handleTableSave = function (rows, diff, rowIndexes) {
        ...
        if (Array.isArray(rows)) {
            ...
            var data = merge__default["default"]({}, origin_2, diff);
            items = amisCore.spliceTree(items, indexes, 1, data);
    ...
    FormTable.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('InputTable', className) },
            ...
            (addable &&
                ...
                showPager ? (React__default["default"].createElement("div", { className: cx('InputTable-toolbar') },
