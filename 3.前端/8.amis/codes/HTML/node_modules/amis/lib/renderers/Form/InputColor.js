...
var ColorControl = /** @class */ (function (_super) {
    ...
    ColorControl.prototype.render = function () {
        var _a = this.props, className = _a.className; _a.style; var ns = _a.classPrefix, value = _a.value, env = _a.env; _a.static; var useMobileUI = _a.useMobileUI, rest = tslib.__rest(_a, ["className", "style", "classPrefix", "value", "env", "static", "useMobileUI"]);
