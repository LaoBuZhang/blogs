...
var LinkCmpt = /** @class */ (function (_super) {
    ...
    LinkCmpt.prototype.render = function () {
        ...
        return (React__default["default"].createElement(amisUi.Link, { className: className, style: style, href: value, disabled: disabled, title: title, htmlTarget: htmlTarget || (blank ? '_blank' : '_self'), icon: icon, rightIcon: rightIcon, onClick: this.handleClick }, body ? render('body', body) : value || __('link')));
    };
