...
var Service = /** @class */ (function (_super) {
    ...
    Service.prototype.afterDataFetch = function (result) {
        ...
        dispatchEvent === null || dispatchEvent === void 0 ? void 0 : dispatchEvent('fetchInited', tslib.__assign(tslib.__assign({}, data), { __response: { msg: store.msg, error: store.error } }));
    ...
    Service.prototype.afterSchemaFetch = function (schema) {
        ...
        dispatchEvent === null || dispatchEvent === void 0 ? void 0 : dispatchEvent('fetchSchemaInited', tslib.__assign(tslib.__assign({}, schema), { __response: { msg: store.msg, error: store.error } }));
    ...
    Service.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx("".concat(ns, "Service"), className), style: style },
            store.error ? (React__default["default"].createElement("div", { className: cx("Alert Alert--danger") },
                ...
                store.msg)) : null,
            this.renderBody(),
            React__default["default"].createElement(amisUi.Spinner, { size: "lg", overlay: true, key: "info", show: store.loading, loadingConfig: loadingConfig }),
            render(
