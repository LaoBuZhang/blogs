        ...
        descriptor.value = function () {
            ...
            if (props.static) {
                ...
                if (staticSchema && (staticSchema.type
                    ...
                    body = target.renderStatic.apply(this, tslib.__spreadArray(tslib.__spreadArray([], args, true), [isValueEmpty ? staticPlaceholder : displayValue], false));
                }
                ...
                return React__default["default"].createElement("div", { className: cx("".concat(ns, "Form-static"), className) }, body);
            }
