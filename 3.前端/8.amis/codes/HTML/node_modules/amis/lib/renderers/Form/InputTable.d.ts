...
import { FormControlProps, FormBaseControl, SimpleMap, RendererData, ActionObject, ITableStore } from 'amis-core';
...
export default class FormTable extends React.Component<TableProps, TableState> {
    ...
    startEdit(index: number, isCreate?: boolean, isCopy?: boolean): void;
