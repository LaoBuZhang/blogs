...
var RatingControl = /** @class */ (function (_super) {
    ...
    RatingControl.prototype.renderStatic = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('RatingControl', className) },
            React__default["default"].createElement(amisUi.Rating, { classnames: cx, value: value, disabled: true, count: count, half: half, char: char, inactiveColor: inactiveColor, colors: colors, texts: texts, charClassName: charClassName, textClassName: textClassName, textPosition: textPosition })));
    };
    RatingControl.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('RatingControl', className) },
            React__default["default"].createElement(amisUi.Rating, { classnames: cx, value: value, disabled: disabled, count: finalCount, half: half, allowClear: allowClear, readOnly: readOnly, char: char, inactiveColor: inactiveColor, colors: colors, texts: texts, charClassName: charClassName, textClassName: textClassName, textPosition: textPosition, onChange: this.handleChange, onHoverChange: function (value) {
