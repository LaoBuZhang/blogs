...
var NumberControl = /** @class */ (function (_super) {
    ...
    NumberControl.prototype.doAction = function (action, args) {
        ...
        if (actionType === 'clear') {
            ...
            var value = amisUi.NumberInput.normalizeValue(resetValue !== null && resetValue !== void 0 ? resetValue : '', this.filterNum(min, big), this.filterNum(max, big), finalPrecision, resetValue !== null && resetValue !== void 0 ? resetValue : '', big);
    ...
    NumberControl.prototype.dispatchEvent = function (eventName) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                ...
                dispatchEvent(eventName, amisCore.resolveEventData(this.props, { value: value }, 'value'));
                return [2 /*return*/];
            });
        });
    };
    ...
    NumberControl.prototype.renderStatic = function (displayValue) {
        ...
        return React__default["default"].createElement(React__default["default"].Fragment, null, finalValue + unit);
    };
    NumberControl.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx__default["default"]("".concat(ns, "NumberControl"), (_a = {},
                ...
                _a), className) },
            React__default["default"].createElement(amisUi.NumberInput, { inputRef: this.inputRef, value: finalValue, resetValue: resetValue, step: step, max: this.filterNum(max, big), min: this.filterNum(min, big), formatter: formatter, parser: parser, onChange: this.handleChange, disabled: disabled, placeholder: placeholder, precision: finalPrecision, showSteps: showSteps, borderMode: borderMode, readOnly: readOnly, onFocus: function () { return _this.dispatchEvent('focus'); }, onBlur: function () { return _this.dispatchEvent('blur'); }, keyboard: keyboard, displayMode: displayMode, big: big }),
