...
var Table = /** @class */ (function (_super) {
    ...
    Table.prototype.renderHeading = function () {
        ...
        if (title ||
            (quickSaveApi &&
                ...
                !hideQuickSaveBtn) ||
            store.moved) {
            return (React__default["default"].createElement("div", { className: cx('Table-heading', headingClassName), key: "heading" }, !saveImmediately &&
                store.modified &&
                !hideQuickSaveBtn &&
                !isModifiedColumnSaveImmediately ? (React__default["default"].createElement("span", null,
                __('Table.modified', {
                    modified: store.modified
                }),
                React__default["default"].createElement("button", { type: "button", className: cx('Button Button--size-xs Button--success m-l-sm'), onClick: this.handleSave },
                    React__default["default"].createElement(amisUi.Icon, { icon: "check", className: "icon m-r-xs" }),
                    __('Form.submit')),
                React__default["default"].createElement("button", { type: "button", className: cx('Button Button--size-xs Button--danger m-l-sm'), onClick: this.reset },
    ...
    Table.prototype.renderHeadCell = function (column, props) {
        ...
        if (column.type === '__checkme') {
            return (React__default["default"].createElement("th", tslib.__assign({}, props, { className: cx(column.pristine.className) }), store.rows.length && multiple ? (React__default["default"].createElement(amisUi.Checkbox, { classPrefix: ns, partial: store.someChecked && !store.allChecked, checked: store.someChecked, disabled: store.isSelectionThresholdReached, onChange: this.handleCheckAll })) : ('\u00A0')));
        }
        ...
        if (column.sortable && column.name) {
            affix.push(React__default["default"].createElement("span", { key: "table-head-sort", className: cx('TableCell-sortBtn'), onClick: function () { return tslib.__awaiter(_this, void 0, void 0, function () {
        ...
        if (!column.searchable && column.filterable && column.name) {
            affix.push(React__default["default"].createElement(HeadCellFilterDropdown.HeadCellFilterDropDown, tslib.__assign({ key: "table-head-filter" }, this.props, { onQuery: onQuery, name: column.name, type: column.type, data: query, filterable: column.filterable, popOverContainer: this.getPopOverContainer })));
        }
    ...
    Table.prototype.renderTableContent = function () {
        ...
        return (React__default["default"].createElement(React__default["default"].Fragment, null,
            TableContent.TableContent.renderItemActions({
                store: store,
                classnames: cx,
                render: render,
            ...
            React__default["default"].createElement(amisUi.Spinner, { loadingConfig: loadingConfig, overlay: true, show: loading })));
    };
