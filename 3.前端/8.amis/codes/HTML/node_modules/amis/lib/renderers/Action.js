    ...
    Action.prototype.render = function () {
        ...
        if (actionType !== 'email' && body) {
            return (React__default["default"].createElement(amisUi.TooltipWrapper, { classPrefix: ns, classnames: cx, placement: tooltipPlacement, tooltip: tooltip, container: tooltipContainer, trigger: tooltipTrigger, rootClose: tooltipRootClose },
                React__default["default"].createElement("div", { className: cx('Action', className), style: style, onClick: this.handleAction, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave }, render('body', body))));
        }
        ...
        return (React__default["default"].createElement(amisUi.Button, { loadingConfig: loadingConfig, className: cx(className, (_a = {},
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if ((action === null || action === void 0 ? void 0 : action.actionType) === 'click' && amisCore.isObject(action === null || action === void 0 ? void 0 : action.args)) {
                            mergedData = amisCore.createObject(data, tslib.__assign(tslib.__assign({}, action.args), { nativeEvent: e }));
                        }
