...
var Plain = /** @class */ (function (_super) {
    ...
    Plain.prototype.render = function () {
        ...
        return (React__default["default"].createElement(Component, { className: cx('PlainField', className), style: style, onClick: this.handleClick, onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave }, tpl || text ? (amisCore.filter(tpl || text, data)) : typeof value === 'undefined' || value === '' || value === null ? (React__default["default"].createElement("span", { className: "text-muted" }, placeholder)) : (String(value))));
    };
    Plain.defaultProps = {
        wrapperComponent: '',
        inline: true,
