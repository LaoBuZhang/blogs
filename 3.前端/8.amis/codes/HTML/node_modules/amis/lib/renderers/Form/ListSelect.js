    ...
    ListControl.prototype.renderStatic = function (displayValue) {
        ...
        var itemRender = function (option, key) {
            ...
            if (itemSchema || option.body || option.image) {
                return (React__default["default"].createElement("div", { key: key, className: cx('ListControl-static-item', itemClassName) }, itemSchema
                    ...
                    : option.body
                        ...
                        : [(option.image
                                ? React__default["default"].createElement("div", { key: "image", className: cx('ListControl-itemImage', imageClassName) },
                                    React__default["default"].createElement("img", { src: option.image, alt: label }))
                                : null),
                            (React__default["default"].createElement("div", { key: "label", className: cx('ListControl-itemLabel') }, label))
                        ]));
            }
            return (React__default["default"].createElement("div", { key: key, className: cx("ListControl-static-item") }, label));
        };
        return React__default["default"].createElement("div", { className: cx('StaticList') }, selectedOptions.map(itemRender));
    };
    ListControl.prototype.render = function () {
        var _this = this;
        var _a = this.props, render = _a.render, itemClassName = _a.itemClassName, cx = _a.classnames, className = _a.className; _a.style; var disabled = _a.disabled, options = _a.options, placeholder = _a.placeholder, selectedOptions = _a.selectedOptions, imageClassName = _a.imageClassName, submitOnDBClick = _a.submitOnDBClick, itemSchema = _a.itemSchema, data = _a.data, labelField = _a.labelField, listClassName = _a.listClassName, __ = _a.translate;
        var body = null;
