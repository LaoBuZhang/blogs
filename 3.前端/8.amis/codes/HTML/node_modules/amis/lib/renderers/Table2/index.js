...
var Table2 = /** @class */ (function (_super) {
    ...
    Table2.prototype.renderCellSchema = function (schema, props) {
        ...
        if (schema && amisCore.isObject(schema)) {
            ...
            schema.width; schema.children; schema.title; var rest = tslib.__rest(schema, ["width", "children", "title"]);
    ...
    Table2.prototype.renderHeading = function () {
        ...
        if (store.moved) {
            return (React__default["default"].createElement("div", { className: cx('Table-heading', headingClassName), key: "heading" }, store.moved ? (React__default["default"].createElement("span", null,
                ...
                React__default["default"].createElement("button", { type: "button", className: cx('Button Button--size-xs Button--success m-l-sm'), onClick: this.handleSaveOrder },
    ...
    Table2.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('Table-render-wrapper'), style: style },
            this.renderActions('header'),
            heading,
            this.renderTable(),
            React__default["default"].createElement(amisUi.Spinner, { overlay: true, show: loading, loadingConfig: loadingConfig })));
    };
