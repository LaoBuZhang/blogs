...
var WordsField = /** @class */ (function (_super) {
    ...
    WordsField.prototype.renderContent = function (words) {
        ...
        // 使用tag展示时，默认不使用连接符
        React__default["default"].createElement(amisUi.Tag, tslib.__assign({ key: key, label: label, className: 'mb-1' }, typeof inTag === 'object' ? tslib.__assign(tslib.__assign({}, inTag), { className: cx(inTag.className) }) : undefined))); });
    };
    ...
    WordsField.prototype.render = function () {
        ...
        return React__default["default"].createElement("div", { className: cx('Words-field', className), style: style }, body);
    };
