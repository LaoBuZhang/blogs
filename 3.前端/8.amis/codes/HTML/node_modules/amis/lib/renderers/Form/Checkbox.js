...
var CheckboxControl = /** @class */ (function (_super) {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dispatchEvent('change', amisCore.resolveEventData(this.props, { value: eventData }, 'value'))];
                    case 1:
    ...
    CheckboxControl.prototype.renderStatic = function () {
        ...
        return (React__default["default"].createElement(amisUi.Checkbox, { inline: true, value: value || '', trueValue: trueValue, falseValue: falseValue, disabled: true, partial: partial, optionType: optionType, checked: checked, labelClassName: labelClassName }, option ? render('option', option) : null));
    };
