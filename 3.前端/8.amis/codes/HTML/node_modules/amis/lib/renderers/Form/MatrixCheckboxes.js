...
var MatrixCheckbox = /** @class */ (function (_super) {
            ...
            return tslib.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dispatchEvent('change', amisCore.resolveEventData(this.props, { value: value.concat() }, 'value'))];
                    case 1:
                ...
                React__default["default"].createElement("table", { className: cx('Table-table') },
                    ...
                    React__default["default"].createElement("tbody", null, rows.map(function (row, y) { return (React__default["default"].createElement("tr", { key: y },
                        ...
                        columns.map(function (column, x) { return (React__default["default"].createElement("td", { key: x, className: "text-center" },
                            React__default["default"].createElement(amisUi.Checkbox, { type: multiple ? 'checkbox' : 'radio', disabled: forceDisabled || disabled, checked: !!(value[x] && value[x][y] && value[x][y].checked), onChange: function (checked) {
    ...
    MatrixCheckbox.prototype.renderStatic = function (displayValue) {
        ...
        return (React__default["default"].createElement("div", { key: "input", className: cx('MatrixControl', className || '') }, error ? displayValue : this.renderInput(true)));
    };
    MatrixCheckbox.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { key: "input", className: cx('MatrixControl', className || '') },
            ...
            React__default["default"].createElement(amisUi.Spinner, { size: "lg", overlay: true, key: "info", show: loading, loadingConfig: loadingConfig })));
    };
