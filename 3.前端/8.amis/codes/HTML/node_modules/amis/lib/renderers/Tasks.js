...
var Task = /** @class */ (function (_super) {
    ...
    Task.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('Table-content', className), style: style },
            React__default["default"].createElement("table", { className: cx('Table-table', tableClassName) },
                ...
                React__default["default"].createElement("tbody", null, error ? (React__default["default"].createElement("tr", null,
                    ...
                    React__default["default"].createElement("td", null, item.status == loadingStatusCode ? (React__default["default"].createElement(amisUi.Spinner, { loadingConfig: loadingConfig, show: true, icon: "reload", spinnerClassName: cx('Task-spinner') })) : item.status == canRetryStatusCode ? (React__default["default"].createElement("a", { onClick: function () { return _this.submitTask(item, key, true); }, className: cx('Button', 'Button--danger', 'Button--size-md', retryBtnClassName || btnClassName) }, retryBtnText || btnText)) : (React__default["default"].createElement("a", { onClick: function () { return _this.submitTask(item, key); }, className: cx('Button', 'Button--default', 'Button--size-md', btnClassName, {
