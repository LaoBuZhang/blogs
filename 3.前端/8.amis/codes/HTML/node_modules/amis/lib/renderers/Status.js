...
var StatusField = /** @class */ (function (_super) {
    ...
    StatusField.prototype.render = function () {
        ...
        return (React__default["default"].createElement("span", { className: cx('StatusField', wrapClassName, className), style: style }, viewValue));
    };
