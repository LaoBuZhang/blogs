...
var Container = /** @class */ (function (_super) {
    ...
    Container.prototype.render = function () {
        var _a = this.props, className = _a.className, wrapperComponent = _a.wrapperComponent, size = _a.size, cx = _a.classnames, style = _a.style, data = _a.data, draggable = _a.draggable, draggableConfig = _a.draggableConfig;
        ...
        var contentDom = (React__default["default"].createElement(Component, { className: cx('Container', size && size !== 'none' ? "Container--".concat(size) : '', className), style: amisCore.buildStyle(style, data) }, this.renderBody()));
        return finalDraggable ? (React__default["default"].createElement(amisUi.DndContainer, tslib.__assign({}, finalDraggableConfig, { draggable: true }), contentDom)) : (contentDom);
    };
