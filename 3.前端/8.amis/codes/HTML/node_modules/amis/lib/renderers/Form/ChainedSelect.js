...
var ChainedSelectControl = /** @class */ (function (_super) {
                ...
                return tslib.__generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, dispatchEvent('change', amisCore.resolveEventData(this.props, { value: valueRes }, 'value'))];
                        case 1:
    ...
    ChainedSelectControl.prototype.renderStatic = function (displayValue) {
        ...
        return React__default["default"].createElement("div", { className: cx("".concat(classPrefix, "SelectStaticControl"), className) }, displayValue);
    };
    ChainedSelectControl.prototype.render = function () {
        var _this = this;
        var _a = this.props, options = _a.options, ns = _a.classPrefix, className = _a.className; _a.style; _a.inline; var loading = _a.loading, value = _a.value, delimiter = _a.delimiter; _a.joinValues; _a.extractValue; _a.multiple; var useMobileUI = _a.useMobileUI, env = _a.env, rest = tslib.__rest(_a, ["options", "classPrefix", "className", "style", "inline", "loading", "value", "delimiter", "joinValues", "extractValue", "multiple", "useMobileUI", "env"]);
        var arr = Array.isArray(value)
            ? value.concat()
            : value && typeof value === 'string'
                ? value.split(delimiter || ',')
