...
var MappingField = amisUi.withStore(function (props) {
    return Store.create({
        ...
        class_1.prototype.renderSingleValue = function (key, reactKey, needStyle) {
            ...
            return (React__default["default"].createElement("span", { key: "map-".concat(reactKey), className: cx('MappingField', className), style: curStyle }, viewValue));
        };
        class_1.prototype.renderViewValue = function (value) {
            ...
            return render('mappingItemSchema', itemSchema, {
                data: amisCore.createObject(data, amisCore.isObject(value) ? value : { item: value })
            });
        };
        class_1.prototype.render = function () {
            ...
            if (Array.isArray(mapKey)) {
                return (React__default["default"].createElement("span", { style: style }, mapKey.map(function (singleKey, index) {
