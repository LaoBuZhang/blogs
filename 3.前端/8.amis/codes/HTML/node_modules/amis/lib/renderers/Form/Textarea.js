...
var TextAreaControl = /** @class */ (function (_super) {
    ...
    TextAreaControl.prototype.handleChange = function (e) {
        ...
        dispatchEvent('change', amisCore.resolveEventData(this.props, { value: e }, 'value'));
        onChange && onChange(e);
    };
    TextAreaControl.prototype.handleFocus = function (e) {
        ...
        this.setState({
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, dispatchEvent('focus', amisCore.resolveEventData(this.props, { value: value }, 'value'))];
                    case 1:
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dispatchEvent('blur', amisCore.resolveEventData(this.props, { value: value }, 'value'))];
                    case 1:
                        rendererEvent = _a.sent();
                        if (rendererEvent === null || rendererEvent === void 0 ? void 0 : rendererEvent.prevented) {
                            return [2 /*return*/];
    ...
    TextAreaControl.prototype.render = function () {
        ...
        return (React__default["default"].createElement(amisUi.Textarea, tslib.__assign({}, rest, { forwardRef: this.inputRef, onFocus: this.handleFocus, onBlur: this.handleBlur, onChange: this.handleChange })));
    };
