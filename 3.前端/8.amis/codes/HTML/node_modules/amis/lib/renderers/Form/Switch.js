...
var SwitchControl = /** @class */ (function (_super) {
    ...
    SwitchControl.prototype.renderBody = function (children) {
        ...
        var Option = React__default["default"].createElement("span", { className: cx('Switch-option') }, option);
    ...
    SwitchControl.prototype.renderStatic = function () {
        ...
        var body = React__default["default"].createElement("span", null, value === trueValue ? on : off);
    ...
    SwitchControl.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx("SwitchControl", className) }, this.renderBody(React__default["default"].createElement(amisUi.Switch, { classPrefix: ns, value: value, trueValue: trueValue, falseValue: falseValue, onText: on, offText: off, disabled: disabled, onChange: this.handleChange, size: size }))));
    };
