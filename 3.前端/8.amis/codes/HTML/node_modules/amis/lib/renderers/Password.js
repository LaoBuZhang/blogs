...
var PasswordField = /** @class */ (function (_super) {
    ...
    PasswordField.prototype.render = function () {
        ...
        return (React__default["default"].createElement("span", { className: cx('Password-field', className), style: style },
            this.state.visible ? value : mosaicText,
            this.state.visible
                ? React__default["default"].createElement(amisUi.Icon, { icon: "view", className: "icon", onClick: this.toggleVisible })
                : React__default["default"].createElement(amisUi.Icon, { icon: "invisible", className: "icon", onClick: this.toggleVisible })));
    };
    tslib.__decorate([
        amisCore.autobind,
