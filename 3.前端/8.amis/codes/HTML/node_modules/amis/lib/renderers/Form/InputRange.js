...
var Input = /** @class */ (function (_super) {
    ...
    Input.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx("".concat(ns, "InputRange-input")) },
            React__default["default"].createElement(amisUi.NumberInput, { value: +_value, step: step, max: this.checkNum(max), min: this.checkNum(min), onChange: this.handleInputNumberChange, disabled: disabled, onBlur: this.onBlur, onFocus: this.onFocus })));
    };
    tslib.__decorate([
        amisCore.autobind,
...
var RangeControl = /** @class */ (function (_super) {
    ...
    RangeControl.prototype.render = function () {
        var _this = this;
        var value = this.state.value;
        var props = tslib.__assign(tslib.__assign({}, this.props), { value: value, onChange: this.handleChange, onAfterChange: this.onAfterChange });
