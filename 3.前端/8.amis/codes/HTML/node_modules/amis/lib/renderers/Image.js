...
var ImageThumb = /** @class */ (function (_super) {
    ...
    ImageThumb.prototype.render = function () {
        ...
        var imageContent = (React__default["default"].createElement(React__default["default"].Fragment, null,
            imageLoading ? (React__default["default"].createElement("img", { className: cx('Image-image', imageClassName), src: imagePlaceholder, alt: alt })) : null,
            React__default["default"].createElement("img", { onLoad: this.handleImgLoaded, onError: this.handleImgError, className: cx('Image-image', imageClassName, {
        ...
        var enlarge = enlargeAble || overlays ? (React__default["default"].createElement("div", { key: "overlay", className: cx('Image-overlay') },
            ...
            overlays)) : null;
        var image = (React__default["default"].createElement("div", { className: cx('Image', imageMode === 'original' ? 'Image--original' : 'Image--thumb', className), style: href ? undefined : style },
        ...
        if (href) {
            image = (React__default["default"].createElement("a", { href: href, target: htmlTarget || (blank ? '_blank' : '_self'), className: cx('Link', className), style: style, title: title }, image));
        }
        return image;
    };
    tslib.__decorate([
