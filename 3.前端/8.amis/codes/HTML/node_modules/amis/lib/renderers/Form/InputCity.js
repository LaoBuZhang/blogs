...
var CityPicker = /** @class */ (function (_super) {
    ...
    CityPicker.prototype.render = function () {
        ...
        return db ? (React__default["default"].createElement("div", { className: cx('CityPicker', className) },
            ...
            allowCity && db.city[provinceCode] && db.city[provinceCode].length ? (React__default["default"].createElement(amisUi.Select, { searchable: searchable, disabled: disabled, options: db.city[provinceCode].map(function (item) { return ({
                    label: db[item],
                    value: item
            ...
            allowStreet && provinceCode ? (React__default["default"].createElement("input", { className: cx('CityPicker-input'), value: street || '', onChange: this.handleStreetChange, onBlur: this.handleStreetEnd, placeholder: __('City.street'), disabled: disabled })) : null)) : (React__default["default"].createElement(amisUi.Spinner, { show: true, size: "sm", loadingConfig: loadingConfig }));
    };
...
var LocationControl = /** @class */ (function (_super) {
    ...
    LocationControl.prototype.renderStatic = function (displayValue) {
        ...
        if (!this.state.db) {
            ...
            return React__default["default"].createElement(amisUi.Spinner, { size: "sm", show: true, loadingConfig: loadingConfig });
        }
        if (!value) {
        ...
        return (React__default["default"].createElement(React__default["default"].Fragment, null, [province, city, district, street].filter(function (v) { return !!v; }).join(delimiter)));
    };
