...
var Code = /** @class */ (function (_super) {
    ...
    Code.prototype.registerAndGetTheme = function () {
        ...
        var _c = this.props.editorTheme, editorTheme = _c === void 0 ? 'vs' : _c;
        if (!monaco) {
            return editorTheme;
        }
        if (this.customLang &&
            ...
            var colors = ((_a = this.customLang) === null || _a === void 0 ? void 0 : _a.colors) && isPlainObject__default["default"]((_b = this.customLang) === null || _b === void 0 ? void 0 : _b.colors)
    ...
    Code.prototype.render = function () {
        ...
        var _a = this.props, className = _a.className, style = _a.style, cx = _a.classnames, editorTheme = _a.editorTheme, customLang = _a.customLang, wordWrap = _a.wordWrap, wrapperComponent = _a.wrapperComponent;
        ...
        return (React__default["default"].createElement(Component, { ref: this.codeRef, className: cx('Code', {
