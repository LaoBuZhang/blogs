...
var Drawer = /** @class */ (function (_super) {
    ...
    Drawer.prototype.render = function () {
        ...
        return (React__default["default"].createElement(Container, { resizable: resizable, classPrefix: ns, className: className, style: style, size: size, onHide: this.handleSelfClose, disabled: store.loading, show: show, showCloseButton: showCloseButton, width: width, height: height, position: position, overlay: overlay, onEntered: this.handleEntered, onExited: this.handleExited, closeOnEsc: closeOnEsc, closeOnOutside: !store.drawerOpen && !store.dialogOpen && closeOnOutside, container: drawerContainer
                ? drawerContainer
            ...
            React__default["default"].createElement("div", { className: cx('Drawer-body', bodyClassName), role: "dialog-body" }, this.renderBody(body, 'body'))) : null,
            this.renderFooter(),
            body
