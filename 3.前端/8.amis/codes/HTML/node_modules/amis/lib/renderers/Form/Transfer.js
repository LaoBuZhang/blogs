                ...
                switch (_b.label) {
                    case 0:
                        ...
                        isTreeDefer = selectMode === 'tree' &&
                            (!!deferApi ||
                                !!amisCore.findTree(options, function (option) { return option.deferApi || option.defer; }));
                        isTreeDefer === true ||
