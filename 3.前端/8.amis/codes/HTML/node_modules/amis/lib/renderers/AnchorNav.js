...
var AnchorNav = /** @class */ (function (_super) {
    ...
    AnchorNav.prototype.render = function () {
        ...
        return (React__default["default"].createElement(amisUi.AnchorNav, { classPrefix: ns, classnames: cx, className: className, style: style, linkClassName: linkClassName, sectionClassName: sectionClassName, onSelect: this.handleSelect, active: this.state.active, direction: direction }, children));
    };
