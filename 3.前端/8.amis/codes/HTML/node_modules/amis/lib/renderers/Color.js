...
var ColorField = /** @class */ (function (_super) {
    ...
    ColorField.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('ColorField', className), style: style },
            React__default["default"].createElement("i", { className: cx('ColorField-previewIcon'), style: { backgroundColor: color || defaultColor } }),
            showValue ? (React__default["default"].createElement("span", { className: cx('ColorField-value') }, color || defaultColor)) : null));
    };
