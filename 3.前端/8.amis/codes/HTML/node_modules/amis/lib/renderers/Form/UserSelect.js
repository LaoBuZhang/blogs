...
var UserSelectControl = /** @class */ (function (_super) {
    ...
    UserSelectControl.prototype.renderStatic = function () {
        ...
        if (labelField === 'avatar') {
            return selectedOptions.map(function (item, index) { return (React__default["default"].createElement("img", { key: index, className: cx('UserSelect-avatar-img'), src: item[labelField], alt: "" })); });
        }
