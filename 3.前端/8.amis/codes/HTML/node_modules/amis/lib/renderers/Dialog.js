    ...
    Dialog.prototype.render = function () {
        ...
        return (React__default["default"].createElement(Wrapper, { classPrefix: classPrefix, className: cx(className), style: style, size: size, height: height, width: width, backdrop: "static", onHide: this.handleSelfClose, keyboard: closeOnEsc && !store.loading, closeOnEsc: closeOnEsc, closeOnOutside: !store.dialogOpen && closeOnOutside, show: show, onEntered: this.handleEntered, onExited: this.handleExited, container: env && env.getModalContainer ? env.getModalContainer : undefined, enforceFocus: false, disabled: store.loading },
            ...
            header
                ...
                : null,
            (!store.entered && lazyRender) || (lazySchema && !body) ? (React__default["default"].createElement("div", { className: cx('Modal-body', bodyClassName), role: "dialog-body" },
                React__default["default"].createElement(amisUi.Spinner, { overlay: true, show: true, size: "lg", loadingConfig: loadingConfig }))) : body ? (
            // dialog-body 用于在 editor 中定位元素
            React__default["default"].createElement("div", { className: cx('Modal-body', bodyClassName), role: "dialog-body" }, this.renderBody(body, 'body'))) : null,
            this.renderFooter(),
            body
