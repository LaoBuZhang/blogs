...
var CRUD = /** @class */ (function (_super) {
    ...
    CRUD.prototype.handleBulkAction = function (selectedItems, unSelectedItems, e, action) {
        ...
        var ids = selectedItems
            ...
            .join(',');
        var ctx = amisCore.createObject(store.mergedData, tslib.__assign(tslib.__assign({}, selectedItems[0]), { currentPageData: store.mergedData.items.concat(), rows: selectedItems, items: selectedItems, selectedItems: selectedItems, unSelectedItems: unSelectedItems, ids: ids }));
        var fn = function () {
            if (action.actionType === 'dialog') {
    ...
    CRUD.prototype.renderSwitchPerPage = function (childProps) {
        ...
        return (React__default["default"].createElement("div", { className: cx('Crud-pageSwitch') },
            ...
            React__default["default"].createElement(amisUi.Select, { classPrefix: ns, searchable: false, placeholder: __('Select.placeholder'), options: perPages, value: store.perPage + '', onChange: function (value) { return _this.handleChangePage(1, value.value); }, clearable: false, popOverContainer: this.parentContainer })));
    };
    CRUD.prototype.renderLoadMore = function () {
        ...
        var page = store.page, lastPage = store.lastPage;
        return (React__default["default"].createElement("div", { className: cx('Crud-loadMore') },
            React__default["default"].createElement(amisUi.Button, { disabled: page >= lastPage, disabledTip: __('CRUD.loadMoreDisableTip'), classPrefix: ns, onClick: function () {
