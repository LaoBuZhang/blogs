    ...
    Each.prototype.render = function () {
        ...
        var arr = amisCore.isObject(value)
            ...
            : Array.isArray(value)
                ? value
                : [];
        return (React__default["default"].createElement("div", { className: cx('Each', className), style: style }, Array.isArray(arr) && arr.length && items ? (arr.map(function (item, index) {
            var _a;
