    ...
    InputArrayControl.prototype.render = function () {
        ...
        var normalizedItems = Array.isArray(items)
            ...
            : items != null
                ? [items]
                : [];
        return (React__default["default"].createElement(Combo["default"], tslib.__assign({}, rest, { scaffold: scaffold, items: normalizedItems, flat: true, multiple: true, multiLine: false, ref: this.comboRef })));
    };
